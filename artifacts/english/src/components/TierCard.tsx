    ...
    >
      ...
      <div className="relative p-6 space-y-4">
        ...
        <div className="flex items-center justify-between gap-2">
          <div
            className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${meta.iconGradient} text-white font-extrabold text-lg shadow-[0_10px_24px_-8px_rgba(0,0,0,0.6),inset_0_1px_0_rgba(255,255,255,0.25)] ring-1 ring-white/20`}
            aria-hidden
          >
            {meta.letter}
          </div>
