import type { CEFRLevel } from "@/features/flashcards/data/oxford-words";
...
const ALL_LEVELS: (CEFRLevel | "all")[] = ["all", "A1", "A2", "B1", "B2"];
...
export function FilterBar({
  ...
  const LEVELS: (CEFRLevel | "all")[] = allowedLevels
    ? ["all", ...ALL_LEVELS.filter((l) => l !== "all" && allowedLevels.includes(l as CEFRLevel))]
    : ALL_LEVELS;
  return (
