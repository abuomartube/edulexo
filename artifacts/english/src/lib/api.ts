...
export function bestTier(enrollments: EnglishEnrollment[]): EnglishTier | null {
...
export async function getMentorTierInfo() {
  return request<{ bestTier: string | null; tiers: readonly string[] }>(
    "/api/english/mentor/tier-info",
  );
}
