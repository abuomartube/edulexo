...
export const READING_TYPES: { id: ReadingType; label: string; tagline: string }[] = [
  { id: "skimming", label: "Skimming", tagline: "Read fast for the main idea or overall purpose" },
  { id: "scanning", label: "Scanning", tagline: "Hunt the text for one specific fact, name or number" },
  { id: "mcq", label: "Multiple Choice", tagline: "Pick the best answer from three options" },
  { id: "tfng", label: "True / False / Not Given", tagline: "Decide if a statement matches the facts in the text" },
  { id: "ynng", label: "Yes / No / Not Given", tagline: "Decide if a statement matches the writer's opinion" },
  { id: "matching_headings", label: "Matching Headings", tagline: "Match each paragraph to the correct heading" },
  { id: "matching_features", label: "Matching Information", tagline: "Match each fact to the correct item from the text" },
  { id: "sentence_completion", label: "Sentence / Summary Completion", tagline: "Fill the gaps using words from the text" },
  { id: "note_completion", label: "Note Completion", tagline: "Complete short notes about the passage" },
  { id: "table_completion", label: "Table Completion", tagline: "Complete a table using words from the text" },
  { id: "flow_chart_completion", label: "Flow Chart Completion", tagline: "Complete a step-by-step flow chart" },
  { id: "short_answer", label: "Short-Answer Questions", tagline: "Answer in a few words straight from the text" },
];
...
const INSTR: Record<ReadingType, string> = {
  ...
  matching_features:
    "Match each statement to the correct item from the text.",
  sentence_completion:
...
const A2_MCQ: ReadingItem[] = bucket([
  ...
  },
  {
    ...
    answerKey: {
      q1: {
        value: 1,
        explanation: "The last sentence says: \"The bakery is closed on Mondays.\"",
      },
    },
  },
]);
...
const A2_TFNG: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: {
        value: "false",
        explanation: "The text says cats sleep \"about 12 to 16 hours a day\", which is more than 10, so the statement is false.",
      },
      q2: {
        value: "true",
        explanation: "The text says milk \"is actually not very good for their stomachs\", which agrees with the statement.",
      },
      q3: {
        value: "ng",
        explanation: "The text does not compare fish and meat, so we cannot say.",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: {
        value: "ng",
        explanation: "The text mentions autumn and winter rain, but says nothing about spring rain.",
      },
      q2: {
        value: "false",
        explanation: "The text says \"It does not snow every winter\", so the statement is false.",
      },
      q3: {
        value: "true",
        explanation: "The text says \"Many tourists carry an umbrella with them all year round\", which matches the statement.",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: {
        value: "true",
        explanation: "The text says directly: \"There are more bicycles in the city than people.\"",
      },
      q2: {
        value: "false",
        explanation: "The text says the streets \"are flat and easy to ride on\", the opposite of steep.",
      },
      q3: {
        value: "ng",
        explanation: "The text mentions trams but says nothing about prices for students.",
      },
    },
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "The children ate lunch inside the museum building." },
      { id: "q3", prompt: "The trip was the best day of the year." },
    ],
    answerKey: {
      q1: {
        value: "true",
        explanation: "The text starts with \"Last Friday, the children from Class 5 went to the city museum.\"",
      },
      q2: {
        value: "false",
        explanation: "The text says they \"had lunch in the museum garden\" — outside, not inside.",
      },
      q3: {
        value: "ng",
        explanation: "The text says they were happy, but never compares this trip to other days.",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: {
        value: "false",
        explanation: "The text says it \"opened on Main Street last month\", so much less than a year.",
      },
      q2: {
        value: "true",
      ...
      q3: {
        value: "false",
        explanation: "The text says \"The café does not allow dogs inside\", so they are not welcome.",
      },
    },
  },
]);
...
const A2_YNNG: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "The writer believes that Tokyo is the most exciting city." },
    ...
    answerKey: {
      q1: {
        value: "yes",
        explanation: "The writer says: \"I think Tokyo is the most exciting city in the world.\"",
      },
      q2: {
        value: "no",
        explanation: "The writer praises the \"fast trains\" — the opposite of slow.",
      },
      q3: {
        value: "ng",
        explanation: "The writer never says anything about wanting to live there.",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: {
        value: "no",
        explanation: "The writer disagrees with people who call village life boring.",
      },
      q2: {
        value: "yes",
        explanation: "The writer says: \"I sleep very well at night because it is so quiet.\"",
      },
      q3: {
        value: "ng",
        explanation: "The writer mentions other young people moving, but never their own plans.",
      },
    },
  },
  {
    ...
    questions: [
      ...
      { id: "q3", prompt: "The writer believes football should be taught in schools." },
    ],
    answerKey: {
      q1: {
        value: "yes",
        explanation: "The writer says football is \"more exciting than tennis or basketball\".",
      },
      q2: {
        value: "no",
        explanation: "The writer says the tickets \"are expensive\", the opposite of cheap.",
      },
      q3: {
        value: "ng",
        explanation: "The writer never gives an opinion about football in schools.",
      },
    },
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "The writer says all students enjoy the first lecture." },
      { id: "q3", prompt: "The writer believes lessons should start before 7 AM." },
    ],
    answerKey: {
      q1: {
        value: "yes",
        explanation: "The writer states: \"this is too early for most students\".",
      },
      q2: {
        value: "no",
        explanation: "The writer says many students \"simply do not come\", which contradicts the statement.",
      },
      q3: {
        value: "no",
        explanation: "The writer says classes should start at 9 or 10, not before 7.",
      },
    },
  },
]);
...
const A2_MATCHING_HEADINGS: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: { value: 2, explanation: "Paragraph A talks about hot, sunny summer weather and beach activities." },
      q2: { value: 0, explanation: "Paragraph B describes cold winter weather and warm clothes." },
    },
  },
  {
    ...
    options: ["The Comfort and Calm of Train Travel", "The Cost of Plane Tickets", "Freedom and Flexibility of Driving"],
    questions: [
      { id: "q1", prompt: "Paragraph A" },
      { id: "q2", prompt: "Paragraph B" },
    ],
    answerKey: {
      q1: { value: 0, explanation: "Paragraph A focuses on the comfort of trains — big seats, time to read, calm." },
      q2: { value: 2, explanation: "Paragraph B is about cars, where you can stop anywhere — that is freedom and flexibility." },
    },
  },
  {
    ...
    options: ["The Benefits of Daily Walking", "Why Drinking Water Matters", "How to Choose a Diet"],
    questions: [
      { id: "q1", prompt: "Paragraph A" },
      { id: "q2", prompt: "Paragraph B" },
    ],
    answerKey: {
      q1: { value: 1, explanation: "Paragraph A is about water and its benefits." },
      q2: { value: 0, explanation: "Paragraph B is about thirty minutes of walking per day." },
    },
  },
  {
    ...
    options: ["A Day at the Zoo", "The Busy Side of City Life", "A Quieter Life in the Countryside"],
    questions: [
      { id: "q1", prompt: "Paragraph A" },
      { id: "q2", prompt: "Paragraph B" },
    ],
    answerKey: {
      q1: { value: 1, explanation: "Paragraph A describes the busy life in big cities." },
      q2: { value: 2, explanation: "Paragraph B describes the calm life in the countryside." },
    },
  },
  {
    ...
    options: ["The Joy of Reading at Night", "Travelling Around the World", "Cooking as a Fun Hobby"],
    questions: [
      { id: "q1", prompt: "Paragraph A" },
      { id: "q2", prompt: "Paragraph B" },
    ],
    answerKey: {
      q1: { value: 0, explanation: "Paragraph A is about reading, especially before sleep." },
      q2: { value: 2, explanation: "Paragraph B is about cooking as a fun hobby." },
    },
  },
]);
...
const A2_MATCHING_FEATURES: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: { value: 1, explanation: "The Moon car is described as \"very safe for families\"." },
      q2: { value: 0, explanation: "The Star car is \"very cheap\", which means not expensive." },
      q3: { value: 2, explanation: "The Sun car is described as \"yellow and fast\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: 0, explanation: "Café Bloom has \"the lowest prices in the area\"." },
      q2: { value: 1, explanation: "Riverbean has a \"quiet study room\"." },
      q3: { value: 2, explanation: "Sunbeans Café is \"famous for its homemade chocolate cake\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: 1, explanation: "City Glide is \"light\" and easy to carry up the stairs." },
      q2: { value: 2, explanation: "Speed One is \"the most expensive\" model." },
      q3: { value: 0, explanation: "Mountain Pro has \"thick tyres for rough roads\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: 0, explanation: "Beach Week is \"relaxing\" with \"just rest\"." },
      q2: { value: 1, explanation: "Mountain Trip includes \"a short lesson about nature\" each day." },
      q3: { value: 2, explanation: "City Tour says tourists \"travel by fast train\"." },
    },
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: 1, explanation: "Apartment Two has a \"large balcony with a view of the park\"." },
      q3: { value: 2, explanation: "Apartment Three \"gets the most sunlight in the building\"." },
    },
  },
]);
...
const A2_SENTENCE_COMPLETION: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "First, you must boil water. Next, put the tea ____ in a cup." },
      { id: "q2", prompt: "After you pour the water, you should wait for three ____." },
      { id: "q3", prompt: "You can add ____ to make the tea sweet." },
    ],
    answerKey: {
      q1: { value: "bag", explanation: "The text says to \"put a tea bag in your cup\"." },
      q2: { value: "minutes", explanation: "The text says \"wait for three minutes\"." },
      q3: { value: "sugar", acceptable: ["milk"], explanation: "The text says \"you can add milk or sugar if you like it sweet\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "slices", explanation: "The text says \"two slices of bread\"." },
      q2: { value: "minutes", explanation: "The text says \"Wait two minutes\"." },
      q3: { value: "butter", explanation: "The text says \"Spread some butter on top\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "spade", explanation: "The text says to \"dig a small hole in the soil with a spade\"." },
      q2: { value: "earth", explanation: "The text says \"cover the roots with earth\"." },
      q3: { value: "water", explanation: "The text says \"Pour some water on the plant once a day\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "streets", explanation: "The text says \"The bus stop is two streets from her house\"." },
      q2: { value: "card", explanation: "The text says \"show her student card to the driver\"." },
      q3: { value: "minutes", explanation: "The text says \"The journey takes only fifteen minutes\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "card", explanation: "The text says \"bring your member card\"." },
      q2: { value: "manager", explanation: "The text says \"give it to the manager\"." },
      q3: { value: "week", explanation: "The text says \"You can keep the film for one week\"." },
    },
  },
]);
...
const A2_NOTE_COMPLETION: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: { value: "Mondays", acceptable: ["monday"], explanation: "The text says \"It is closed on Mondays.\"" },
      q2: { value: "$10", acceptable: ["10", "$10."], explanation: "The text says \"adults must pay $10\"." },
      q3: { value: "flash", acceptable: ["a flash"], explanation: "The text says visitors \"cannot use a flash\"." },
      q4: { value: "exit", explanation: "The text says the gift shop is \"near the exit\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "Saturday", acceptable: ["saturdays", "saturday morning"], explanation: "Classes are \"every Saturday morning\"." },
      q2: { value: "10 AM", acceptable: ["10am", "10 a.m."], explanation: "Classes start \"at 10 AM\"." },
      q3: { value: "football boots", acceptable: ["boots"], explanation: "Each child must wear football boots." },
      q4: { value: "$20", acceptable: ["20", "$20."], explanation: "\"The class fee is $20 a month\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "24 hours", explanation: "The text says \"Reception is open 24 hours\"." },
      q2: { value: "10 AM", acceptable: ["10am", "10 a.m."], explanation: "Breakfast is served \"from 7 AM to 10 AM\"." },
      q3: { value: "room key", acceptable: ["key"], explanation: "The password is \"on the back of the room key\"." },
      q4: { value: "6 PM", acceptable: ["6pm", "6 p.m."], explanation: "Guests can use the pool \"until 6 PM\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "8 AM", acceptable: ["8am", "8 a.m."], explanation: "The library opens at 8 AM on weekdays." },
      q2: { value: "three", acceptable: ["3"], explanation: "Students can borrow \"up to three books\"." },
      q3: { value: "two weeks", acceptable: ["2 weeks"], explanation: "\"The maximum loan period is two weeks.\"" },
      q4: { value: "librarian", explanation: "Group meetings should be booked \"with the librarian\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "$25", acceptable: ["25", "$25."], explanation: "The pass \"costs only $25 a month\"." },
      q2: { value: "post office", explanation: "Passes can be bought \"at any post office\"." },
      q3: { value: "proof of address", acceptable: ["address"], explanation: "You need a photo and \"proof of address\"." },
...
const A2_TABLE_COMPLETION: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      ...
      q2: { value: "Swimming", explanation: "The Swimming class is on Wednesday at 5 PM in the Main Pool." },
  ...
  },
  {
    ...
    answerKey: {
      q1: { value: "Anna", explanation: "Anna will buy the fruit at the market." },
      q2: { value: "home", explanation: "Sami will make the sandwiches at home." },
      q3: { value: "supermarket", explanation: "Mum will bring the juice from the supermarket." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "main hall", acceptable: ["hall"], explanation: "Drama Club meets in the main hall." },
      q2: { value: "Thursday", explanation: "Chess Club meets on Thursday." },
      q3: { value: "Garden", explanation: "The Garden Club meets on Friday in the school garden." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "Yusuf", explanation: "The Cooking course is taught by Chef Yusuf." },
      q2: { value: "seven", acceptable: ["7"], explanation: "Photography lasts seven days." },
      q3: { value: "Painting", explanation: "Painting is led by Mr Brown for ten days." },
    },
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: "1 PM", acceptable: ["1pm", "1 p.m."], explanation: "The penguin eats fish at 1 PM." },
      q3: { value: "Tiger", explanation: "The tiger is from Asia and fed at 3 PM." },
    },
  },
]);
...
const A2_FLOW_CHART: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "Find the book on the shelf → Go to the ____ with the book." },
    ...
    answerKey: {
      q1: { value: "front desk", acceptable: ["desk"], explanation: "The text says: \"take the book to the front desk\"." },
      q2: {
        value: "student ID",
        acceptable: ["id card", "id", "student id card"],
        explanation: "The text says: \"show your student ID card to the librarian\".",
      },
      q3: { value: "scan", explanation: "The text says: \"the librarian will scan the book\"." },
      q4: { value: "return date", acceptable: ["date"], explanation: "The librarian will \"tell you the return date\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "film", acceptable: ["movie"], explanation: "Choose your film on the screen." },
      q2: { value: "seat", explanation: "Pick a seat from the seat map." },
      q3: { value: "counter", explanation: "Pay at the counter with cash or card." },
  ...
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: "address", explanation: "Write the address on the front of the envelope." },
  ...
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: "stir", explanation: "Add the pasta and stir for a few seconds." },
      q3: { value: "strainer", explanation: "Pour the pasta into a strainer." },
      q4: { value: "sauce", explanation: "Mix the pasta with the sauce on a plate." },
    },
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: "number", explanation: "Type your student number to log in." },
...
const A2_SHORT_ANSWER: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: { value: "Poland", explanation: "The text says she \"was born in Poland in 1867\"." },
      q2: { value: "1867", explanation: "The text says \"in 1867\"." },
      q3: { value: "two", acceptable: ["2"], explanation: "She \"won two Nobel Prizes\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "25 years", acceptable: ["25", "twenty-five years", "twenty five years"], explanation: "Mr Patel has been a driver for 25 years." },
      q2: { value: "14", acceptable: ["number 14"], explanation: "He drives the number 14 bus." },
      q3: {
  ...
  },
  {
    ...
    answerKey: {
      ...
      q3: { value: "a writer", acceptable: ["writer"], explanation: "A writer visits the shop every Saturday." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "three", acceptable: ["3"], explanation: "The park has three football pitches." },
      q2: { value: "1 kilometre", acceptable: ["1km", "1 km", "one kilometre"], explanation: "There is a 1-kilometre walking path." },
      q3: { value: "10 PM", acceptable: ["10pm", "10 p.m."], explanation: "The park closes at 10 PM in summer." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "7:30 AM", acceptable: ["7:30am", "7.30 am"], explanation: "The room opens at 7:30 AM." },
      q2: {
      ...
      q3: { value: "the city council", acceptable: ["city council", "council"], explanation: "The breakfast is paid for by the city council." },
    },
  },
]);
...
const B1_MCQ: ReadingItem[] = bucket([
  ...
  },
  {
    ...
    answerKey: {
      q1: {
        value: 1,
        explanation: "The text mentions that managers \"worry that remote workers may feel isolated\".",
      },
    },
  },
  {
    ...
    questions: [
      {
        id: "q1",
        prompt: "What is one disadvantage of electric scooters according to the text?",
        mcqOptions: [
    ...
    answerKey: {
      q1: {
        value: 2,
        explanation: "The text says scooters are \"often left blocking pavements, creating problems for pedestrians\".",
      },
    },
  },
  {
    ...
    questions: [
      {
        id: "q1",
        prompt: "What does the text suggest is a problem with reading long texts on a screen?",
        mcqOptions: [
...
const B1_TFNG: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "Sleep helps the brain organize and remember new information." },
      { id: "q2", prompt: "Adults need more sleep than teenagers do." },
      { id: "q3", prompt: "Drinking coffee before bed negatively affects memory." },
    ],
    answerKey: {
      q1: {
        value: "true",
        explanation: "The text says \"our brain processes the information we have gathered during the day\" — that is organising and remembering.",
      },
      q2: {
        value: "false",
        explanation: "The text says teenagers need up to ten hours, more than the seven-to-nine for adults — so adults need less.",
      },
      q3: {
        value: "ng",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "Bee populations have grown rapidly in the past twenty years." },
      { id: "q3", prompt: "Schools teach all children how to keep bees." },
    ],
    answerKey: {
      q1: {
        value: "true",
        explanation: "The text says bees \"pollinate many of the fruit and vegetable crops we eat every day\".",
      },
      q2: {
        value: "false",
        explanation: "The text says populations \"have fallen sharply\" — the opposite of grown rapidly.",
      },
      q3: {
        value: "ng",
        explanation: "The text says nothing about schools or teaching children to keep bees.",
      },
    },
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "Plant-based meat is now sold in regular supermarkets." },
    ...
    answerKey: {
      q1: {
        value: "true",
        explanation: "The text says plant-based meat has moved into \"ordinary supermarkets\" — the same as regular ones.",
      },
      q2: {
        value: "false",
        explanation: "The text says the price \"remains higher than meat\", so they are not cheaper.",
      },
      q3: {
        value: "ng",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "Library visits have dropped after the new services were added." },
      { id: "q3", prompt: "Libraries no longer buy any printed books." },
    ],
    answerKey: {
      q1: {
        value: "true",
        explanation: "The text lists Wi-Fi, training, and recording studios as services beyond books.",
      },
      q2: {
        value: "false",
        explanation: "The text says \"visits have increased\" where new services were introduced.",
      },
      q3: {
        value: "ng",
        explanation: "The text doesn't talk about whether libraries still buy printed books.",
      },
    },
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "The new cycling lanes were built over several years." },
      { id: "q2", prompt: "There are now fewer cyclists in Greendale than before 2018." },
      { id: "q3", prompt: "Greendale has banned cars from the city centre." },
    ],
    answerKey: {
      q1: {
        value: "true",
        explanation: "The text says the lanes were built \"between 2018 and 2022\" — over four years.",
      },
      q2: {
        value: "false",
        explanation: "The text says cyclist numbers \"more than doubled\", not fell.",
      },
      q3: {
        value: "ng",
...
const B1_YNNG: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "The writer thinks working from home is good for employees' personal lives." },
      { id: "q2", prompt: "The writer states that remote workers are less hardworking than office workers." },
      { id: "q3", prompt: "The writer prefers working in an office during the winter season." },
    ],
    answerKey: {
      q1: {
        value: "yes",
        explanation: "The writer says working from home \"has greatly improved the work-life balance\".",
      },
      q2: {
        value: "no",
        explanation: "The writer says remote workers \"are actually more focused\", which is the opposite.",
      },
      q3: {
        value: "ng",
        explanation: "The writer never mentions a personal preference about winter or the office.",
      },
    },
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "The writer believes fast fashion harms the environment." },
      { id: "q2", prompt: "The writer enjoys shopping with friends every weekend." },
      { id: "q3", prompt: "The writer thinks cheap clothes always look good." },
    ],
    answerKey: {
      q1: {
        value: "yes",
        explanation: "The writer calls fast fashion \"a disaster for the planet\".",
      },
      q2: {
        value: "ng",
        explanation: "The writer never mentions shopping with friends every weekend.",
      },
      q3: {
        value: "no",
        explanation: "The writer says cheap clothes \"fall apart after a few washes\" and finds simpler clothes more elegant.",
      },
    },
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "The writer believes learning a language changes how a person thinks." },
      { id: "q2", prompt: "The writer says it is easy to learn a new language quickly." },
      { id: "q3", prompt: "The writer thinks all schools should offer Korean lessons." },
    ],
    answerKey: {
      q1: {
        value: "yes",
        explanation: "The writer says a new language \"opens a door to a different way of thinking\".",
      },
      q2: {
        value: "no",
      ...
      q3: {
        value: "ng",
        explanation: "The writer never gives an opinion about schools and Korean lessons.",
      },
    },
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "The writer found notifications on the watch stressful." },
      { id: "q2", prompt: "The writer plans to buy another smart watch soon." },
      { id: "q3", prompt: "The writer believes the heart-rate sensor can be helpful." },
    ],
    answerKey: {
      q1: {
        value: "yes",
        explanation: "The writer says: \"The endless notifications were stressful\".",
      },
      q2: {
        value: "no",
        explanation: "The writer says smart watches \"are simply not for me\" — they are not buying another.",
      },
      q3: {
        value: "yes",
        explanation: "The writer agrees the heart-rate sensor is \"genuinely useful for older relatives\".",
      },
    },
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "The writer believes the cinema experience is worth the money." },
      { id: "q2", prompt: "The writer claims that all streaming services should close." },
      { id: "q3", prompt: "The writer thinks streaming is acceptable on tired nights." },
    ],
    answerKey: {
      q1: {
        value: "yes",
      ...
      q2: {
        value: "no",
        explanation: "The writer thinks streaming \"is fine for tired evenings\" — they don't want it to close.",
      },
      q3: {
        value: "yes",
...
const B1_MATCHING_HEADINGS: ReadingItem[] = bucket([
  {
    ...
    options: ["A More Comfortable Ride", "The Health Benefits of Cycling", "The Earliest Designs"],
    questions: [
      { id: "q1", prompt: "Paragraph A" },
      { id: "q2", prompt: "Paragraph B" },
    ],
    answerKey: {
      q1: { value: 2, explanation: "Paragraph A talks about the very first bicycles, which were the earliest designs." },
      q2: { value: 0, explanation: "Paragraph B describes how new materials made the ride smoother and more comfortable." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: 1, explanation: "Paragraph A is about how poor early smartphone cameras were." },
      q2: { value: 0, explanation: "Paragraph B explains how today's phone cameras match professional equipment." },
    },
  },
  {
    ...
    options: ["A Formal Japanese Ritual", "Tea Production in India", "A Relaxed British Tradition"],
    questions: [
      { id: "q1", prompt: "Paragraph A" },
      { id: "q2", prompt: "Paragraph B" },
    ],
    answerKey: {
      q1: { value: 0, explanation: "Paragraph A describes the precise, ceremonial Japanese tea ritual." },
      q2: { value: 2, explanation: "Paragraph B describes the relaxed British afternoon-tea tradition." },
    },
  },
  {
    ...
    options: ["High-Tech Maritime Rescue Today", "The Lonely Life of Old Lighthouse Keepers", "Building New Harbours"],
    questions: [
      { id: "q1", prompt: "Paragraph A" },
      { id: "q2", prompt: "Paragraph B" },
    ],
    answerKey: {
      q1: { value: 1, explanation: "Paragraph A describes the lonely, manual work of old lighthouse keepers." },
      q2: { value: 0, explanation: "Paragraph B describes modern, high-tech coastguard work." },
    },
  },
  {
    ...
    paragraphs: [
      {
        label: "A",
        text:
          "Studying with a private teacher allows the student to receive immediate feedback. The teacher can spot a wrong finger position the moment it happens, and lessons are shaped around the learner's strengths and weaknesses.",
      },
      {
        label: "B",
        text:
    ...
    answerKey: {
      q1: { value: 1, explanation: "Paragraph A is about the personal attention given by a private teacher." },
      q2: { value: 2, explanation: "Paragraph B describes the flexibility and lower cost of online learning." },
    },
  },
]);
...
const B1_MATCHING_FEATURES: ReadingItem[] = bucket([
  {
    ...
    questions: [
      ...
      { id: "q3", prompt: "Allows dairy products but restricts all meat and fish." },
    ],
    answerKey: {
      q1: { value: 1, explanation: "Veganism excludes \"any animal products at all\", including dairy and eggs." },
      q2: { value: 2, explanation: "Pescatarianism allows fish and other seafood." },
      q3: { value: 0, explanation: "Vegetarianism allows cheese, milk, and eggs but excludes meat, chicken, and fish." },
    },
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "Provides a wide selection of foreign-language films." },
      { id: "q3", prompt: "Mainly broadcasts live events rather than films." },
    ],
    answerKey: {
      q1: { value: 0, explanation: "Beam Plus is described as \"the cheapest streaming service on the market\"." },
      q2: { value: 1, explanation: "Vista Stream includes \"thousands of foreign-language films\"." },
      q3: { value: 2, explanation: "Kino Live \"focuses on live sports and concert broadcasts\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: 1, explanation: "Marine Biology requires \"long periods on a research ship\"." },
      q2: { value: 2, explanation: "Data Analytics offers a \"guaranteed paid internship\"." },
      q3: { value: 0, explanation: "Modern Architecture is taught \"entirely online\"." },
    },
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: 2, explanation: "City Studio \"includes a free public transport pass\"." },
      q3: { value: 1, explanation: "Mountain Lodge is \"ideal for groups of up to ten people\" and excludes young children." },
    },
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: 2, explanation: "Office Receptionist offers Monday-to-Friday 9–5 with no weekend shifts." },
...
const B1_SENTENCE_COMPLETION: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "Solar energy is converted into ____ using special panels." },
      { id: "q2", prompt: "It is considered a clean source of power because it creates no ____." },
      { id: "q3", prompt: "Panels should be placed on a ____ that gets a lot of sun." },
    ],
    answerKey: {
      q1: { value: "electricity", explanation: "The text says solar panels \"convert it into electricity\"." },
      q2: { value: "pollution", explanation: "The text says solar power \"does not produce harmful pollution\"." },
      q3: { value: "roof", explanation: "The text says you need \"a roof that receives plenty of direct sunlight\"." },
    },
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "When corals lose their colour the process is called ____." },
      { id: "q3", prompt: "Scientists worry many reefs could vanish within fifty ____." },
    ],
    answerKey: {
      q1: { value: "quarter", explanation: "The text says coral reefs are home to \"about a quarter of all marine species\"." },
      q2: { value: "bleaching", explanation: "The loss of colour is \"a process known as bleaching\"." },
      q3: { value: "years", explanation: "The text says reefs could disappear \"within fifty years\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "bus", explanation: "The text says Curitiba \"is famous for its bus network\"." },
      q2: { value: "lanes", explanation: "The text says the dedicated lanes \"other vehicles cannot enter\"." },
      q3: {
        value: "boarding",
        acceptable: ["board"],
  ...
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "Forest school children study mainly outside instead of ____." },
      { id: "q2", prompt: "Teachers say students improve in concentration and ____." },
      { id: "q3", prompt: "Parents need to accept that the children's clothes may be ____." },
    ],
    answerKey: {
      q1: {
        value: "indoors",
        acceptable: ["inside"],
        explanation: "Children spend most lessons outdoors, the opposite of indoors.",
      },
      q2: { value: "teamwork", explanation: "The text mentions \"improved concentration and stronger teamwork\"." },
      q3: { value: "muddy", explanation: "The text says clothes \"may return home muddy most days\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "volunteers", explanation: "The text says the service \"depends entirely on local volunteers\"." },
      q2: { value: "training", explanation: "The text says volunteers \"complete a demanding training course\"." },
      q3: { value: "kilos", acceptable: ["kg", "kilograms"], explanation: "The equipment \"can weigh more than twenty kilos\"." },
    },
  },
]);
...
const B1_NOTE_COMPLETION: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: { value: "Main Hall", acceptable: ["main hall"], explanation: "The tour starts \"in the Main Hall\"." },
      q2: { value: "turned off", explanation: "Phones must be \"turned off during the presentation\"." },
      q3: { value: "Ancient Egypt", explanation: "The first stop is \"the Ancient Egypt section\"." },
      q4: { value: "backpacks", explanation: "\"Backpacks must be left at the reception desk\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "10 PM", acceptable: ["10pm", "10 p.m."], explanation: "Lifeguards work \"between 6 AM and 10 PM\"." },
      q2: { value: "adult", explanation: "Under-16s \"must be accompanied by an adult\"." },
      q3: { value: "$120", acceptable: ["120", "$120."], explanation: "The fee is \"frozen at $120 for residents\"." },
      q4: { value: "$1 coin", acceptable: ["1 coin", "$1"], explanation: "Lockers \"take a $1 coin\"." },
    },
  },
  {
    ...
    answerKey: {
      ...
      q3: { value: "12:30 PM", acceptable: ["12:30pm", "12.30 pm"], explanation: "Lunch is served at 12:30 PM." },
      q4: { value: "7:00", acceptable: ["7", "7:00am", "7am"], explanation: "An email is sent \"by 7:00 AM\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "Tuesday", acceptable: ["tuesdays", "tuesday evenings"], explanation: "Classes are on Tuesday evenings." },
      q2: { value: "$180", acceptable: ["180", "$180."], explanation: "\"The course costs $180\"." },
      q3: {
        value: "recipe book",
        acceptable: ["printed recipe book", "book"],
        explanation: "Each student receives \"a printed recipe book on the first evening\".",
      },
      q4: { value: "fifteen", acceptable: ["15"], explanation: "\"Spaces are limited to fifteen places\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "village shop", acceptable: ["shop"], explanation: "Meet \"at the car park behind the village shop\"." },
      q2: { value: "14", acceptable: ["fourteen"], explanation: "The route is \"about 14 kilometres\"." },
      q3: {
        value: "one litre",
        acceptable: ["1 litre", "1l", "1 liter"],
        explanation: "Each walker must carry \"at least one litre of water\".",
      },
      q4: { value: "$3", acceptable: ["3", "$3."], explanation: "There is \"a small entrance fee of $3\"." },
    },
  },
]);
...
const B1_TABLE_COMPLETION: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: { value: "textbook", explanation: "The required item for French is \"a specific textbook\"." },
      q2: { value: "Intermediate", explanation: "The Spanish class is the \"Intermediate\" level." },
      q3: { value: "German", explanation: "The Advanced German course requires a laptop." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "Patel", explanation: "The Bronze Age room is curated by Dr Patel." },
      q2: { value: "three", acceptable: ["3"], explanation: "Modern Photography \"lasts three months\"." },
      q3: {
        value: "Children's Dinosaur Hall",
        acceptable: ["children's dinosaur", "dinosaur hall", "children's dinosaur hall"],
        explanation: "The Children's Dinosaur Hall is permanent and in the basement.",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "two", acceptable: ["2"], explanation: "Negotiation \"runs for two days\"." },
      q2: { value: "Marco", explanation: "Time Management is led by Marco Bianchi." },
      q3: { value: "Leadership", explanation: "The five-day course is Leadership Foundations." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "Northstar", explanation: "The Marketing internship is at Northstar." },
      q2: { value: "550", acceptable: ["$550"], explanation: "Engineering pays $550 per week." },
      q3: { value: "six", acceptable: ["6"], explanation: "The Research internship lasts six weeks." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "ten", acceptable: ["10"], explanation: "Route Blue follows the river \"for ten kilometres\"." },
      q2: { value: "parks", explanation: "Route Green \"crosses three parks\"." },
      q3: { value: "Red", explanation: "Route Red is the 25-kilometre country-road route." },
    },
  },
]);
...
const B1_FLOW_CHART: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "Collect plastic waste from bins → Transport the waste to a ____." },
    ...
    answerKey: {
      q1: { value: "recycling facility", acceptable: ["facility"], explanation: "The waste is taken to \"a recycling facility\"." },
      q2: { value: "sort", explanation: "Workers \"sort the items by color and plastic type\"." },
      q3: { value: "wash", explanation: "Machines \"wash the plastic\" to remove dirt." },
      q4: {
        value: "new products",
        acceptable: ["products"],
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "→ Workers remove the outer fruit to leave the ____ beans." },
      { id: "q3", prompt: "→ Roasters heat the beans until they turn ____." },
      { id: "q4", prompt: "→ Baristas ____ the beans and brew them." },
    ],
    answerKey: {
      q1: { value: "cherries", acceptable: ["cherry"], explanation: "Pickers harvest the cherries by hand." },
      q2: { value: "green", explanation: "After removing the fruit, only the \"green beans\" remain." },
      q3: { value: "dark brown", acceptable: ["brown"], explanation: "Roasters heat the beans until they \"turn dark brown\"." },
      q4: { value: "grind", explanation: "Baristas \"grind the roasted beans\"." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "number", explanation: "Log in using \"your patient number\"." },
      q2: { value: "slot", explanation: "Pick a free \"time slot\" in the calendar." },
      q3: { value: "symptoms", explanation: "Describe your symptoms briefly so staff can prepare." },
  ...
  },
  {
    ...
    answerKey: {
      ...
      q4: { value: "fingerprints", explanation: "Visit the post office to provide your fingerprints." },
    },
  },
  {
    ...
    answerKey: {
      q1: { value: "crush", explanation: "Workers crush the grapes to release the juice." },
      q2: { value: "yeast", explanation: "Yeast is added to start fermentation." },
      q3: { value: "barrels", explanation: "The wine is moved to oak barrels to age." },
...
const B1_SHORT_ANSWER: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "In what year was the practical telephone invented?" },
      { id: "q2", prompt: "What was Alexander Graham Bell's original job?" },
      { id: "q3", prompt: "Who was the first person to hear words spoken over the telephone?" },
    ],
    answerKey: {
      q1: { value: "1876", explanation: "The text says the telephone was invented \"in 1876\"." },
      q2: {
      ...
      q3: {
        ...
        explanation: "The first words were directed to his assistant, Thomas Watson.",
      },
    },
  },
  {
    ...
    answerKey: {
      ...
      q3: { value: "indigo", explanation: "The blue colour comes from \"a natural dye called indigo\"." },
    },
  },
  {
    ...
    answerKey: {
      ...
      q2: { value: "1953", explanation: "The summit was first reached in 1953." },
      q3: {
        value: "two months",
  ...
  },
  {
    ...
    answerKey: {
      q1: { value: "China", explanation: "The earliest paper was \"produced in China\"." },
      q2: {
        value: "12th century",
  ...
  },
  {
    ...
    answerKey: {
      ...
      q3: {
        ...
        explanation: "A blue whale can eat \"around four tonnes of krill in one day\".",
      },
    },
  },
]);
...
const A2_SCANNING: ReadingItem[] = bucket([
  {
    ...
    answerKey: {
      q1: {
        value: 1,
        explanation: "The text says: \"The wall is more than 21,000 kilometres long.\"",
      },
      q2: {
        value: 0,
        explanation: "The text says people started building it \"more than 2,000 years ago\".",
      },
      q3: {
        value: 2,
        explanation: "The text says it was built \"to keep enemies out of the country\".",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: {
        value: 2,
        explanation: "The text says it \"stands in the city of Paris in France\".",
      },
      q2: {
        value: 1,
      ...
      q3: {
        value: 3,
        explanation: "The text says \"A French engineer called Gustave Eiffel designed it\".",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: {
        value: 0,
        explanation: "The text says \"The top of the mountain is 8,849 metres above sea level.\"",
      },
      q2: {
        value: 3,
      ...
      q3: {
        value: 1,
        explanation: "The text says \"The first climbers to reach the top were Edmund Hillary and Tenzing Norgay in 1953.\"",
      },
    },
  },
  {
    ...
    answerKey: {
      q1: {
        value: 2,
        explanation: "The text says \"The first ancient Olympic Games took place in Greece in 776 BC.\"",
      },
      q2: {
        value: 0,
        explanation: "The text says \"The modern Olympic Games started in Athens in 1896.\"",
      },
      q3: {
        value: 1,
  ...
  },
  {
    ...
    answerKey: {
      q1: {
        value: 1,
        explanation: "The text says it \"covers about 5.5 million square kilometres of South America\".",
      },
      q2: {
        value: 2,
        explanation: "The text says the Amazon River \"is around 6,400 kilometres long\".",
      },
      q3: {
        value: 3,
...
const B1_SCANNING: ReadingItem[] = bucket([
  {
    ...
    questions: [
      { id: "q1", prompt: "In which year did Marie Curie win her first Nobel Prize?" },
    ...
    answerKey: {
      q1: {
        value: "1903",
        acceptable: ["in 1903"],
        explanation: "The text says she \"received [the prize] in 1903 in Physics\".",
      },
      q2: {
        value: "Chemistry",
  ...
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "About how many square kilometres does the Sahara cover?" },
      { id: "q2", prompt: "Which part of Africa does the Sahara stretch across?" },
      { id: "q3", prompt: "Above how many degrees Celsius can the Sahara reach in summer?" },
    ],
    answerKey: {
      q1: {
        value: "9 million",
        acceptable: ["nine million", "around 9 million", "9,000,000"],
        explanation: "The text says it \"covers around 9 million square kilometres\".",
      },
      q2: {
        value: "northern Africa",
        acceptable: ["the north", "north Africa", "northern"],
        explanation: "The text says it \"stretches across most of northern Africa\".",
      },
      q3: {
        value: "45",
  ...
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "In which month and year did Wikipedia first go online?" },
    ...
    answerKey: {
      q1: {
        ...
        explanation: "The text says it \"went online for the first time in January 2001\".",
      },
      q2: {
        value: "more than 300",
        acceptable: ["over 300", "300+", "more than three hundred"],
        explanation: "The text says it \"is available in more than 300 languages\".",
      },
      q3: {
        value: "60 million",
  ...
  },
  {
    ...
    questions: [
      { id: "q1", prompt: "In which year did Concorde start carrying passengers?" },
      { id: "q2", prompt: "What was Concorde's top speed in kilometres per hour?" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q2", prompt: "How tall (in metres) was the pyramid when it was first finished?" },
    ...
    answerKey: {
      ...
      q2: {
        ...
        explanation: "The text says \"it stood about 147 metres tall\" when finished.",
      },
      q3: {
        value: "139",
        acceptable: ["139 metres", "around 139", "one hundred and thirty-nine"],
        explanation: "The text says \"today the pyramid is around 139 metres high\".",
      },
    },
  },
]);
