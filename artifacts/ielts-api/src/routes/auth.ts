...
import { db, settingsTable, accessRequestsTable, accessCodesTable, reviewsTable, userDataTable, xpEventsTable, weakWordsTable, progressTable, quizScoresTable, orwellSubmissionsTable } from "@workspace/ielts-db";
