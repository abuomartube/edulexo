...
export function IntroTierBanner({ className = "" }: { className?: string }) {
  ...
  const allowedSummary =
    tier === "intro"
      ? {
          ar: "مستويا A2 و B1 متاحان فقط لهذه الباقة.",
          en: "A2 and B1 levels are unlocked on Intro.",
        }
      : {
          ar: "المستويات B1 و B2 و C1 متاحة لهذه الباقة.",
          en: "B1, B2 and C1 levels are unlocked on Advance.",
        };
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 space-y-1">
        ...
        <p
          className="text-xs text-sky-800/90 dark:text-sky-200/90"
          dir="rtl"
          lang="ar"
        >
