  ...
  const handleEnable = useCallback(async () => {
    ...
    try {
      const { publicKey } = await customFetch<{ publicKey: string }>(
        "/api-ielts/notifications/vapid-key",
      );
      if (!publicKey) {
        setShow(false);
        return;
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                You'll get class messages and study reminders.
              </p>
            </div>
          </div>
        ) : (
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Get class messages from your teacher and daily study reminders
                  — even when LEXO is closed.
                </p>
                <p
