...
export const LISTENING_SECTIONS: {
...
}[] = [
  {
    ...
    arabic: "محادثة يومية",
    description:
      "A conversation between two people in a social context — booking a room, registering for a course, calling about a service.",
    emoji: "📞",
  ...
  },
  {
    ...
    arabic: "خطاب اجتماعي",
    description:
      "One speaker talking about a place, event or facility — a tour guide, a community announcement, a museum guide.",
    emoji: "🎤",
  ...
  },
  {
    ...
    description:
      "A conversation between 2–4 people in an educational setting — a tutor and students discussing an assignment.",
    emoji: "🎓",
  ...
  },
  {
    ...
    description:
      "A university-style lecture by one speaker. The most challenging section, with academic vocabulary and dense content.",
    emoji: "📚",
...
export const LISTENING_SKILL_TESTS: LSkillTest[] = [
...

  {
    ...
    context:
      "A man calls the Greenfield Hotel to book a room for a short stay.",
    ...
    audioLines: [
      {
        ...
        voice: "f",
        text: "Good afternoon, Greenfield Hotel, Sarah speaking. How can I help you?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Hi, I'd like to book a room for next weekend, please.",
      },
      {
        speaker: "Receptionist",
        voice: "f",
      ...
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Yes, it's Daniel Foster. That's F-O-S-T-E-R.",
      },
      {
        speaker: "Receptionist",
        voice: "f",
        text: "Thank you, Mr Foster. And which dates were you thinking of?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Friday the fourteenth, checking out on Sunday morning.",
      },
      {
        speaker: "Receptionist",
        voice: "f",
        text: "So that's two nights. Would you like a single, double or family room?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "A double, please. Is there one with a view of the garden?",
      },
      {
        speaker: "Receptionist",
        voice: "f",
        text: "Yes, the garden rooms are seventy-five pounds per night, including breakfast.",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "That sounds fine. Could I also book parking? I'll be driving.",
      },
      {
        speaker: "Receptionist",
        voice: "f",
        text: "Certainly. Parking is free for guests. Could I take a contact number?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Yes, it's oh-seven-eight-double-four, two-one-six, nine-three-oh.",
      },
      {
        speaker: "Receptionist",
        voice: "f",
        text: "Thank you. I'll send confirmation to your email if you give it to me.",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "It's daniel.foster, all one word, at quickmail dot com.",
      },
      {
        speaker: "Receptionist",
        voice: "f",
        text: "Perfect. Your booking is confirmed, Mr Foster. We look forward to seeing you.",
      },
    ],
    visual: `╔════════════════ GREENFIELD HOTEL — BOOKING FORM ════════════════╗
...
╚══════════════════════════════════════════════════════════════════╝`,
    items: [
      ...
      {
        prompt: "2. Check-in date",
        answer: "14th",
        acceptable: ["fourteenth", "14"],
      },
      { prompt: "3. Number of nights", answer: "2", acceptable: ["two"] },
      {
        prompt: "4. Price per night (£)",
        answer: "75",
        acceptable: ["seventy-five", "seventy five"],
      },
      {
        prompt: "5. Last 3 digits of phone",
        answer: "930",
        acceptable: ["nine three oh", "nine-three-oh"],
      },
    ],
    analysis: `1 → Foster. The caller spells it: "F-O-S-T-E-R."
...
Tip: Numbers and spellings are the most common Section 1 traps. Always write digits exactly as you hear them.`,
...

  {
    ...
    context:
      "A woman calls the Riverside Community Centre to enrol on a course.",
    qType: "multiple_choice",
    instructions: "For each question, choose the correct letter A, B or C.",
    audioLines: [
      {
        speaker: "Centre staff",
        voice: "m",
        text: "Riverside Community Centre, good morning.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Hello, I'm interested in joining one of your evening cookery courses.",
      },
      {
        speaker: "Centre staff",
        voice: "m",
        text: "Lovely. We currently run three: Italian, Thai and a general beginners' class.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "I think Thai would suit me best. I cook Italian at home already.",
      },
      {
        speaker: "Centre staff",
        voice: "m",
        text: "Excellent choice. The Thai course runs for eight weeks, Tuesday evenings, from six-thirty to nine.",
      },
      { speaker: "Caller", voice: "f", text: "And what does it cost?" },
      {
        speaker: "Centre staff",
        voice: "m",
        text: "It's a hundred and twenty pounds, which includes all ingredients but not the recipe book.",
      },
      { speaker: "Caller", voice: "f", text: "Do I need to bring anything?" },
      {
        speaker: "Centre staff",
        voice: "m",
        text: "Just an apron. We provide knives, chopping boards and pans.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "And how many people are in each class?",
      },
      {
        speaker: "Centre staff",
        voice: "m",
        text: "We keep it small — twelve students maximum, so everyone gets attention from the chef.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Where exactly does the class meet? In the main building?",
      },
      {
        speaker: "Centre staff",
        voice: "m",
        text: "No, it's in the kitchen of the annexe — the smaller building behind the car park.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Great. Do I need to pay today to reserve a place?",
      },
      {
        speaker: "Centre staff",
        voice: "m",
        text: "A fifty-pound deposit is enough for now. The rest is due on the first evening.",
      },
    ],
    items: [
      {
    ...
    analysis: `1 → B. "I cook Italian at home already" — that's the reason for choosing Thai.
...
Tip: Distractors in Section 1 multiple choice often paraphrase wrong details from the same conversation. Listen for the WHY, not just the keyword.`,
...

  {
    ...
    context:
      "A guide gives visitors an introduction to a country park and points out features on a map.",
    qType: "map_labelling",
    instructions:
      "Label the map. Choose the correct letter A–G for each location.",
    audioLines: [
      {
        speaker: "Guide",
        voice: "f",
        text: `Welcome, everyone, to Greendale Country Park. I'm Helen, your guide for this morning. Before we set off, let me orient you to the map you've been given.
...
Finally, in the north-east corner, accessible only by the small path that runs along the eastern edge of the lake, you'll find the bird hide — a small wooden building where you can sit quietly and watch the water birds without disturbing them. Please use this carefully and keep your voices low.`,
    ...
    options: [
      ...
      {
        label: "D",
        text: "north of the visitor centre, to the left of the path",
      },
   ...
   └──────────────────────────────────────┘`,
    ...
    analysis: `1 → E. "Bottom-right corner with the climbing equipment."
...
Tip: For map questions, ALWAYS find the starting point first ("we're standing here") and follow direction words (left/right/north/across from). Underline them as you listen.`,
...

  {
    ...
    context:
      "A volunteer coordinator describes four roles available at a local hospital.",
    qType: "matching",
    instructions:
      "What does the coordinator say about each volunteer role? Match each role (1–5) with the correct description (A–G).",
    audioLines: [
      {
        speaker: "Coordinator",
        voice: "m",
        text: `Good evening, and thank you for your interest in volunteering at St Margaret's Hospital. Tonight I'd like to outline five different roles you can apply for, and what's distinctive about each.
...
Finally, we have the Library Trolley role. Volunteers wheel a small trolley of books and magazines around the wards twice a week. It's a good role for anyone who wants regular contact with patients but prefers shorter conversations than the Ward Visitor role involves.`,
    ...
    analysis: `1 → A. "Most popular with our retired volunteers."
...
F and G are distractors that aren't mentioned. The trick with Section 2 matching is that all five descriptions appear in roughly the order the speaker mentions them — but the answer choices are scrambled.`,
...

  {
    ...
    context:
      "Two students, Maya and Tom, talk to their tutor about an upcoming geography field trip.",
    qType: "multiple_choice",
    instructions: "For each question, choose the correct letter A, B or C.",
    audioLines: [
      {
        speaker: "Tutor",
        voice: "f",
        text: "Right, Maya and Tom — the field trip to the coast. Have you decided which area you'd like to focus on?",
      },
      {
        speaker: "Maya",
        voice: "f",
        text: "We were thinking about coastal erosion at first, but there's so much existing research on it that we'd struggle to add anything new.",
      },
      {
        speaker: "Tom",
        voice: "m",
        text: "So we're now planning to study the impact of small-scale tourism on the dune ecosystems instead.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "Interesting. And how are you planning to gather your data?",
      },
      {
        speaker: "Maya",
        voice: "f",
        text: "We'd originally planned interviews with local visitors, but we worried about people refusing or being rushed. So we're going to do systematic observations from a fixed point instead — counting people, noting where they walk, that sort of thing.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "That's much more reliable. What about the practical side — accommodation?",
      },
      {
        speaker: "Tom",
        voice: "m",
        text: "There's a youth hostel about three kilometres away, which is reasonably priced.",
      },
      {
        speaker: "Maya",
        voice: "f",
        text: "But we'd lose half the morning getting to and from the dunes. We've been offered space in the warden's caravan at the reserve itself, and I think we should take it.",
      },
      {
        speaker: "Tom",
        voice: "m",
        text: "It is more practical, even though it'll be cramped. Agreed.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "Sensible. Now, your biggest worry — what is it?",
      },
      {
        speaker: "Maya",
        voice: "f",
        text: "Honestly, the weather. Heavy rain would make the observation work almost impossible.",
      },
      {
        speaker: "Tom",
        voice: "m",
        text: "I'm more worried about whether the visitor numbers will be high enough to give us meaningful data. Late September is past peak season.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "Both are fair concerns. Bring the back-up plan — interviews — in case Tom's worry materialises.",
      },
    ],
    items: [
      {
        ...
        options: [
          ...
          {
            label: "B",
            text: "there is already a lot of existing research on it.",
          },
    ...
    analysis: `1 → B. "There's so much existing research on it."
...
Tip: In Section 3, distractors often appear EARLIER in the conversation as plans the students change their minds about. The answer is what they FINALLY decide, not what they first considered.`,
...

  {
    ...
    context:
      "Three students — Liam, Priya and Chen — discuss roles for their psychology presentation.",
    qType: "matching",
    instructions:
      "Match each student (1–3) with the responsibility (A–E) they will take. Two responsibilities are not used.",
    audioLines: [
      {
        speaker: "Liam",
        voice: "m",
        text: "Right, we've got two weeks until the presentation. Let's split the work properly this time.",
      },
      {
        speaker: "Priya",
        voice: "f",
        text: "I think we should each take a clear role, otherwise we'll keep doubling up.",
      },
      {
        speaker: "Chen",
        voice: "m",
        text: "Agreed. There are basically four jobs: the literature search, the actual slide design, the introduction script, and the practice runs to time it.",
      },
      {
        speaker: "Liam",
        voice: "m",
        text: "I'll do the literature search. I enjoy that part and I've got access to a couple of databases the others don't.",
      },
      {
        speaker: "Priya",
        voice: "f",
        text: "Good. I'd be happy doing the slides — I did graphic design at sixth form, and I've got the software at home.",
      },
      {
        speaker: "Chen",
        voice: "m",
        text: "Then I'll write the introduction script. My English is the strongest in the group for that kind of thing.",
      },
      {
        speaker: "Liam",
        voice: "m",
        text: "And practising the timing? We need someone to keep us strict on the twelve-minute limit.",
      },
      {
        speaker: "Priya",
        voice: "f",
        text: "Liam, you should do that. You're the most punctual of us!",
      },
      {
        speaker: "Chen",
        voice: "m",
        text: "Wait — Liam will already be busy with the literature search. I can do timing as well.",
      },
      {
        speaker: "Liam",
        voice: "m",
        text: "Honestly, I'm fine with both. Chen, the introduction script will be enough on top of your other modules.",
      },
    ...
    options: [
      ...
      {
        label: "C",
        text: "Doing the literature search and timing the practice runs",
      },
    ...
    analysis: `1 → C. Liam takes both the literature search AND the timing ("I'm fine with both"). Note how the group nearly assigns timing to Chen — that's the trap.
...
D and E are distractors not discussed at all. The Section 3 challenge is that group plans CHANGE during the conversation — always wait for the final decision.`,
...

  {
    ...
    context:
      "A university lecture on the causes of honeybee population decline and possible solutions.",
    ...
    audioLines: [
      {
        speaker: "Lecturer",
        voice: "f",
        text: `Good morning. Today's lecture explores one of the more troubling environmental stories of the past two decades: the decline of the honeybee. As you'll see, no single explanation suffices — instead, we are dealing with what biologists now call a "stress stack."
...
What can be done? Restrictions on neonicotinoid use have already produced measurable improvements in some regions of Europe. Beekeepers are also breeding strains of bees with natural resistance to varroa. And, perhaps surprisingly, urban areas are emerging as unexpected refuges: the variety of flowers in city parks and gardens often exceeds what is found in the surrounding countryside.`,
    ...
    items: [
      {
        prompt:
          "1. Biologists now describe the multiple causes of honeybee decline as a ___.",
        answer: "stress stack",
      },
      {
        prompt: "2. The varroa mite originally infected only ___ bee species.",
        answer: "Asian",
      },
      {
        prompt:
          "3. Even sub-lethal doses of neonicotinoids impair the bees' ability to ___.",
        answer: "navigate",
      },
      {
        prompt:
          "4. Modern monoculture farms leave bees with no food for most of the ___.",
        answer: "season",
      },
      {
        prompt:
          "5. Climate change can cause a ___ between flower blooms and bee emergence.",
        answer: "phenological mismatch",
        acceptable: ["mismatch"],
      },
      {
        prompt:
          "6. Surprisingly, ___ areas are now important refuges for bees.",
        answer: "urban",
      },
    ],
    analysis: `1 → stress stack. "What biologists now call a 'stress stack'."
...
Tip: Section 4 lectures move fast and you only hear them once. Skim the questions BEFORE the audio plays so you know what words to listen for.`,
...

  {
    ...
    context:
      "A neuroscience lecture explaining the stages of human memory formation.",
    qType: "short_answer",
    ...
    audioLines: [
      {
        speaker: "Lecturer",
        voice: "m",
        text: `Today we'll examine how human memory forms — a process that, although familiar in everyday life, is biologically remarkable.
...
Finally, not all memories are alike. Episodic memory — the memory of specific events — depends heavily on the hippocampus and is the first kind to suffer in conditions like Alzheimer's disease. Procedural memory, by contrast — the memory of how to ride a bicycle or play a piano piece — is stored in different brain regions and remains intact long after episodic memory has begun to fail.`,
    ...
    items: [
      ...
      {
        prompt:
          "2. Which brain structure binds scattered patterns into one memory?",
        answer: "hippocampus",
        acceptable: ["the hippocampus"],
      },
      {
        prompt: "3. During which type of sleep does most consolidation happen?",
        answer: "non-REM sleep",
        acceptable: ["non-REM", "slow-wave sleep", "deep sleep"],
      },
      {
        prompt: "4. What happens to a memory each time we retrieve it?",
        answer: "we rewrite it",
        acceptable: [
          "partially rewrite it",
          "we partially rewrite it",
          "rewrite",
        ],
      },
      {
        prompt:
          "5. Which kind of memory is the FIRST to suffer in Alzheimer's disease?",
        answer: "episodic memory",
        acceptable: ["episodic"],
      },
      {
        prompt:
          "6. Which kind of memory remains intact after episodic memory fails?",
        answer: "procedural memory",
        acceptable: ["procedural"],
      },
    ],
    analysis: `1 → encoding. "A stage called encoding."
...
Tip: For short-answer questions, use the EXACT words from the audio if possible. Avoid paraphrasing — markers want to see the actual term you heard.`,
...

  {
    ...
    context:
      "A woman calls the Westgate Sports Centre to enquire about membership.",
    qType: "sentence_completion",
    instructions: "Complete each sentence using words from the recording.",
    wordLimit: "Write NO MORE THAN TWO WORDS AND/OR A NUMBER for each answer.",
    audioLines: [
      {
        speaker: "Receptionist",
        voice: "m",
        text: "Westgate Sports Centre, good morning. How can I help?",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Hi, I'd like to ask about your membership options.",
      },
      {
        speaker: "Receptionist",
        voice: "m",
        text: "Of course. We have three categories: standard, family and student.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "I'd be the only one using it, so standard, I think.",
      },
      {
        speaker: "Receptionist",
        voice: "m",
        text: "That's forty-five pounds a month, with no joining fee at the moment.",
      },
      { speaker: "Caller", voice: "f", text: "And what's included?" },
      {
        speaker: "Receptionist",
        voice: "m",
        text: "Unlimited use of the gym, swimming pool and all classes — except yoga, which is an extra five pounds per session.",
      },
      { speaker: "Caller", voice: "f", text: "What are your opening hours?" },
      {
        speaker: "Receptionist",
        voice: "m",
        text: "Six a.m. to ten p.m. on weekdays, and eight to eight at the weekend.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Do I need to book the pool in advance?",
      },
      {
        speaker: "Receptionist",
        voice: "m",
        text: "Only the swimming lanes between five and seven in the evening — that's our peak time.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Anything I need to bring on my first visit?",
      },
      {
        speaker: "Receptionist",
        voice: "m",
        text: "Just photo ID and a bank card to set up the direct debit. We'll give you a tour and a free fitness assessment.",
      },
    ],
    items: [
      {
        prompt: "1. Standard membership costs £___ a month.",
        answer: "45",
        acceptable: ["forty-five", "forty five"],
      },
      { prompt: "2. There is currently no ___ to pay.", answer: "joining fee" },
      {
        prompt: "3. Yoga classes cost an extra £___ per session.",
        answer: "5",
        acceptable: ["five"],
      },
      {
        prompt:
          "4. The pool only requires booking between 5 and 7 p.m. because it is the ___.",
        answer: "peak time",
      },
      {
        prompt: "5. On the first visit, members receive a tour and a free ___.",
        answer: "fitness assessment",
      },
    ],
    analysis: `1 → 45. "Forty-five pounds a month."
...
Tip: Section 1 sentence completion mirrors form completion — the words you write must match the recording EXACTLY. "Joining cost" or "fitness check" would be marked wrong.`,
...

  {
    ...
    context:
      "A man reports a lost bag at a city train station's lost property office.",
    qType: "form_completion",
    ...
    audioLines: [
      {
        speaker: "Officer",
        voice: "f",
        text: "Lost property, good afternoon. How can I help?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Hi, I think I left my bag on the train this morning.",
      },
      {
        speaker: "Officer",
        voice: "f",
        text: "Let me take some details. Your full name, please?",
      },
      { speaker: "Caller", voice: "m", text: "James Whitman — W-H-I-T-M-A-N." },
      {
        speaker: "Officer",
        voice: "f",
        text: "Thank you. Which train were you on?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "The eight forty-five from Bristol to Reading.",
      },
      { speaker: "Officer", voice: "f", text: "Could you describe the bag?" },
      {
        speaker: "Caller",
        voice: "m",
        text: "It's a small backpack, dark green, with a leather front pocket.",
      },
      {
        speaker: "Officer",
        voice: "f",
        text: "Any contents that would help identify it?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Yes — there's a laptop inside, a notebook, and a brown wallet.",
      },
      {
        speaker: "Officer",
        voice: "f",
        text: "Where do you think you left it?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Probably on the luggage rack above the seat.",
      },
      {
        speaker: "Officer",
        voice: "f",
        text: "I'll log it. Best contact number?",
      },
      {
        speaker: "Caller",
        voice: "m",
        text: "Oh-seven-three-three-one, six-double-two, four-eight-seven.",
      },
      {
        speaker: "Officer",
        voice: "f",
        text: "Thank you. We'll text you within forty-eight hours.",
      },
    ],
    visual: `╔═══════════ LOST PROPERTY REPORT ═══════════╗
...
╚════════════════════════════════════════════╝`,
    items: [
      ...
      {
        prompt: "2. Train departure time",
        answer: "8:45",
        acceptable: ["08:45", "0845", "8.45", "eight forty-five"],
      },
      { prompt: "3. Front pocket material", answer: "leather" },
      {
        prompt: "4. Other contents (one item)",
        answer: "brown wallet",
        acceptable: ["wallet"],
      },
      { prompt: "5. Likely location of bag", answer: "luggage rack" },
    ],
    analysis: `1 → Whitman. "W-H-I-T-M-A-N."
...
Tip: For times in IELTS, both "8.45" and "8:45" are accepted — but "845" without punctuation usually isn't.`,
...

  {
    ...
    audioLines: [
      {
        speaker: "Owner",
        voice: "m",
        text: "Hello, Coastal Cottages, this is Mark.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Hi, I'm looking at your website. The Lighthouse Cottage — is it still free in August?",
      },
      {
        speaker: "Owner",
        voice: "m",
        text: "Let me check… yes, the second week of August is open. Sleeps six.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Perfect. We're four adults and two children. Is the beach close?",
      },
      {
        speaker: "Owner",
        voice: "m",
        text: "It's a five-minute walk down a private path.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "Lovely. And what about parking?",
      },
      {
        speaker: "Owner",
        voice: "m",
        text: "There's space for two cars right outside the cottage.",
      },
      { speaker: "Caller", voice: "f", text: "And the price?" },
      {
        speaker: "Owner",
        voice: "m",
        text: "August is peak season, so it's nine hundred pounds for the week. Off-peak it's six-fifty.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "We'll bring our dog. Is that OK?",
      },
      {
        speaker: "Owner",
        voice: "m",
        text: "Yes, but with a sixty-pound cleaning supplement — small dogs only, please.",
      },
      {
        speaker: "Caller",
        voice: "f",
        text: "She's a spaniel, so that's fine. What's the booking process?",
      },
      {
        speaker: "Owner",
        voice: "m",
        text: "A twenty-five percent deposit secures the dates; the balance is due four weeks before arrival.",
      },
    ],
    items: [
      {
    ...
    analysis: `1 → B. "The second week of August is open."
...
Tip: Numbers used as distractors (£650 here) are nearly always real numbers from the recording, just attached to the wrong thing.`,
...

  {
    ...
    context:
      "A festival organiser welcomes visitors and gives practical information.",
    qType: "multiple_choice",
    instructions: "For each question, choose the correct letter A, B or C.",
    audioLines: [
      {
        speaker: "Organiser",
        voice: "f",
        text: `Welcome, everyone, to the Riverside Summer Festival. Before you head in, a few important pieces of information.
...
Finally, the lost children's point is at the family stage. We strongly recommend taking a photo of your child this morning so you can show staff exactly what they're wearing.`,
    ...
    items: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            label: "B",
            text: "give children a wristband with their phone number.",
          },
    ...
    analysis: `1 → B. "The main music stage closes at nine."
...
Tip: Section 2 monologues frequently contrast THIS year vs LAST year. The current arrangement is always the answer — but the previous arrangement is offered as a distractor.`,
...

  {
    ...
    context:
      "A facilities manager guides new staff around the company's new offices.",
    qType: "map_labelling",
    instructions:
      "Label the floor plan. Choose the correct letter A–G for each location.",
    audioLines: [
      {
        speaker: "Manager",
        voice: "m",
        text: `Welcome to your new workplace. Let me walk you through the ground floor before you find your desks.
...
Finally, the post room is in the south-west corner, again with its own corridor from reception. Internal post is delivered twice daily.`,
   ...
   └──────────────────────────────────────┘`,
    ...
    analysis: `1 → C. "Post room is in the south-west corner."
...
Tip: For map labelling, anchor yourself with the speaker ("we've just come in through the main entrance"). Track every "left/right/opposite/behind" relative to that anchor.`,
...

  {
    ...
    context:
      "A council officer gives residents information about new recycling rules.",
    qType: "form_completion",
    ...
    audioLines: [
      {
        speaker: "Officer",
        voice: "f",
        text: `Good evening, everyone. Tonight I'd like to explain the changes to our recycling collection that begin next month.
...
╚═════════════════════════════════════════╝`,
    items: [
      {
        prompt: "1. Date the new system starts",
        answer: "1st",
        acceptable: ["first", "1", "1 of"],
      },
      { prompt: "2. Total number of bins", answer: "4", acceptable: ["four"] },
      { prompt: "3. Colour of the food waste bin", answer: "brown" },
      {
        prompt: "4. Item that contaminates food waste",
        answer: "plastic bags",
        acceptable: ["plastic"],
      },
      {
        prompt: "5. Free additional bin per household — how many?",
        answer: "first",
        acceptable: ["1st", "first one"],
      },
      {
        prompt: "6. How to report missed collections",
        answer: "app",
        acceptable: ["new app", "council app"],
      },
    ],
    analysis: `1 → 1st. "From the first of June."
    ...
    audioLines: [
      {
        speaker: "Tutor",
        voice: "f",
        text: "I've read your draft proposal. The research question is excellent — clear, narrow, and answerable.",
      },
      {
        speaker: "Sara",
        voice: "f",
        text: "Thank you. We did struggle to narrow it down.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "The methodology section, however, needs more detail. You say you'll interview small business owners, but you don't say how many.",
      },
      {
        speaker: "Marcus",
        voice: "m",
        text: "We were thinking around fifteen, to keep it manageable.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "That's a reasonable number, but be sure to justify it in the proposal — refer to data saturation, the standard reason.",
      },
      {
        speaker: "Sara",
        voice: "f",
        text: "And how should we recruit them? We were going to ask the local Chamber of Commerce for contacts.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "That's fine, but be aware that gives you a non-random sample. Make this a stated limitation.",
      },
      {
        speaker: "Marcus",
        voice: "m",
        text: "What about the interview length? We thought thirty minutes.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "I'd push for forty-five — owners often need ten minutes to warm up before saying anything genuinely useful.",
      },
      {
        speaker: "Sara",
        voice: "f",
        text: "And recording? Audio only, or should we film?",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "Audio is sufficient. Filming makes participants self-conscious and produces little extra value for this kind of qualitative work.",
      },
      { speaker: "Marcus", voice: "m", text: "What about data analysis?" },
      {
        speaker: "Tutor",
        voice: "f",
        text: "Use thematic analysis. It's well documented and appropriate for an undergraduate project.",
      },
    ],
    items: [
      {
        prompt:
          "1. The tutor described the research question as ___, narrow and answerable.",
        answer: "clear",
      },
      {
        prompt:
          "2. The number of interviews must be justified by referring to ___.",
        answer: "data saturation",
        acceptable: ["saturation"],
      },
      {
        prompt:
          "3. Recruiting via the Chamber of Commerce will give a ___ sample.",
        answer: "non-random",
        acceptable: ["non random"],
      },
      {
        prompt: "4. The recommended interview length is ___ minutes.",
        answer: "45",
        acceptable: ["forty-five", "forty five"],
      },
      {
        prompt: "5. The tutor recommends recording in ___ only.",
        answer: "audio",
      },
      {
        prompt: "6. The recommended method of data analysis is ___.",
        answer: "thematic analysis",
        acceptable: ["thematic"],
      },
    ],
    analysis: `1 → clear. "Clear, narrow, and answerable."
...
Tip: In Section 3, the tutor often UPGRADES or CHANGES a student's plan. Listen for the FINAL recommendation, not the student's first suggestion ("thirty minutes" is a distractor here).`,
...

  {
    ...
    context:
      "A supervisor helps a student narrow down possible dissertation topics.",
    qType: "matching",
    instructions:
      "What does the supervisor say about each possible topic? Match each topic (1–5) with the correct comment (A–G).",
    audioLines: [
      {
        speaker: "Supervisor",
        voice: "m",
        text: `Right, Hannah, let's go through the five topics you've shortlisted.
...
Finally, the fifth — remote working and team cohesion — is probably the safest bet. The methodology is well-established, the data is easy to gather through surveys, and your previous coursework already touches on the area.`,
    ...
    analysis: `1 → B. "I'd avoid it for that reason" (the enormous literature).
...
F and G are distractors. The challenge: every option in matching tasks SOUNDS plausible, so don't rely on intuition — wait for the explicit reason.`,
...

  {
    ...
    context:
      "A chemistry tutor gives two students feedback on their lab report.",
    qType: "multiple_choice",
    instructions: "For each question, choose the correct letter A, B or C.",
    audioLines: [
      {
        speaker: "Tutor",
        voice: "f",
        text: "Overall, this report is a solid first attempt. Let me focus on what to improve.",
      },
      { speaker: "Aiden", voice: "m", text: "Was the introduction OK?" },
      {
        speaker: "Tutor",
        voice: "f",
        text: "The introduction was strong, actually — well referenced and concise. The weakness is in the methodology: it reads like a recipe rather than scientific prose.",
      },
      {
        speaker: "Priya",
        voice: "f",
        text: "We did copy from the lab manual.",
      },
      {
        speaker: "Tutor",
        voice: "f",
        text: "I could tell. Rewrite it in your own words, in past passive — 'the solution was heated to 80 degrees', not 'heat the solution'.",
      },
      { speaker: "Aiden", voice: "m", text: "And the results section?" },
      {
        speaker: "Tutor",
        voice: "f",
        text: "Your tables are clear, but you have no error bars on the graph. That's a serious omission in any quantitative work.",
      },
      { speaker: "Priya", voice: "f", text: "What about the discussion?" },
      {
        speaker: "Tutor",
        voice: "f",
        text: "The discussion is your weakest section. You describe what happened but you don't explain why. Reference the underlying chemistry — bond energies, in this case.",
      },
      { speaker: "Aiden", voice: "m", text: "And the references?" },
      {
        speaker: "Tutor",
        voice: "f",
        text: "Mostly fine, but two of your sources are popular blogs rather than peer-reviewed journals. Replace those with proper academic sources.",
      },
    ],
    items: [
      {
    ...
    analysis: `1 → A. "The introduction was strong, actually."
    ...
    audioLines: [
      {
        speaker: "Lecturer",
        voice: "m",
        text: `Today's lecture traces the journey of coffee from its origins in north-east Africa to becoming the world's second-most-traded commodity, after oil.
...
The economic and social impact has been immense, but so has the environmental cost. Modern monoculture coffee farming has been linked to deforestation in producer countries and to vulnerability to disease — most notably the coffee leaf rust epidemics of the past decade.`,
    ...
    items: [
      {
        prompt:
          "1. Coffee was first brewed by Sufi monks in fifteenth-century ___.",
        answer: "Yemen",
      },
      {
        prompt:
          "2. The Coffea arabica plant originates from the highlands of ___.",
        answer: "Ethiopia",
      },
      {
        prompt: "3. By 1670, London had over ___ coffeehouses.",
        answer: "3000",
        acceptable: ["three thousand", "3,000"],
      },
      {
        prompt: "4. London coffeehouses were nicknamed ___ universities.",
        answer: "penny",
      },
      {
        prompt: "5. The first Europeans to grow coffee abroad were the ___.",
        answer: "Dutch",
      },
      {
        prompt:
          "6. Modern monoculture farming has been linked to ___ in producer countries.",
        answer: "deforestation",
      },
    ],
    analysis: `1 → Yemen. "Yemen was the first place to brew it."
...
Tip: Section 4 lectures often follow a chronological structure. Use the dates as anchors to track where you are in the lecture.`,
...

  {
    ...
    qType: "matching",
    instructions:
      "Match each volcano type (1–4) with its main characteristic (A–F).",
    audioLines: [
      {
        speaker: "Lecturer",
        voice: "f",
        text: `In today's lecture I'll introduce the four main types of volcano. Each forms under different conditions and produces eruptions of very different character.
...
The fourth type is the caldera. These are not really mountains at all but huge depressions left when a magma chamber empties and the ground above it collapses. The Yellowstone caldera in the United States is over fifty kilometres across. When such systems erupt, the consequences can be global, as happened with Toba seventy-four thousand years ago.`,
    ...
    options: [
      ...
      {
        label: "C",
        text: "Small, short-lived; forms in months from gas-rich eruptions",
      },
    ...
    analysis: `1 → A. "Wide, gently sloping mountain… gentle eruptions of low-viscosity basaltic lava."
...
E and F are distractors. Tip: For Section 4 matching, the speaker usually presents items in the SAME ORDER as the question numbers, but the description options are scrambled.`,
...

  {
    ...
    context:
      "A psychology lecture explaining how habits form and how to change them.",
    qType: "short_answer",
    instructions: "Answer the questions using words from the recording.",
    wordLimit: "Write NO MORE THAN THREE WORDS for each answer.",
    audioLines: [
      {
        speaker: "Lecturer",
        voice: "m",
        text: `Today's lecture explores the psychology of habit — how routines become automatic, and why they're so difficult to change.
...
The most successful approach to behaviour change, supported by recent evidence, is therefore not to attack the routine directly but to identify and modify the cue. If the smell of coffee is the cue, removing the coffee maker from your kitchen is more effective than relying on willpower. This is sometimes called environmental design, and it underpins many modern behaviour-change programmes.`,
    ...
    items: [
      ...
      {
        prompt:
          "5. Willpower is described as a ___ that depletes during the day.",
        answer: "finite resource",
      },
      {
        prompt:
          "6. The most effective behaviour change approach is to modify the ___.",
        answer: "cue",
        acceptable: ["the cue"],
      },
    ],
    analysis: `1 → the enormous flywheel. "William James… called habit 'the enormous flywheel of society.'"
...
export function scoreListeningItem(
  item: LItem,
  ua: string | string[] | null,
): boolean {
