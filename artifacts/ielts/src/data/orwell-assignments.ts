...
export const TASK1_ASSIGNMENTS: OrwellAssignment[] = [
  ...
  },
  {
    ...
    chart: {
      type: "bar",
      title:
        "Male and female enrolments by university subject, 2023 (in thousands)",
      ...
      series: [
        {
          name: "Theft",
          color: PALETTE.rose,
          values: [70, 82, 75, 55, 45, 38, 32],
        },
        {
          name: "Violent crime",
          color: PALETTE.amber,
          values: [18, 22, 26, 24, 20, 18, 16],
        },
        {
          name: "Cybercrime",
          color: PALETTE.violet,
          values: [1, 2, 5, 14, 28, 42, 60],
        },
      ],
    },
  },
...
export const TASK2_SUBTYPES: {
...
}[] = [
  {
    ...
    structure:
      "Intro (paraphrase + clear opinion) → Body 1 (first reason + example) → Body 2 (second reason + example) → Conclusion (restate opinion).",
  },
  {
    id: "Discussion",
    ...
    structure:
      "Intro (paraphrase + your opinion) → Body 1 (view A + reasons) → Body 2 (view B + why you favour/reject it) → Conclusion (restate which view you support).",
  },
  {
    ...
    emoji: "➕➖",
    description:
      "Weigh the benefits and drawbacks; sometimes give your overall judgement.",
    structure:
      "Intro (paraphrase + thesis: do advantages outweigh disadvantages?) → Body 1 (advantages + examples) → Body 2 (disadvantages + examples) → Conclusion (overall judgement).",
  },
  {
    id: "Problem-Solution",
    ...
    structure:
      "Intro (paraphrase + outline) → Body 1 (causes/problems + examples) → Body 2 (solutions + how they work) → Conclusion (summary + outlook).",
  },
  {
    ...
    emoji: "❓❓",
    description:
      "Answer both questions fully and clearly in separate paragraphs.",
    structure:
      "Intro (paraphrase + outline both answers) → Body 1 (answer Q1 fully) → Body 2 (answer Q2 fully) → Conclusion (brief summary of both answers).",
  },
];
...
> = {
  task1: {
    label: "IELTS Task 1",
    emoji: "📊",
    description: "Describe charts, graphs and diagrams (150+ words)",
  },
  task2: {
    label: "IELTS Task 2",
    emoji: "✍️",
    description: "Write an academic essay on a given topic (250+ words)",
  },
  paragraph: {
    label: "Paragraph Writing",
    emoji: "💌",
    description: "Emails, letters and short messages for real-life situations",
  },
};
