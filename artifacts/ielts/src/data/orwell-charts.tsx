...
export type SingleChartSpec =
  ...
  | {
      ...
      title: string;
      subtitle?: string;
      render: "water-cycle" | "paper-recycling" | "honey-production";
    }
  | {
      type: "map";
      title: string;
...
function WaterCycleDiagram() {
  return (
    <svg viewBox="0 0 560 300" className="w-full max-w-[640px] mx-auto block">
      ...
      <path
        d="M 350 210 Q 300 140 220 85"
        stroke="#0284c7"
        strokeWidth="2.5"
        fill="none"
        markerEnd="url(#arrow-wc)"
      />
      <text x="305" y="145" fontSize="11" fontWeight="600" fill="#0c4a6e">
        1. Evaporation
      </text>
      <path
        d="M 140 90 L 140 200"
        stroke="#0284c7"
        strokeWidth="2.5"
        fill="none"
        markerEnd="url(#arrow-wc)"
        strokeDasharray="4 3"
      />
      <text x="50" y="150" fontSize="11" fontWeight="600" fill="#0c4a6e">
        2. Precipitation
      </text>
      <text x="50" y="165" fontSize="11" fill="#0c4a6e">
        (rain/snow)
      </text>
      <polygon points="70,220 110,150 150,220" fill="#94a3b8" />
      <polygon points="130,220 170,130 210,220" fill="#64748b" />
      <text x="130" y="235" fontSize="10" fontWeight="600" fill="#1e293b">
        MOUNTAINS
      </text>
      <path
        d="M 170 220 Q 250 240 340 230"
        stroke="#0284c7"
        strokeWidth="2.5"
        fill="none"
        markerEnd="url(#arrow-wc)"
      />
      <text x="240" y="225" fontSize="11" fontWeight="600" fill="#0c4a6e">
        3. Runoff (rivers)
      </text>
      <text x="420" y="270" fontSize="11" fontWeight="600" fill="#0c4a6e">
        4. Collection
      </text>
    </svg>
  );
...
function PaperRecyclingDiagram() {
  ...
  return (
    <svg viewBox="0 0 560 340" className="w-full max-w-[640px] mx-auto block">
      ...
      />
      <path
        d="M 480 80 L 480 150"
        stroke="#334155"
        strokeWidth={2}
        markerEnd="url(#arrow-pr)"
      />
      <path
        d="M 420 175 L 340 175"
        stroke="#334155"
        strokeWidth={2}
        markerEnd="url(#arrow-pr)"
      />
      <path
        d="M 220 175 L 140 175"
        stroke="#334155"
        strokeWidth={2}
        markerEnd="url(#arrow-pr)"
      />
      ...
      />
      <path
        d="M 140 295 L 220 295"
        stroke="#334155"
        strokeWidth={2}
        markerEnd="url(#arrow-pr)"
      />
      <path
        d="M 340 295 L 420 295"
        stroke="#334155"
        strokeWidth={2}
        markerEnd="url(#arrow-pr)"
      />
  ...
  return (
    <svg viewBox="0 0 560 340" className="w-full max-w-[640px] mx-auto block">
      ...
      <g>
        ...
        <text x="70" y="82" textAnchor="middle" fontSize={9} fill="#78350f">
          (nectar)
        </text>
      </g>
      <path
      ...
      <g>
        ...
        <text x="245" y="86" textAnchor="middle" fontSize={9} fill="#78350f">
          (gather nectar)
        </text>
      </g>
      <path
      ...
      <g>
        ...
        <text x="450" y="88" textAnchor="middle" fontSize={9} fill="#78350f">
          (hexagonal cells)
        </text>
      </g>
      <path
        d="M 450 110 L 450 165"
        stroke="#d97706"
        strokeWidth={2}
        markerEnd="url(#arrow-hp)"
      />
      ...
      <g>
        ...
        <text x="450" y="208" textAnchor="middle" fontSize={9} fill="#78350f">
          (bees fan wings)
        </text>
      </g>
      <path
        d="M 380 195 L 290 195"
        stroke="#d97706"
        strokeWidth={2}
        markerEnd="url(#arrow-hp)"
      />
      ...
      <g>
        ...
        <text x="220" y="208" textAnchor="middle" fontSize={9} fill="#78350f">
          (by beekeeper)
        </text>
      </g>
      <path
        d="M 150 195 L 70 195"
        stroke="#d97706"
        strokeWidth={2}
        markerEnd="url(#arrow-hp)"
      />
      <g>
        ...
        <text x="70" y="208" textAnchor="middle" fontSize={9} fill="#fff">
          (final product)
        </text>
      </g>
    </svg>
...
function TableChart({
  ...
  spec: Extract<SingleChartSpec, { type: "table" }>;
}) {
  return (
    <ChartFrame title={spec.title} subtitle={spec.subtitle}>
          ...
          <thead>
            <tr className="bg-slate-100 dark:bg-slate-800">
              {spec.columns.map((c, i) => (
                <th
                  key={i}
                  className="border border-slate-300 dark:border-slate-700 px-3 py-2 font-bold text-slate-800 dark:text-slate-100 text-left"
                >
                  {c}
                </th>
              ))}
            ...
            {spec.rows.map((row, ri) => (
              ...
              >
                {row.map((cell, ci) => (
                  <td
                    key={ci}
                    className={`border border-slate-300 dark:border-slate-700 px-3 py-2 text-slate-800 dark:text-slate-200 ${ci === 0 ? "font-semibold" : ""}`}
                  >
                    {cell}
                  </td>
                ))}
