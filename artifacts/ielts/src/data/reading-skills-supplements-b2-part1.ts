...
Cambridge tip: a list of related strategies inside one paragraph is often a clue that the passage is describing a category — choose the option that names the category.`,
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Coastal wetlands — their value, decline and the case for restoration",
      },
      ...
      {
        label: "D",
        text: "A history of land reclamation in seventeenth-century Europe",
      },
    ],
    items: [{ prompt: "Best title for the passage:", answer: "A" }],
    analysis: `A is correct. The passage moves through value (storm buffering, carbon storage), decline (loss of half of global cover) and restoration efforts.
...
Cambridge tip: words such as "case for, and obstacles to" or "advantages and challenges" almost always signal a balanced informational purpose.`,
  ...
  // ───────────────────── 2. Scanning (need +15) ─────────────────────
  {
    ...
    passage: `The Hubble Space Telescope was launched aboard the Space Shuttle Discovery on 24 April 1990, becoming the first major optical telescope to be placed in orbit above the distorting effects of Earth's atmosphere. Its primary mirror, 2.4 metres in diameter, was found shortly after deployment to suffer from a small but consequential aberration that blurred its images. A repair mission in December 1993, conducted by astronauts aboard the Shuttle Endeavour, installed corrective optics and restored the telescope's intended performance. Over the subsequent three decades, Hubble has produced more than 1.5 million observations and has been cited in more than 19,000 peer-reviewed scientific papers, making it among the most productive scientific instruments ever built. The observatory has measured the expansion rate of the universe, identified candidate atmospheres around exoplanets and resolved the structure of distant galaxy clusters. NASA expects the telescope to remain operational into the late 2020s, after which a controlled re-entry over an unpopulated stretch of the Pacific Ocean is planned.`,
    instructions:
      "Scan the passage and answer with NO MORE THAN THREE WORDS or a number.",
    items: [
      {
        prompt: "1. On what exact date was Hubble launched?",
        answer: "24 April 1990",
        acceptable: ["April 24 1990", "24 April, 1990"],
      },
      {
        prompt:
          "2. What is the diameter of Hubble's primary mirror, in metres?",
        answer: "2.4",
        acceptable: ["2.4 metres", "2.4 m"],
      },
      {
        prompt:
          "3. In which month and year did the first repair mission take place?",
        answer: "December 1993",
      },
      {
        prompt:
          "4. How many peer-reviewed papers have cited Hubble observations?",
        answer: "19,000",
        acceptable: ["19000", "more than 19,000", "over 19,000"],
      },
      {
        prompt: "5. Where is the planned controlled re-entry to take place?",
        answer: "Pacific Ocean",
        acceptable: ["the Pacific Ocean", "Pacific"],
      },
    ],
    analysis: `Each answer can be located by scanning for a distinctive feature: a date (1, 3), a numerical figure (2, 4) or a proper noun (5). Numerals and capitalised words leap off the page even before the surrounding sentence is read in detail.`,
  },
  {
    id: "scn-b2-302",
    type: "scanning",
    ...
    passage: `The Channel Tunnel, which links Folkestone in southern England with Coquelles near Calais in northern France, was officially opened by Queen Elizabeth II and President François Mitterrand on 6 May 1994. Construction had begun in December 1987 and required the simultaneous operation of eleven tunnel-boring machines digging from both coasts. The completed system consists of three parallel tubes — two single-track rail tunnels and a smaller central service tunnel — running for 50.5 kilometres, of which approximately 38 kilometres lie beneath the seabed of the English Channel. The project ultimately cost around £4.65 billion, roughly 80 per cent more than its original estimate. In commercial service, the high-speed Eurostar passenger trains complete the journey from London to Paris in just over two hours, while heavy-goods vehicles are carried on dedicated shuttle trains operated by Eurotunnel. More than 500 million passengers had travelled through the tunnel by the time of its thirtieth anniversary.`,
    instructions:
      "Scan the passage and answer with NO MORE THAN THREE WORDS or a number.",
    items: [
      {
        prompt:
          "1. On what exact date was the Channel Tunnel officially opened?",
        answer: "6 May 1994",
        acceptable: ["May 6 1994", "6 May, 1994"],
      },
      {
        prompt:
          "2. How many tunnel-boring machines were used during construction?",
        answer: "11",
        acceptable: ["eleven"],
      },
      {
        prompt: "3. What is the total length of the tunnel, in kilometres?",
        answer: "50.5",
        acceptable: ["50.5 kilometres", "50.5 km"],
      },
      {
        prompt: "4. Approximately how much did the project cost (in pounds)?",
        answer: "£4.65 billion",
        acceptable: ["4.65 billion", "£4.65bn"],
      },
      {
        prompt:
          "5. How long does the Eurostar journey from London to Paris take?",
        answer: "two hours",
        acceptable: ["just over two hours", "2 hours"],
      },
    ],
    analysis: `The questions ask for dates, quantities and a duration — each easily located by scanning for a distinctive numeral or proper noun rather than by reading the entire passage.`,
  },
  {
    id: "scn-b2-303",
    type: "scanning",
    ...
    analysis: `Each answer is a discrete fact — a date, a place, a name, a year and a base pairing — that can be picked out at a glance by scanning for keywords (Nobel, photograph, adenine).`,
  },
  ...
  // ───────────────────── 3. Matching Headings (need +11) ─────────────────────
  {
    ...
    passage: `[A] In its earliest form, microfinance grew out of small experimental loans made to landless villagers in Bangladesh in the 1970s. Founders such as Muhammad Yunus argued that even very poor borrowers, lacking collateral and excluded from the formal banking system, could be reliably lent to in tiny amounts when group structures encouraged repayment.
...
[D] More recent assessments suggest that microfinance is best understood as a useful financial tool rather than as a stand-alone cure for poverty. Where it has been combined with savings products, simple insurance and digital payments, it has improved household resilience; where it has been deployed as an isolated programme, results have been modest.`,
    ...
    options: [
      ...
      {
        label: "iii",
        text: "Rapid international expansion through donor support",
      },
      {
        label: "iv",
        text: "Problems of over-indebtedness and regulatory response",
      },
      { label: "v", text: "Why microfinance has been completely abandoned" },
      {
        label: "vi",
        text: "A more measured view of its place in development policy",
      },
      {
        label: "vii",
        text: "The history of formal commercial banking in Asia",
      },
    ],
    items: [
    ...
    analysis: `A → i: Bangladesh origins, Yunus, group lending.
...
ii (mathematics), v (abandoned) and vii (commercial banking history) are distractors not supported by the text.`,
  },
  {
    ...
    passage: `[A] Although certain folk remedies based on mouldy bread had been used for centuries, the modern era of antibiotic medicine is conventionally dated to Alexander Fleming's chance observation in 1928 that a Penicillium mould inhibited bacterial growth on a contaminated culture plate.
...
[D] The widespread, often indiscriminate use of these drugs in human medicine and animal agriculture has, however, accelerated the evolution of resistant bacterial strains. Public-health agencies now warn that without sustained investment in new antibiotic discovery and the careful stewardship of existing drugs, parts of modern medicine could once again become hazardous.`,
    ...
    options: [
      {
        label: "i",
        text: "From a chance observation to a recognised discovery",
      },
      ...
      {
        label: "v",
        text: "Resistance and the threat of returning vulnerability",
      },
    ...
    analysis: `A → i: Fleming's chance observation in 1928.
...
ii, vi and vii are distractors not supported by the text.`,
  },
  {
    ...
    topic: "History · Trade",
    passage: `[A] Although tea bushes are native to a region overlapping south-west China, north-east India and the upper reaches of Burma, the systematic cultivation of Camellia sinensis for drinking is generally traced to imperial China, where written records describe its use both as a beverage and as a herbal medicine more than two thousand years ago.
...
[D] In the twenty-first century, tea remains the second most consumed beverage in the world after water. Producer countries are increasingly experimenting with single-origin and speciality teas in an effort to capture more of the value of the supply chain, much of which has historically been retained by blenders and brand owners in importing countries.`,
    ...
    analysis: `A → i: ancient China, more than 2,000 years.
...
iv, vi and vii are distractors with no textual support (note that the passage in fact says tea is SECOND only to water, not overtaken by coffee).`,
  ...
  // ───────────────────── 4. Matching Information (need +10) ─────────────────────
  {
    ...
    passage: `[A] Mountain glaciers form wherever annual snowfall exceeds annual melt for long enough that compacted snow recrystallises into dense glacial ice. Once a glacier reaches sufficient thickness, gravity causes it to flow slowly downhill, sculpting the U-shaped valleys that characterise heavily glaciated landscapes.
...
[D] Beyond water supply, retreating glaciers also expose unstable slopes that can fail catastrophically as glacial lakes form behind moraine dams. Several recent flood events in the Himalayas have been linked to such glacial-lake outburst floods, prompting investment in early-warning systems and dam-strengthening works.`,
    ...
    items: [
      {
        prompt: "1. A reference to investment in early-warning systems.",
        answer: "D",
      },
      {
        prompt:
          "2. The role of glaciers in maintaining river flow during the dry season.",
        answer: "C",
      },
      {
        prompt: "3. Evidence of accelerated glacier retreat since the 1980s.",
        answer: "B",
      },
      {
        prompt: "4. An explanation of how glacial ice is initially formed.",
        answer: "A",
      },
      {
        prompt: "5. A geographical region especially dependent on summer melt.",
        answer: "C",
      },
    ],
    analysis: `1 → D: "investment in early-warning systems and dam-strengthening works".
...
5 → C: "central Andes and the Hindu Kush–Himalaya".`,
  },
  {
    ...
    topic: "History · Trade",
    passage: `[A] Coffee is generally believed to have been first cultivated as a beverage crop in the highlands of southern Ethiopia, with the most familiar legend attributing its discovery to a goatherd named Kaldi who noticed his animals grew unusually energetic after eating the red berries of a particular shrub.
...
[D] Today, coffee is among the most heavily traded agricultural commodities in the world. Demand for higher-quality, traceable beans has driven the rise of specialty coffee in importing countries, while producer cooperatives have begun to capture a larger share of value through direct trade and certification schemes.`,
    ...
    items: [
      {
        prompt:
          "1. The traditional story of how coffee's effects were first noticed.",
        answer: "A",
      },
      {
        prompt: "2. A reference to direct-trade and certification schemes.",
        answer: "D",
      },
      { prompt: "3. The reason Sufi communities valued coffee.", answer: "B" },
      {
        prompt: "4. The country that became the world's largest producer.",
        answer: "C",
      },
      {
        prompt:
          "5. The role of a particular Yemeni port in the early coffee trade.",
        answer: "B",
      },
    ],
    analysis: `1 → A: the goatherd Kaldi.
...
Zaha Hadid, born in Baghdad and based for most of her career in London, became known in the early twenty-first century for fluid, parametric forms generated with the aid of digital modelling tools. In 2004 she became the first woman to receive the Pritzker Prize, the highest international award in architecture.`,
    instructions:
      "Match each statement with the correct architect (A, B or C).",
    options: [
    ...
    items: [
      ...
      {
        prompt: "2. Used digital modelling to generate fluid forms.",
        answer: "C",
      },
      {
        prompt: '3. Set out the famous "Five Points" of modern architecture.',
        answer: "A",
      },
      {
        prompt: "4. Was the first woman to win the Pritzker Prize.",
        answer: "C",
      },
      { prompt: "5. Drew up the master plan for an Indian city.", answer: "A" },
    ],
    analysis: `Each statement maps to one architect via a unique signature: Fallingwater → B, parametric/digital forms → C, Five Points → A, first woman Pritzker → C, Chandigarh master plan → A. Cambridge tip: read all three biographies once, then return to each statement and look for the most distinctive keyword.`,
  },
  {
    id: "mf-b2-302",
    type: "matching_features",
...
In the mid-twentieth century, the American virologist Jonas Salk led the development of the first effective vaccine against poliomyelitis, an inactivated-virus injection that was approved for general use in 1955. Salk famously declined to patent the vaccine, arguing that public-health benefits should not be limited by commercial considerations.`,
    ...
    items: [
      {
        prompt: "1. Refused to patent the vaccine they developed.",
        answer: "C",
      },
      {
        prompt: "2. Used cowpox material to protect against smallpox.",
        answer: "A",
      },
      {
        prompt: "3. Treated a young boy bitten by a rabid dog in 1885.",
        answer: "B",
      },
      {
        prompt: "4. Developed a process for making milk safer to drink.",
        answer: "B",
      },
      {
        prompt: "5. Was active in late eighteenth-century rural England.",
        answer: "A",
      },
    ],
    analysis: `1 → C: Salk, declined to patent.
...
5 → A: Jenner, English country doctor in the 1790s. Cambridge tip: features can recur for the same person; check each statement on its own merits.`,
  ...
  // ───────────────────── 6. Matching Sentence Endings (need +11) ─────────────────────
  {
    ...
    items: [
      ...
      {
        prompt: "4. The North Atlantic component of the circulation…",
        answer: "E",
      },
    ],
    analysis: `1 → A: Gulf Stream "carries warm water across the North Atlantic".
...
D and F are distractors: depth access is not discussed, and F directly contradicts the text.`,
  },
  {
    ...
    options: [
      ...
      {
        label: "C",
        text: "required massive migration from countryside to town.",
      },
      { label: "D", text: "had been completely abandoned by 1900." },
      {
        label: "E",
        text: "invested heavily in technical education and university–industry links.",
      },
      { label: "F", text: "produced no social conflict whatever." },
    ],
    items: [
      {
        prompt: "1. The first sustained industrial transformation…",
        answer: "A",
      },
      {
        prompt: "2. The steam engine, before it was adapted to factories,…",
        answer: "B",
      },
      {
        prompt: "3. The spread of industry across Europe and North America…",
        answer: "C",
      },
      {
        prompt:
          "4. Germany and the United States, by the late nineteenth century,…",
        answer: "E",
      },
    ],
    analysis: `1 → A: "first sustained industrial transformation took place in late eighteenth-century Britain".
...
D and F are distractors; both directly contradict the text.`,
  },
  {
    ...
    analysis: `1 → A: "average sleep duration has fallen by close to an hour per night since the mid-twentieth century".
...
5 TRUE: "Mehmed himself…formally protected the city's surviving Greek Orthodox patriarchate".`,
  },
  {
    ...
    items: [
      {
        prompt:
          "1. Modern domestic horses are descended from a single ancestral population first tamed on the western Eurasian steppe.",
        answer: "TRUE",
      },
      {
        prompt:
          "2. Earlier locally tamed horse populations elsewhere in Eurasia survived alongside the new domestic horse.",
        answer: "FALSE",
      },
      {
        prompt:
          "3. Horses had been used in chariot warfare for centuries before the steppe domestication began.",
        answer: "FALSE",
      },
      {
        prompt:
          "4. The fastest mounted couriers could cover several hundred kilometres in a single day.",
        answer: "NOT GIVEN",
      },
      {
        prompt:
          "5. Horses had lived in the Americas long before Europeans reintroduced them in the late fifteenth century.",
        answer: "TRUE",
      },
    ],
    analysis: `1 TRUE: the passage states that the modern domestic horse descends from animals tamed there around 4,200 years ago.
...
5 TRUE: horses "had in fact roamed the continent in prehistoric times".`,
  ...
  // ───────────────────── 8. Multiple Choice (need +8) ─────────────────────
  {
    ...
    passage: `Carbon-offset programmes invite individuals and companies to compensate for their greenhouse-gas emissions by paying for projects — typically forest protection, tree planting or renewable-energy installations — that are claimed to remove or avoid an equivalent quantity of carbon dioxide elsewhere. In principle, the arrangement allows hard-to-decarbonise activities, such as long-haul aviation, to continue while genuine reductions are achieved at lower cost in another sector. In practice, audits of the largest forest-based programmes have repeatedly suggested that a substantial proportion of the offsets sold do not represent additional carbon savings, either because the protected forest was not in fact under serious threat or because emissions are merely displaced to nearby unprotected areas. Recent reforms — including stricter baselines, satellite monitoring and the introduction of independent verification — have begun to address the most egregious failures. Most analysts now argue, however, that high-quality offsets can play only a supporting role in climate strategy and cannot substitute for direct reductions at source.`,
    instructions: "Choose the BEST answer.",
    options: [
      {
        label: "A",
        text: "All carbon-offset programmes are fraudulent and should be banned.",
      },
      {
        label: "B",
        text: "Carbon offsets can usefully complement, but not replace, direct emission reductions.",
      },
      {
        label: "C",
        text: "Forest-based offsets are technically perfect and require no further oversight.",
      },
      {
        label: "D",
        text: "Offsets are most valuable when emissions are very easy to reduce at source.",
      },
    ],
    items: [
      {
    ...
    analysis: `B is correct: the closing sentence says high-quality offsets "can play only a supporting role…cannot substitute for direct reductions at source".
...
D inverts the logic — offsets are most attractive precisely where direct reductions are HARD, e.g. long-haul aviation.`,
  },
  {
    ...
    options: [
      {
        label: "A",
        text: "Online retail growth will inevitably make urban congestion worse.",
      },
      {
        label: "B",
        text: "Micro-hub delivery schemes appear promising but face real-estate and competitive challenges.",
      },
      {
        label: "C",
        text: "Cargo bicycles are the only future of urban delivery.",
      },
      {
        label: "D",
        text: "Pilot projects have shown that delivery times always become much longer.",
      },
    ],
    items: [
      {
    ...
    analysis: `B is correct: pilots have shown promise (less van traffic, similar delivery times) but viability is constrained by real-estate prices and competitive willingness.
...
D inverts the finding — pilots show "little difference to overall delivery times".`,
  },
  {
    ...
    analysis: `B is correct: bilinguals "perform better on average" on inhibition and switching tasks, and brain regions for executive control are recruited differently.
...
D overstates the dementia evidence ("tentatively…remain disputed").`,
  },
  {
    ...
    analysis: `B is correct: total text consumption has "almost certainly risen"; what has changed is form (printed books → screens) and depth (long-form vs. skimming).
...
D is not proposed; the writer endorses programmes that protect time for unhurried reading, not bans.`,
  },
  {
    ...
    analysis: `B is correct: declines are "confirmed in many habitats" but vary by region/order/group, and recovery is "likely to be measured in decades rather than years".
...
D inverts the writer's caution about timescales.`,
  },
  {
    ...
    analysis: `C is correct: the writer endorses "activity-based working" as the more promising direction.
...
D contradicts the cognitive-performance findings.`,
  },
  {
    ...
    analysis: `B is correct: vocabulary differences reflect "the way meanings are packaged", not differences in expressive capacity.
...
D overstates: the active vocabularies fall within a similar range, not exactly equal.`,
  },
  {
    ...
    analysis: `C is correct: the passage argues that visits, events and digital lending often more than compensate for falling printed loans, and that managers favour reinvention.
