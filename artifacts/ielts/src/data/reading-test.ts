        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "Vertical tubes are used to grow strawberries, __________ and herbs.",
                answer: "lettuces",
              },
              {
                num: 2,
                text: "There will eventually be a daily harvest of as much as __________ in weight of fruit and vegetables.",
                answer: "1,000 kg",
                alternateAnswers: ["1000 kg"],
              },
              {
                num: 3,
                text: "It may be possible that the farm's produce will account for as much as 10% of the city's __________ overall.",
                answer: "consumption",
                alternateAnswers: ["(food) consumption", "food consumption"],
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 4,
                text: "Intensive farming — Growth: wide range of __________ used; techniques pollute air",
                answer: "pesticides",
              },
              {
                num: 5,
                text: "Intensive farming — Selection: varieties of fruit and vegetables chosen that can survive long __________",
                answer: "journeys",
              },
              {
                num: 6,
                text: "Intensive farming — Sale: __________ receive very little of overall income",
                answer: "producers",
              },
              {
                num: 7,
                text: "Aeroponic urban farming — Selection: produce chosen because of its __________",
                answer: "flavour",
                alternateAnswers: ["flavor"],
              },
            ],
          },
          {
        ...
        questionSections: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 22,
                text: "Some dead wood is removed to avoid the possibility of __________.",
                answer: "fire",
              },
              {
                num: 23,
                text: "The __________ from the tops of cut trees can help improve soil quality.",
                answer: "nutrients",
              },
              {
                num: 24,
                text: "Some damaged trees should be left, as their __________ provide habitats for a range of creatures.",
                answer: "cavities",
              },
              {
                num: 25,
                text: "Some trees that are small, such as __________, are a source of food for animals and insects.",
                answer: "hawthorn",
              },
              {
                num: 26,
                text: "Any trees that are __________ should be left to grow, as they add to the variety of species in the forest.",
                answer: "rare",
              },
            ],
          },
        ...
        questionSections: [
          {
            ...
            questions: [
              ...
              {
                num: 31,
                text: "a reference to efforts to classify space junk",
                answer: "B",
              },
            ],
            options: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 32,
                text: "The committee gives advice on how the __________ of space can be achieved.",
                answer: "sustainability",
              },
              {
                num: 33,
                text: "The committee advises that when satellites are no longer active, any unused __________ or pressurised material that could cause",
                answer: "fuel",
              },
              {
                num: 34,
                text: "__________ should be removed.",
                answer: "explosions",
              },
              {
                num: 35,
                text: "Although operators of large satellite constellations accept that they have obligations as stewards of space, Holger Krag points out that the operators that become __________ are unlikely to prioritise removing their satellites from space.",
                answer: "bankrupt",
              },
            ],
          },
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "There are other parrots that share the kākāpō's inability to fly.",
                answer: "FALSE",
              },
              {
                num: 2,
                text: "Adult kākāpō produce chicks every year.",
                answer: "FALSE",
              },
              {
                num: 3,
                text: "Adult male kākāpō bring food back to nesting females.",
                answer: "FALSE",
              },
              {
                num: 4,
                text: "The Polynesian rat was a greater threat to the kākāpō than Polynesian settlers.",
                answer: "NOT GIVEN",
              },
              {
                num: 5,
                text: "Kākāpō were transferred from Rakiura Island to other locations because they were at risk from feral cats.",
                answer: "TRUE",
              },
              {
                num: 6,
                text: "One Recovery Plan initiative that helped increase the kākāpō population size was caring for struggling young birds.",
                answer: "TRUE",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 7,
                text: "A type of parrot: diet consists of fern fronds, various parts of a tree and __________.",
                answer: "bulbs",
              },
              {
                num: 8,
                text: "Nests are created in __________ where eggs are laid.",
                answer: "soil",
              },
              {
                num: 9,
                text: "Arrival of Polynesian settlers: the __________ of the kākāpō were used to make clothes.",
                answer: "feathers",
              },
              {
                num: 10,
                text: "Arrival of European colonisers: __________ were an animal which they introduced that ate the kākāpō's food sources.",
                answer: "deer",
              },
              {
                num: 11,
                text: "A definite sighting of female kākāpō on Rakiura Island was reported in the year __________.",
                answer: "1980",
              },
              {
                num: 12,
                text: "The Recovery Plan included an increase in __________.",
                answer: "funding",
              },
              {
                num: 13,
                text: "A current goal of the Recovery Plan is to maintain the involvement of __________ in kākāpō protection.",
                answer: "stakeholders",
              },
            ],
          },
        ...
        questionSections: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 24,
                text: "For hundreds of years, the only tree that was more popular in Britain than elm was __________.",
                answer: "oak",
              },
              {
                num: 25,
                text: "Starting in the Bronze Age, many tools were made from elm and people also used it to make weapons. In the 18th century, it was grown to provide wood for boxes and __________.",
                answer: "flooring",
              },
              {
                num: 26,
                text: "Due to its strength, elm was often used for mining equipment and the Cutty Sark's __________ was also constructed from elm.",
                answer: "keel",
              },
            ],
          },
        ...
        questionSections: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: "B",
                text: "took relatively little notice of bad news.",
              },
              {
                label: "C",
                text: "responded to negative and positive information in the same way.",
              },
              { label: "D", text: "were feeling under stress." },
              { label: "E", text: "put them in a stressful situation." },
              {
                label: "F",
                text: "behaved in a similar manner, regardless of the circumstances.",
              },
              {
                label: "G",
                text: "thought it more likely that they would experience something bad.",
              },
            ],
          },
          {
  ...
  },
  {
    ...
    passages: [
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "Appearance: look similar to dugongs, but with a differently shaped __________.",
                answer: "tail",
              },
              {
                num: 2,
                text: "Movement: need to use their __________ to help to turn their bodies around in order to look sideways.",
                answer: "flippers",
              },
              {
                num: 3,
                text: "Movement: sense vibrations in the water by means of __________ on their skin.",
                answer: "hairs",
                alternateAnswers: ["hair"],
              },
              {
                num: 4,
                text: "Feeding: eat mainly aquatic vegetation, such as __________.",
                answer: "seagrasses",
              },
              {
                num: 5,
                text: "Feeding: grasp and pull up plants with their __________.",
                answer: "lips",
              },
              {
                num: 6,
                text: "Breathing: may regulate the __________ of their bodies by using muscles of diaphragm to store air internally.",
                answer: "buoyancy",
              },
            ],
          },
        ...
        questionSections: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 17,
                text: "Many people think that procrastination is the result of __________.",
                answer: "laziness",
              },
              {
                num: 18,
                text: "The tasks we are most likely to put off are those that could damage our self-esteem or cause us to feel __________ when we think about them.",
                answer: "anxious",
              },
              {
                num: 19,
                text: "Research comparing chronic procrastinators with other people even found differences in the brain regions associated with regulating emotions and identifying __________.",
                answer: "threats",
              },
              {
                num: 20,
                text: "Getting ready to take __________ might be a typical example of a task that causes procrastination.",
                answer: "exams",
              },
              {
                num: 21,
                text: "People who are likely to procrastinate tend to be either __________ or those with low self-esteem.",
                answer: "perfectionists",
              },
              {
                num: 22,
                text: "Procrastination is only a short-term measure for managing emotions. It's often followed by a feeling of __________, which worsens our mood and leads to more procrastination.",
                answer: "guilt",
              },
            ],
          },
      ...
      },
      {
        ...
        subtitle:
          "The introduction of the Automated Ball-Strike System (ABS) in baseball and the debate around it",
        timeGuide: "You should spend about 20 minutes on Questions 27–40",
        questionRange: "Questions 27–40",
        paragraphs: [
          {
        ...
        questionSections: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 33,
                text: "Even after ABS was developed, MLB still wanted human umpires to shout out decisions as they had in their __________.",
                answer: "F",
              },
              {
                num: 34,
                text: "The umpire's job had, at one time, required a __________ about whether a ball was a strike.",
                answer: "D",
              },
              {
                num: 35,
                text: "A ball is considered a strike when the batter does not hit it and it crosses through a __________ extending approximately from the batter's knee to his chest.",
                answer: "H",
              },
              {
                num: 36,
                text: "In the past, __________ over strike calls were not uncommon.",
                answer: "B",
              },
              {
                num: 37,
                text: "One difference, however, is that during the first game DeJesus used ABS, strike calls were met with __________.",
                answer: "G",
              },
            ],
            options: [
    ...
    passages: [
      {
        ...
        subtitle:
          "How sustainable architecture and urban greening are transforming city skylines around the world",
        timeGuide: "You should spend about 20 minutes on Questions 1–13",
        questionRange: "Questions 1–13",
        paragraphs: [
          {
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "Stefano Boeri wanted to create buildings that would serve as an extension of the __________ rather than a substitute for it.",
                answer: "natural environment",
              },
              {
                num: 2,
                text: "Engineers initially doubted whether balconies could bear the weight of trees subjected to strong __________ at height.",
                answer: "winds",
              },
              {
                num: 3,
                text: "Research showed that the Bosco Verticale absorbs around 30 tonnes of __________ annually.",
                answer: "carbon dioxide",
              },
              {
                num: 4,
                text: "The ongoing care of the vegetation requires qualified __________ to descend the building facades.",
                answer: "arborists",
              },
              {
                num: 5,
                text: "In Liuzhou, China, an entire __________ has been planned with dozens of plant-covered buildings.",
                answer: "Forest City",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 6,
                text: "The Bosco Verticale was the first building in the world to feature trees on its balconies.",
                answer: "NOT GIVEN",
              },
              {
                num: 7,
                text: "The vegetation on the Bosco Verticale helps to reduce noise levels for people living in the building.",
                answer: "TRUE",
              },
              {
                num: 8,
                text: "Kestrels had been commonly seen in central Milan before the Bosco Verticale was built.",
                answer: "FALSE",
              },
              {
                num: 9,
                text: "The grey-water recycling system on the Bosco Verticale has eliminated all concerns about water use.",
                answer: "FALSE",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 10,
                text: "examples of how the vertical forest concept has been adopted in various countries",
                answer: "F",
              },
              {
                num: 11,
                text: "details of the financial and logistical difficulties associated with vertical forests",
                answer: "E",
              },
              {
                num: 12,
                text: "a description of the process used to test whether trees could survive on tall buildings",
                answer: "B",
              },
              {
                num: 13,
                text: "evidence that the vertical forest has attracted wildlife not previously found in the area",
                answer: "D",
              },
            ],
            options: [
      ...
      },
      {
        ...
        subtitle:
          "What neuroscience research reveals about the critical role sleep plays in learning and memory formation",
        timeGuide: "You should spend about 20 minutes on Questions 14–26",
        questionRange: "Questions 14–26",
        paragraphs: [
          {
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 14,
                text: "Memory consolidation is the process of stabilising new information into long-term __________.",
                answer: "storage",
              },
              {
                num: 15,
                text: "The deepest stage of NREM sleep is called __________ sleep.",
                answer: "slow-wave",
              },
              {
                num: 16,
                text: "During slow-wave sleep, the hippocampus __________ recently learned information.",
                answer: "replays",
              },
              {
                num: 17,
                text: "Procedural memories, such as motor skills, are linked to __________ sleep.",
                answer: "REM",
              },
              {
                num: 18,
                text: "Walker described sleep as performing a __________ function for the brain.",
                answer: "filing",
              },
              {
                num: 19,
                text: "Short __________ of 20–30 minutes can improve learning after new material is studied.",
                answer: "naps",
              },
            ],
          },
          {
            instruction:
              "Look at the following findings (Questions 20–22) and the list of researchers below.\nMatch each finding with the correct researcher, A–G.\nWrite the correct letter, A–G, in boxes 20–22 on your answer sheet.",
            type: "mcMatch",
            questions: [
              {
                num: 20,
                text: "Sleep-deprived people may develop memories of events that did not actually occur.",
                answer: "C",
              },
              {
                num: 21,
                text: "Depriving participants of a specific sleep stage impaired performance on a visual task.",
                answer: "A",
              },
              {
                num: 22,
                text: "Sleep strengthens memories of emotionally significant experiences more than neutral ones.",
                answer: "D",
              },
            ],
            options: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 23,
                text: "The proportion of REM sleep remains constant throughout the night.",
                answer: "NO",
              },
              {
                num: 24,
                text: "One night without sleep can reduce the brain's ability to take in new information by nearly half.",
                answer: "YES",
              },
              {
                num: 25,
                text: "The selective consolidation of emotional memories may have developed as a survival mechanism.",
                answer: "YES",
              },
              {
                num: 26,
                text: "All schools that adopted later start times saw improvements in student grades.",
                answer: "NOT GIVEN",
              },
            ],
          },
      ...
      },
      {
        ...
        subtitle:
          "How researchers and governments are rethinking the measurement of national wellbeing beyond traditional economic indicators",
        timeGuide: "You should spend about 20 minutes on Questions 27–40",
        questionRange: "Questions 27–40",
        paragraphs: [
          {
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 27,
                text: "GDP is an adequate measure of a nation's overall quality of life.",
                answer: "NO",
              },
              {
                num: 28,
                text: "Easterlin found that increases in national income always led to corresponding increases in happiness.",
                answer: "NO",
              },
              {
                num: 29,
                text: "Bhutan's GNH framework has been universally accepted as superior to GDP.",
                answer: "NO",
              },
              {
                num: 30,
                text: "The Nordic countries' high happiness levels are primarily due to their natural resources.",
                answer: "NO",
              },
              {
                num: 31,
                text: "Self-report surveys of happiness can be affected by temporary factors such as the weather.",
                answer: "YES",
              },
              {
                num: 32,
                text: "New Zealand was the first country to allocate its entire national budget based on wellbeing criteria.",
                answer: "NOT GIVEN",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 33,
                text: "Easterlin observed that after basic needs are satisfied, more income produces __________ in happiness.",
                answer: "E",
              },
              {
                num: 34,
                text: "Bhutan's GNH index is compiled from surveys that assess __________ across nine areas.",
                answer: "A",
              },
              {
                num: 35,
                text: "The Nordic model shows that happiness correlates more with __________ than with national wealth.",
                answer: "G",
              },
              {
                num: 36,
                text: "The UK's well-being programme measures __________ together with standard economic statistics.",
                answer: "C",
              },
              {
                num: 37,
                text: "Policymakers face the difficulty of proving __________ between individual policies and wellbeing changes.",
                answer: "F",
              },
            ],
            options: [
    ...
    passages: [
      {
        ...
        subtitle:
          "Why soil health is fundamental to global food security and environmental sustainability",
        timeGuide: "You should spend about 20 minutes on Questions 1–13",
        questionRange: "Questions 1–13",
        paragraphs: [
          {
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "A single teaspoon of healthy soil can contain as many as __________ bacteria.",
                answer: "one billion",
                alternateAnswers: ["1 billion"],
              },
              {
                num: 2,
                text: "Mycorrhizal fungi form symbiotic associations with the roots of about __________ of all plant species.",
                answer: "90 per cent",
                alternateAnswers: ["90 percent", "90%"],
              },
              {
                num: 3,
                text: "Each year, the world loses around __________ of fertile topsoil.",
                answer: "24 billion tonnes",
              },
              {
                num: 4,
                text: "Soils store approximately __________ of carbon globally, making them the largest land-based carbon reservoir.",
                answer: "2,500 gigatonnes",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 5,
                text: "The majority of soil microorganism species have already been identified and classified.",
                answer: "FALSE",
              },
              {
                num: 6,
                text: "Excessive tillage helps to preserve organic matter in the soil.",
                answer: "FALSE",
              },
              {
                num: 7,
                text: "Regenerative farms studied in Nature Food produced lower yields than conventional farms.",
                answer: "FALSE",
              },
              {
                num: 8,
                text: "Biochar application is one method that can help lock carbon into the soil.",
                answer: "TRUE",
              },
              {
                num: 9,
                text: "The 4 per 1000 programme was established before the Paris Climate Conference.",
                answer: "FALSE",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 10,
                text: "a description of the obstacles to widespread adoption of soil-friendly farming",
                answer: "F",
              },
              {
                num: 11,
                text: "statistics illustrating the rate at which soil is being lost globally",
                answer: "C",
              },
              {
                num: 12,
                text: "an explanation of how fungi assist plants in obtaining nutrients",
                answer: "B",
              },
              {
                num: 13,
                text: "details of farming methods designed to improve rather than merely maintain soil quality",
                answer: "D",
              },
            ],
            options: [
      ...
      },
      {
        ...
        subtitle:
          "The promise and ethical challenges of AI-driven diagnostics and medical decision-making",
        timeGuide: "You should spend about 20 minutes on Questions 14–26",
        questionRange: "Questions 14–26",
        paragraphs: [
          {
        ...
        questionSections: [
          {
            instruction:
              "Look at the following statements (Questions 14–18) and the list of researchers/institutions below.\nMatch each statement with the correct researcher or institution, A–G.\nWrite the correct letter, A–G, in boxes 14–18 on your answer sheet.",
            type: "mcMatch",
            questions: [
              {
                num: 14,
                text: "Created an AI system that predicted disease onset by learning from hundreds of thousands of patient records.",
                answer: "C",
              },
              {
                num: 15,
                text: "Demonstrated that an AI tool for resource allocation disadvantaged certain patient groups.",
                answer: "D",
              },
              {
                num: 16,
                text: "Developed an AI model that identified skin conditions as accurately as specialist doctors.",
                answer: "A",
              },
              {
                num: 17,
                text: "Suggested that the lack of transparency in AI conflicts with principles of medical ethics.",
                answer: "F",
              },
              {
                num: 18,
                text: "Argued that AI will enhance rather than replace the work of doctors.",
                answer: "G",
              },
            ],
            options: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 19,
                text: "Machine learning can screen millions of molecular __________ much faster than traditional methods.",
                answer: "compounds",
              },
              {
                num: 20,
                text: "AlphaFold solved a long-standing challenge related to predicting protein __________.",
                answer: "structure",
              },
              {
                num: 21,
                text: "Unlike conventional drugs, AI models may continue to __________ after receiving regulatory approval.",
                answer: "evolve",
              },
              {
                num: 22,
                text: "Many advanced AI models function as __________ boxes, making their reasoning difficult to interpret.",
                answer: "black",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 23,
                text: "AI diagnostic systems have consistently outperformed human clinicians in all medical specialities.",
                answer: "NO",
              },
              {
                num: 24,
                text: "The bias in the healthcare allocation algorithm was partly caused by historical patterns of spending.",
                answer: "YES",
              },
              {
                num: 25,
                text: "Most patients are comfortable with AI making healthcare decisions without any human involvement.",
                answer: "NO",
              },
              {
                num: 26,
                text: "Dr Topol believes that AI will enable doctors to devote more attention to interpersonal aspects of patient care.",
                answer: "YES",
              },
            ],
          },
      ...
      },
      {
        ...
        subtitle:
          "How the measurement of time has shaped human civilisation and continues to evolve",
        timeGuide: "You should spend about 20 minutes on Questions 27–40",
        questionRange: "Questions 27–40",
        paragraphs: [
          {
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 27,
                text: "Early sundials relied on a __________, or gnomon, to cast a shadow across a marked surface.",
                answer: "rod",
              },
              {
                num: 28,
                text: "Water clocks became inaccurate because changes in water __________ and pressure altered the flow rate.",
                answer: "temperature",
              },
              {
                num: 29,
                text: "Mechanical clocks introduced the idea of equal hours, replacing the __________ hours used in earlier times.",
                answer: "variable-length",
              },
              {
                num: 30,
                text: "Huygens's pendulum clock could be affected by changes in temperature and by __________ variations at different locations.",
                answer: "gravity",
              },
              {
                num: 31,
                text: "Quartz clocks work by applying an electric current to a crystal, causing it to __________ at a consistent frequency.",
                answer: "vibrate",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 32,
                text: "Sundials were effective timekeeping devices regardless of weather conditions.",
                answer: "FALSE",
              },
              {
                num: 33,
                text: "Su Song's clock tower in China was built in the eleventh century.",
                answer: "TRUE",
              },
              {
                num: 34,
                text: "The pendulum clock was the dominant precision timekeeper for approximately 300 years.",
                answer: "TRUE",
              },
              {
                num: 35,
              ...
              {
                num: 36,
                text: "The standardisation of time zones was primarily motivated by the needs of the railway industry.",
                answer: "TRUE",
              },
            ],
          },
...
export function calculateBand(correct: number): {
  band: number;
  label: string;
} {
...
export function getRecommendation(band: number): string {
  if (band >= 8)
    return "Excellent performance! You demonstrate a strong command of reading comprehension. Keep practicing with more challenging academic texts to maintain your edge. Focus on speed and accuracy for test-day confidence.";
  if (band >= 7)
    return "Great work! You have a good grasp of reading skills. To push higher, practice skimming and scanning techniques, and work on identifying paraphrased information more quickly. Pay close attention to NOT GIVEN vs FALSE distinctions.";
  if (band >= 6)
    return "You're on the right track! Focus on building your vocabulary, especially academic words. Practice identifying main ideas vs details. Work on time management — try to spend no more than 20 minutes per passage. Read more English newspapers and journals regularly.";
  if (band >= 5)
    return "Keep working! Focus on understanding paragraph structure and how ideas connect. Practice TRUE/FALSE/NOT GIVEN questions carefully — many students confuse FALSE with NOT GIVEN. Build your vocabulary with word lists and read English content daily for at least 30 minutes.";
...
export function getArabicRecommendation(band: number): string {
  if (band >= 8)
    return "أداء ممتاز! استمر في التدرب على النصوص الأكاديمية المتقدمة للحفاظ على مستواك العالي.";
  if (band >= 7)
    return "عمل رائع! ركّز على تقنيات القراءة السريعة وتحديد المعلومات المُعاد صياغتها بشكل أسرع.";
  if (band >= 6)
    return "أنت على الطريق الصحيح! ركّز على بناء مفرداتك الأكاديمية وإدارة الوقت — لا تتجاوز ٢٠ دقيقة لكل نص.";
  if (band >= 5)
    return "استمر في العمل! تدرّب على فهم بنية الفقرات وتمييز الفرق بين FALSE و NOT GIVEN. اقرأ محتوى إنجليزي يومياً.";
