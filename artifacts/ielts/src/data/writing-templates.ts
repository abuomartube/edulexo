...
export const LINKING_PHRASES: LinkingCategory[] = [
  {
    ...
    phrases: [
      {
        phrase: "Furthermore,",
        usage: "Adding a stronger, more formal point",
        example:
          "Furthermore, the government has allocated additional funds to address this issue.",
      },
      {
        phrase: "Moreover,",
        usage: "Adding an equally important point",
        example:
          "Moreover, research suggests that early intervention yields the best results.",
      },
      {
        phrase: "In addition to this,",
        usage: "Building on a previous point",
        example:
          "In addition to this, schools should implement anti-bullying programmes.",
      },
      {
        phrase: "What is more,",
        usage: "Emphasising an additional point",
        example: "What is more, the environmental benefits are significant.",
      },
      {
        phrase: "On top of that,",
        usage: "Semi-formal addition",
        example: "On top of that, employees report higher job satisfaction.",
      },
      {
        phrase: "Not only... but also...",
        usage: "Emphasising two connected points",
        example:
          "Not only does exercise improve physical health, but it also enhances mental wellbeing.",
      },
      {
        phrase: "Equally important is the fact that",
        usage: "Balancing two points of equal weight",
        example:
          "Equally important is the fact that cultural preservation strengthens national identity.",
      },
    ],
  },
  {
    ...
    phrases: [
      {
        phrase: "However,",
        usage: "Introducing an opposing point",
        example: "However, this approach has several significant drawbacks.",
      },
      {
        phrase: "On the other hand,",
        usage: "Presenting the opposite perspective",
        example:
          "On the other hand, some argue that tradition should be preserved.",
      },
      {
        phrase: "Nevertheless,",
        usage: "Conceding a point but maintaining position",
        example: "Nevertheless, the advantages far outweigh the disadvantages.",
      },
      {
        phrase: "Conversely,",
        usage: "Directly opposing the previous point",
        example: "Conversely, rural areas offer a more relaxed pace of life.",
      },
      {
        phrase: "Despite this,",
        usage: "Acknowledging then moving past a point",
        example:
          "Despite this, many countries continue to invest heavily in space exploration.",
      },
      {
        phrase: "While it is true that..., it is also important to consider...",
        usage: "Balanced concession",
        example:
          "While it is true that technology creates jobs, it is also important to consider the roles it eliminates.",
      },
      {
        phrase: "Although... ,",
        usage: "Subordinate contrast clause",
        example:
          "Although the initial costs are high, the long-term savings are substantial.",
      },
      {
        phrase: "In contrast,",
        usage: "Showing clear difference between two things",
        example:
          "In contrast, developing nations face entirely different challenges.",
      },
    ],
  },
  {
    ...
    phrases: [
      {
        phrase: "For instance,",
        usage: "Introducing a specific example",
        example:
          "For instance, countries like Sweden have successfully implemented this policy.",
      },
      {
        phrase: "To illustrate,",
        usage: "Providing a clarifying example",
        example:
          "To illustrate, consider the case of Japan's ageing population.",
      },
      {
        phrase: "A case in point is",
        usage: "Highlighting a specific, relevant example",
        example:
          "A case in point is the rapid development of renewable energy in Germany.",
      },
      {
        phrase: "This is evidenced by",
        usage: "Providing supporting evidence",
        example:
          "This is evidenced by the dramatic rise in online learning enrolments.",
      },
      {
        phrase: "One notable example is",
        usage: "Highlighting a significant example",
        example:
          "One notable example is Singapore's transformation from a developing to a developed nation.",
      },
      {
        phrase: "As demonstrated by",
        usage: "Referring to proof or evidence",
        example:
          "As demonstrated by recent studies, bilingual children develop stronger cognitive skills.",
      },
    ],
  },
  {
    ...
    phrases: [
      {
        phrase: "As a result,",
        usage: "Showing a direct consequence",
        example: "As a result, unemployment rates have fallen significantly.",
      },
      {
        phrase: "Consequently,",
        usage: "Formal cause-effect link",
        example:
          "Consequently, many families are unable to afford basic necessities.",
      },
      {
        phrase: "This leads to",
        usage: "Showing a chain of cause and effect",
        example: "This leads to increased pressure on healthcare systems.",
      },
      {
        phrase: "The primary reason for this is",
        usage: "Identifying the main cause",
        example:
          "The primary reason for this is the lack of investment in public infrastructure.",
      },
      {
        phrase: "This can be attributed to",
        usage: "Formally assigning cause",
        example:
          "This can be attributed to the growing influence of social media.",
      },
      {
        phrase: "Owing to",
        usage: "Formal cause at the start of a sentence",
        example:
          "Owing to rapid urbanisation, many cities face severe housing shortages.",
      },
      {
        phrase: "As a consequence of",
        usage: "Formal result",
        example:
          "As a consequence of globalisation, cultural boundaries have become increasingly blurred.",
      },
    ],
  },
  {
    ...
    phrases: [
      {
        phrase: "In my view,",
        usage: "Direct personal opinion",
        example:
          "In my view, education is the most effective tool for reducing poverty.",
      },
      {
        phrase: "I am of the opinion that",
        usage: "Formal opinion statement",
        example:
          "I am of the opinion that governments should prioritise renewable energy.",
      },
      {
        phrase: "From my perspective,",
        usage: "Softer personal opinion",
        example:
          "From my perspective, cultural exchange programmes are invaluable.",
      },
      {
        phrase: "I firmly believe that",
        usage: "Strong, confident opinion",
        example:
          "I firmly believe that access to clean water is a fundamental human right.",
      },
      {
        phrase: "It seems to me that",
        usage: "Tentative, considered opinion",
        example:
          "It seems to me that the benefits of technology are often overstated.",
      },
      {
        phrase: "I would argue that",
        usage: "Academic opinion with implied evidence",
        example:
          "I would argue that early childhood education has the greatest impact on future success.",
      },
    ],
  },
  {
    ...
    phrases: [
      {
        ...
        usage: "Standard conclusion opener",
        example:
          "In conclusion, both individuals and governments have a role to play.",
      },
      {
        phrase: "To sum up,",
        usage: "Brief summary conclusion",
        example:
          "To sum up, the advantages of remote work clearly outweigh the drawbacks.",
      },
      {
        phrase: "All things considered,",
        usage: "Balanced final assessment",
        example:
          "All things considered, I believe that a combination of approaches is most effective.",
      },
      {
        phrase: "Taking everything into account,",
        usage: "Comprehensive conclusion",
        example:
          "Taking everything into account, it is clear that urgent action is needed.",
      },
      {
        phrase: "Ultimately,",
        usage: "Final, decisive statement",
        example:
          "Ultimately, the responsibility lies with each individual to make informed choices.",
      },
      {
        phrase: "On balance,",
        usage: "Weighing both sides before concluding",
        example:
          "On balance, the evidence suggests that the policy has been largely successful.",
      },
    ],
  },
  {
    ...
    phrases: [
      {
        phrase: "rose sharply / increased dramatically",
        usage: "Large upward movement",
        example:
          "The number of tourists rose sharply from 2 million to 8 million.",
      },
      {
        phrase: "declined steadily / decreased gradually",
        usage: "Consistent downward movement",
        example: "Sales declined steadily over the five-year period.",
      },
      {
        phrase: "remained relatively stable / plateaued",
        usage: "Little or no change",
        example:
          "Expenditure on healthcare remained relatively stable at around 12%.",
      },
      {
        phrase: "fluctuated between... and...",
        usage: "Irregular changes",
        example:
          "Temperatures fluctuated between 15 and 25 degrees throughout the year.",
      },
      {
        phrase: "peaked at / reached a peak of",
        usage: "Highest point",
        example: "Unemployment peaked at 12% in 2010 before falling.",
      },
      {
        phrase: "hit a low of / bottomed out at",
        usage: "Lowest point",
        example: "Production hit a low of 500 units in the third quarter.",
      },
      {
        phrase: "There was a significant increase/decrease in",
        usage: "Noun phrase for trend",
        example:
          "There was a significant increase in the proportion of households with internet access.",
      },
      {
        phrase: "By contrast, / In comparison,",
        usage: "Comparing two data sets",
        example: "By contrast, expenditure on defence showed a marked decline.",
      },
    ],
  },
];
...
export const ESSAY_TEMPLATES: EssayTemplate[] = [
  {
    ...
    taskType: "Task 2",
    description:
      "You are given a statement and asked to what extent you agree or disagree, OR asked to give your opinion on an issue.",
    questionExample:
      "Some people believe that university students should pay the full cost of their education. To what extent do you agree or disagree?",
    structure: [
      {
        step: "Introduction (2-3 sentences)",
        description:
          "Paraphrase the question + state your clear position. Never copy the question word-for-word.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Paraphrases the question effectively (pay → bear the financial burden). States a clear position. Uses sophisticated vocabulary (contentious, notion, solely). Two sentences — concise but complete.",
        },
      },
      {
        step: "Body Paragraph 1 — Main Argument (5-6 sentences)",
        description:
          "Present your strongest argument supporting your position. Topic sentence → explanation → example → link back.",
        sentenceStarters: [
        ...
        sample: {
          ...
          highlightedPhrases: [
            ...
            "student debt has reached alarming levels",
            "undermining its own future workforce",
          ],
          commentary:
            "Clear topic sentence. Develops the idea fully with explanation + cause/effect + specific example (US). Final sentence links back to the wider impact. Good vocabulary range throughout.",
        },
      },
      {
        step: "Body Paragraph 2 — Supporting Argument (5-6 sentences)",
        description:
          "Add a second distinct argument. Don't repeat your first point — approach from a different angle.",
        sentenceStarters: [
        ...
        sample: {
          ...
          highlightedPhrases: [
            ...
            "public investment",
            "higher tax revenues, innovation, and increased productivity",
            "short-sighted",
          ],
          commentary:
            "New angle (public benefit) distinct from Paragraph 1 (inequality). Cites evidence (OECD). Sophisticated vocabulary (short-sighted, shift the financial responsibility). Logical chain: premise → evidence → conclusion.",
        },
      },
      {
        step: "Concession Paragraph (Optional, 3-4 sentences)",
        description:
          "Briefly acknowledge the opposing view, then explain why your position is stronger. This boosts your Coherence & Cohesion score.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Acknowledges the other side fairly, then dismantles it. Shows balanced thinking = higher CC score. Doesn't spend too long on the opposing view.",
        },
      },
      {
        step: "Conclusion (2-3 sentences)",
        description:
          "Restate your position in different words. DO NOT introduce new ideas. Optionally suggest a solution or future outlook.",
        sentenceStarters: [
        ...
        sample: {
          ...
          highlightedPhrases: [
            "socially unjust and economically counterproductive",
            "balanced approach",
            "shared funding",
            "individual aspirations and national interests",
          ],
          commentary:
            "Restates position without repeating the introduction word-for-word. Offers a practical solution. Ends on a forward-looking note. No new arguments introduced.",
        },
      },
    ],
    doList: [
...

  {
    ...
    taskType: "Task 2",
    description:
      "You are asked to discuss both views on an issue and then give your own opinion.",
    questionExample:
      "Some people think children should start formal education at a very early age. Others believe they should not begin until they are older. Discuss both views and give your own opinion.",
    structure: [
      {
        step: "Introduction (2-3 sentences)",
        description:
          "Paraphrase the topic + mention both views + give your position.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Three sentences covering: topic paraphrase, both views, and clear personal position. Sophisticated paraphrasing (start → commence, begin → delaying). Shows the examiner exactly what the essay will discuss.",
        },
      },
      {
        step: "Body Paragraph 1 — First View (5-6 sentences)",
        description:
          "Present the first view fairly and fully. Even if you disagree, develop it with reasons and examples.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Develops View A fully even though the writer disagrees. Uses evidence (developmental psychology, France). Specific age references show precision. Academic vocabulary throughout.",
        },
      },
      {
        step: "Body Paragraph 2 — Second View (5-6 sentences)",
        description:
          "Present the opposing view with equal depth. Then show why you lean towards this view (or neither).",
        sentenceStarters: [
        ...
        sample: {
          ...
          highlightedPhrases: [
            ...
            "renowned for their educational excellence",
            "counterproductive",
            "resilient, creative, and intrinsically motivated",
          ],
          commentary:
            "Equally developed as Body 1 — this is essential for a high CC score. Specific example (Finland). Challenges the first view directly. Final sentence provides a strong concluding idea.",
        },
      },
      {
        step: "Conclusion with Opinion (2-3 sentences)",
        description:
          "Summarise both views briefly, then clearly state which you support and why.",
        sentenceStarters: [
        ...
        sample: {
          ...
          highlightedPhrases: [
            ...
            "the evidence from high-performing education systems",
            "a more gradual approach",
            "lifelong learning",
          ],
          commentary:
            "References both views. Clear personal position supported by evidence mentioned in the essay. Forward-looking final sentence. No new arguments.",
        },
      },
    ],
    doList: [
...

  {
    ...
    taskType: "Task 2",
    description:
      "You are asked to identify problems caused by an issue and suggest solutions.",
    questionExample:
      "In many cities, the increasing number of cars is causing serious problems. What are the problems associated with this? What solutions can you suggest?",
    structure: [
      {
        step: "Introduction (2-3 sentences)",
        description:
          "Paraphrase the issue + indicate you will discuss problems and solutions.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Effective paraphrasing (cars → private vehicles, cities → urban areas). Clear roadmap for the essay. Formal academic register.",
        },
      },
      {
        step: "Body Paragraph 1 — Problems (5-6 sentences)",
        description:
          "Identify 2-3 problems with explanation and specific consequences.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Two clear problems: pollution + congestion. Each developed with causes and effects. WHO statistic adds authority. Specific city examples (Cairo, Jakarta). Connected with 'compounded by'.",
        },
      },
      {
        step: "Body Paragraph 2 — Solutions (5-6 sentences)",
        description:
          "Propose 2-3 realistic solutions with explanation of how they would work.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Three distinct solutions, each with explanation + evidence. Real-world examples (Tokyo, London, Stockholm). Solutions match the problems in Body 1. Progressive complexity: transport → pricing → urban planning.",
        },
      },
      {
        step: "Conclusion (2-3 sentences)",
        description:
          "Summarise the key problems and solutions. Optionally add a final recommendation.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Briefly restates problems and solutions. Optimistic but realistic tone. No new ideas. Strong final sentence.",
        },
      },
    ],
    doList: [
...

  {
    ...
    taskType: "Task 2",
    description:
      "You discuss the pros and cons of a given situation, trend, or proposal.",
    questionExample:
    ...
    structure: [
      {
        step: "Introduction (2-3 sentences)",
        description:
          "Paraphrase the topic + indicate you will examine both sides.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Strong paraphrase (working from home → remote working). Acknowledges both sides. 'Merit careful consideration' signals balanced analysis.",
        },
      },
      {
        step: "Body Paragraph 1 — Advantages (5-6 sentences)",
        description:
          "Present 2-3 advantages with clear explanations and examples.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Two clear advantages: flexibility + reduced commuting. Evidence from Stanford adds credibility. Connected ideas (productivity → financial → environmental).",
        },
      },
      {
        ...
        sample: {
          ...
          commentary:
            "Two disadvantages matching the depth of Body 1. 'Paradoxically' shows sophisticated word choice. Cause-effect chains clearly expressed.",
        },
      },
      {
        step: "Conclusion (2-3 sentences)",
        description:
          "Summarise both sides. If the question asks for your opinion, give it clearly.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Balanced summary. Offers a practical middle-ground. 'Pragmatic solution' — excellent vocabulary. Forward-looking ending.",
        },
      },
    ],
    doList: [
...

  {
    ...
    taskType: "Task 1",
    description:
      "Describe the main trends, comparisons, and key features of data presented in a line graph, bar chart, or similar visual.",
    questionExample:
      "The graph below shows the consumption of three types of fast food in Britain from 1970 to 2010.",
    structure: [
      {
        step: "Introduction (1-2 sentences)",
        description:
          "Paraphrase what the graph/chart shows. NEVER copy the question.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Single sentence paraphrasing the question. Specifies the time period. Uses 'illustrates changes in' instead of 'shows'.",
        },
      },
      {
        step: "Overview (2-3 sentences) — ESSENTIAL",
        description:
          "Summarise 2-3 main trends or key features. NO specific numbers here. This paragraph is CRITICAL — no overview = max Band 5.",
        sentenceStarters: [
        ...
        sample: {
          ...
          highlightedPhrases: [
            ...
            "dramatic rise",
            "significant decline",
            "overtaken both other categories",
          ],
          commentary:
            "Two key trends identified without specific numbers. Shows the examiner you can identify the 'big picture'. The word 'Overall' at the start signals this is the overview paragraph.",
        },
      },
      {
        step: "Body Paragraph 1 — Detail Group A (3-4 sentences)",
        description:
          "Describe specific data for one group/period. Include numbers, dates, and comparisons.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Specific data points with appropriate language (approximately, roughly). Trend vocabulary (tripled, surpassed, upward trajectory). Comparisons between categories.",
        },
      },
      {
        step: "Body Paragraph 2 — Detail Group B (3-4 sentences)",
        description:
          "Describe the remaining data. Draw comparisons where relevant.",
        sentenceStarters: [
          "In contrast, ...",
        ...
        sample: {
          ...
          highlightedPhrases: [
            ...
            "downward trend",
            "reached a low of",
            "represents a decline of roughly two-thirds",
          ],
          commentary:
            "Clear contrast with Body 1. Quantifies the change (two-thirds). Uses appropriate trend language (sustained decline, downward trend, reached a low).",
        },
      },
    ],
    doList: [
...

  {
    ...
    taskType: "Task 1",
    description:
      "Describe the stages of a natural or man-made process shown in a diagram.",
    questionExample:
    ...
    structure: [
      {
        step: "Introduction (1-2 sentences)",
        description:
          "Paraphrase what the diagram shows and mention the number of stages.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Paraphrases 'made' → 'manufacture', 'building' → 'construction'. Mentions the scope from start to finish. Single, clear sentence.",
        },
      },
      {
        step: "Overview (2 sentences)",
        description:
          "Summarise the overall process — how many stages, what it transforms from/to.",
        sentenceStarters: [
        ...
        sample: {
          ...
          highlightedPhrases: [
            "comprises seven distinct stages",
            "culminating in",
            "largely mechanised",
            "firing the raw material",
          ],
          commentary:
            "States total number of stages. Indicates start and end points. Describes the nature of the process (mechanised).",
        },
      },
      {
        step: "Body 1 — First Half of Process (4-5 sentences)",
        description:
          "Describe the first stages using passive voice and sequencing language.",
        sentenceStarters: [
        ...
        sample: {
          ...
          commentary:
            "Consistent use of passive voice (is extracted, is transported, is crushed). Sequencing words (then, following this, subsequently). Precise descriptions.",
        },
      },
      {
        step: "Body 2 — Second Half of Process (4-5 sentences)",
        description:
          "Continue describing the remaining stages to the end of the process.",
        sentenceStarters: [
          "At the next stage, ...",
        ...
        sample: {
          ...
          highlightedPhrases: [
            ...
            "undergo a quality inspection",
          ],
          commentary:
            "Continues the logical sequence. Includes specific data (temperatures). 'Undergo a quality inspection' — strong vocabulary. Ends at the natural conclusion of the process.",
        },
      },
    ],
    doList: [
