...
export const TASKS: Record<string, PlanTask> = {
  ...
  paragraph: {
    id: "paragraph",
    label: "Paragraph Writing (Orwell)",
    arabicLabel: "فقرة كتابية",
    emoji: "✍️",
    href: "/essay-checker",
    estimatedMinutes: 15,
  ...
  churchillP1: {
    id: "churchillP1",
    label: "Churchill — Part 1",
    arabicLabel: "تشرشل الجزء ١",
    emoji: "🎙️",
    href: "/speaking",
    estimatedMinutes: 10,
  ...
  churchillP2: {
    id: "churchillP2",
    label: "Churchill — Part 2",
    arabicLabel: "تشرشل الجزء ٢",
    emoji: "🎤",
    href: "/speaking",
    estimatedMinutes: 12,
  ...
  churchillP3: {
    id: "churchillP3",
    label: "Churchill — Part 3",
    arabicLabel: "تشرشل الجزء ٣",
    emoji: "🎙️",
    href: "/speaking",
    estimatedMinutes: 15,
  ...
  // Reading
  readingSkillsEasy: {
    id: "readingSkillsEasy",
    label: "Reading Skills (Easy)",
    arabicLabel: "مهارات القراءة (سهل)",
    emoji: "📖",
    href: "/reading-test",
    hash: "#skills",
    estimatedMinutes: 15,
  ...
  readingSkills: {
    id: "readingSkills",
    label: "Reading Section Practice",
    arabicLabel: "تمرين قسم القراءة",
    emoji: "📖",
    href: "/reading-test",
    hash: "#skills",
    estimatedMinutes: 25,
  ...
  listeningS3: {
    id: "listeningS3",
    label: "Listening — Section 3",
    arabicLabel: "الاستماع — القسم ٣",
    emoji: "🎧",
    href: "/listening-test",
    hash: "#skills-3",
    estimatedMinutes: 25,
  ...
  listeningS4: {
    id: "listeningS4",
    label: "Listening — Section 4",
    arabicLabel: "الاستماع — القسم ٤",
    emoji: "🎧",
    href: "/listening-test",
    hash: "#skills-4",
    estimatedMinutes: 30,
  ...
  storyExercises: {
    id: "storyExercises",
    label: "Story + Exercises",
    arabicLabel: "قصة وتمارين",
    emoji: "📚",
    href: "/stories",
    estimatedMinutes: 18,
  ...
  listeningMock: {
    ...
    arabicLabel: "اختبار استماع كامل",
    emoji: "🎬",
    href: "/listening-test",
    estimatedMinutes: 40,
    color: "from-amber-500 to-orange-500",
...
export function getWeeklySections(
  level: CefrLevel | string | null | undefined,
): PlanTask[] {
...
export function getPlanCoverage(
  ...
  const allIds = new Set<string>([
    ...counts.keys(),
    ...Object.keys(PLAN_CONTENT_CATALOGS),
  ]);
...
export function daysUntilExam(
  ...
  return Math.max(
    0,
    Math.round((exam.getTime() - today.getTime()) / 86_400_000),
  );
}
...
export function getPlanCompletionStats(
  ...
  return {
    ...
    todayIndex: Math.min(
      duration,
      Math.max(1, getPlanDayIndex(startISO, todayDate)),
    ),
