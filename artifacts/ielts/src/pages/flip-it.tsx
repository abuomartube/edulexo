        ...
        <div className="max-w-xl mx-auto mt-8 animate-in fade-in duration-300">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Race the clock. Read the English word, recall the meaning, then
              watch the card flip to reveal the answer.
            </p>
            <p
      ...
      <div className="max-w-xl mx-auto mt-4 sm:mt-6 animate-in fade-in duration-300">
        <div className="flex items-center justify-between mb-4 gap-2 flex-wrap">
          <div className="text-xs text-muted-foreground">
            <span className="font-bold text-foreground">{cardsSeen}</span> seen
            · Level {level}
          </div>
          <button
            onClick={endSession}
        ...
        {card && (
          <div className="perspective-1000">
            <div className={cn("flip-card", phase === "flipped" && "flipped")}>
              <div
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-muted/40 rounded-b-3xl overflow-hidden">
                    <div
                      className={cn(
                        ...
                        lowSeconds ? "bg-red-500" : "bg-amber-500",
                      )}
        ...
        {isCounting && (
          <p className="text-center text-xs text-muted-foreground mt-4">
            Listen for the tick. Try to recall the Arabic meaning before the
            card flips.
          </p>
        )}
