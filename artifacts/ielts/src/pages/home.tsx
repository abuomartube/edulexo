...
import {
  ...
  useStreak,
  useXp,
} from "@workspace/ielts-api-client-react";
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground leading-relaxed mb-1">
            Browse the full bilingual vocabulary list — 3,000 unique IELTS words
            across 4 CEFR levels (A2–C1), with Arabic translations for every
            word and example sentence.
          </p>
          <p
            className="text-sm text-teal-700 dark:text-teal-400 font-medium"
            dir="rtl"
            lang="ar"
          >
            قائمة المفردات الكاملة ثنائية اللغة · 3000 كلمة · 4 مستويات · ترجمة
            عربية لكل كلمة وجملة
          </p>
        </div>
        ...
        >
          <div className="relative z-10 max-w-xl">
            ...
            <p className="text-white/80 text-base mb-6 leading-relaxed">
              AI-powered speaking, listening, and reading tools — designed for
              A2–B1 learners.
              <span
                className="block mt-1 text-white/60 text-sm"
                dir="rtl"
                lang="ar"
              >
            ...
            <Link href="/free-conversation" className="block group">
              <div className="bg-card border border-teal-300/40 dark:border-teal-600/30 rounded-2xl p-6 hover:border-teal-400/60 hover:shadow-md transition-all h-full flex flex-col">
                ...
                <h3 className="text-lg font-bold text-foreground mb-1">
                  Churchill Free Conversation
                </h3>
                <p className="text-sm text-muted-foreground leading-relaxed flex-1">
                  Practice speaking English naturally with an AI partner — no
                  scripts, just real conversation.
                </p>
                <p
            ...
            <div>
              ...
              <div className="flex items-end gap-1">
                ...
                <span className="text-lg font-semibold text-muted-foreground mb-1">
                  day{streakInfo?.streak !== 1 ? "s" : ""}
                </span>
              </div>
              <p className="text-xs text-muted-foreground mt-1">
                {streakInfo?.totalDays ?? 0} total study days
              </p>
            </div>
          </div>
          <div className="bg-card border border-border rounded-2xl p-6 flex items-center gap-5">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-48 shrink-0">
              <img
                src="/owner.png"
                alt="Instructor"
                className="w-full h-auto md:h-full md:w-48 object-cover object-center block"
              />
            </div>
            <div className="p-7 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4 text-sm">
                ...
                — dedicated to helping Arabic-speaking students achieve their
                target IELTS band.
              </p>
              <a
      ...
      <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <section className="relative rounded-3xl overflow-hidden bg-primary px-8 py-12 shadow-lg">
          <div className="relative z-10 max-w-2xl">
            ...
            <p className="text-primary-foreground/80 text-lg mb-8 leading-relaxed">
              3,000 flashcards across A2–C1 levels, with Arabic translations,
              audio pronunciation and smart quizzes — built for Arabic-speaking
              IELTS students.
            </p>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          {wordOfDay && (
            <div
              id="word-of-day"
              data-tour="word-of-day"
              className="bg-card border border-primary/20 rounded-2xl p-6 relative overflow-hidden sm:col-span-2 lg:col-span-1"
            >
              ...
              <p className="text-xl font-bold arabic-text text-primary mb-2">
                {wordOfDay.arabic}
              </p>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link href="/weak-words" className="block">
            <div
              data-tour="weak-words"
              className="bg-card border border-border rounded-2xl p-5 hover:border-rose-400/40 transition-colors h-full"
            >
              ...
              <p className="text-sm text-muted-foreground">
                Words you got wrong — review and master them.
              </p>
            </div>
          </Link>
          <div
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Speaking practice + Writing grading by AI.
            </p>
          </div>
          <div
            data-tour="tests"
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Listening, Reading tests + full Mock IELTS exam.
            </p>
          </div>
        </section>
          ...
          <div className="flex flex-col md:flex-row">
            <div className="md:w-56 shrink-0">
              <img
                src="/owner.png"
                alt="Instructor"
                className="w-full h-auto md:h-full md:w-56 object-cover object-center block"
              />
            </div>
            <div className="p-8 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground leading-relaxed mb-5">
                ...
                — a platform dedicated to helping Arabic-speaking students
                achieve their target IELTS band. Every word has been hand-picked
                to match the vocabulary demands of the IELTS exam.
              </p>
              <div className="flex flex-wrap gap-3">
                <a
                  href="https://www.4ielts.com"
          ...
          <section className="space-y-6">
              ...
              <div className="bg-primary text-primary-foreground p-6 rounded-3xl shadow-lg relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <div className="flex items-end gap-2 mb-2">
                    ...
                    <span className="text-primary-foreground/80 mb-1">
                      / {summary.totalCards} words learned
                    </span>
                  </div>
                  <Progress
                    value={
                      summary.totalCards > 0
                        ? (summary.totalKnown / summary.totalCards) * 100
                        : 0
                    }
              ...
              <div className="bg-card border border-border p-6 rounded-3xl shadow-sm flex flex-col justify-center">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="rounded-full border-teal-300 text-teal-700 dark:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/20"
                  >
                    <Link href="/synonyms">
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="rounded-full border-orange-300 text-orange-700 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20"
                  >
                    <Link href="/antonyms">
                      <ArrowLeftRight className="w-4 h-4 mr-2" />
                      IELTS Antonyms
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="rounded-full border-indigo-300 text-indigo-700 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/20"
                  >
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="rounded-full border-violet-300 text-violet-700 dark:text-violet-400 hover:bg-violet-50 dark:hover:bg-violet-900/20"
                  >
                  ...
                  <Button
                    asChild
                    variant="outline"
                    className="rounded-full border-rose-300 text-rose-700 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20"
                  >
                    <Link href="/speaking">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {summary.byLevel.map((stat, i) => {
                const percent =
                  stat.total > 0
                    ? Math.round((stat.known / stat.total) * 100)
                    : 0;
                return (
                  <div
                    key={stat.level}
...
function ReviewSection() {
  const storedRaw =
    typeof window !== "undefined" ? localStorage.getItem("4ielts_email") : null;
  let storedEmail = "";
  try {
    storedEmail = storedRaw ? (JSON.parse(storedRaw).email ?? "") : "";
  } catch {
    storedEmail = "";
  }
    ...
    return (
      <section className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-3xl p-8 text-center">
        ...
        <p className="text-muted-foreground text-sm">
          Your review has been submitted and will appear after it is approved.
        </p>
        <p className="text-xs text-muted-foreground mt-1" dir="rtl" lang="ar">
          شكراً لمراجعتك! ستظهر بعد موافقة المشرف.
        </p>
      </section>
    );
  }
    ...
    <section className="bg-card border border-border rounded-3xl p-8 space-y-5">
      <div className="flex items-center gap-3 mb-1">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Share your experience with LEXO · شارك تجربتك
          </p>
        </div>
      </div>
