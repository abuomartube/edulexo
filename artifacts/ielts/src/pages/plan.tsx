      ...
      try {
        const [lvl, band, exam, dur, start] = await Promise.all([
          customFetch<{ value: string }>(
            "/api-ielts/user-data/current_level",
          ).catch(() => null),
          customFetch<{ value: string }>(
            "/api-ielts/user-data/target_band",
          ).catch(() => null),
          customFetch<{ value: string }>(
            "/api-ielts/user-data/exam_date",
          ).catch(() => null),
          customFetch<{ value: string }>(
            "/api-ielts/user-data/plan_duration_days",
          ).catch(() => null),
          customFetch<{ value: string }>(
            "/api-ielts/user-data/plan_start_date",
          ).catch(() => null),
        ]);
        if (cancelled) return;
