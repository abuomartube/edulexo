      ...
      <Layout>
        <div className="max-w-xl mx-auto mt-16 text-center space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            You haven't missed any words in quizzes yet. Take some quizzes and
            any words you get wrong will appear here for review.
          </p>
          <p className="text-sm text-muted-foreground" dir="rtl" lang="ar">
            لا توجد كلمات ضعيفة حالياً — الكلمات التي تخطئ فيها في الاختبارات
            ستظهر هنا تلقائياً
          </p>
    ...
    return (
      <Layout>
        <div className="max-w-xl mx-auto mt-16 text-center space-y-6">
          ...
          <p className="text-muted-foreground text-lg">
            You've reviewed all {mastered.size} weak words in this session.
            Great work!
          </p>
          <p className="text-sm text-muted-foreground" dir="rtl" lang="ar">
      ...
      <Layout>
        <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-500">
          <div className="bg-card border border-border rounded-3xl p-8 text-center space-y-5">
            ...
            <p className="text-muted-foreground text-lg">
              These are words you've gotten wrong in quizzes. Review them as
              flashcards and mark them as mastered when you're confident.
            </p>
            <p className="text-sm text-muted-foreground" dir="rtl" lang="ar">
              هذه الكلمات التي أخطأت فيها — راجعها وحدد "أتقنتها" عندما تكون
              واثقاً
            </p>
            ...
            <Button
              ...
              size="lg"
              className="rounded-full font-bold px-10 mt-4"
            >
              ...
              {words.map((w) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm text-primary arabic-text truncate">
                      {w.arabic}
                    </div>
                  </div>
      ...
      <div className="max-w-md mx-auto space-y-6 animate-in fade-in duration-500">
        ...
        <div className="h-1.5 bg-muted rounded-full overflow-hidden">
          <div
            ...
            style={{
              width: `${((currentIndex + 1) / activeWords.length) * 100}%`,
            }}
          />
        </div>
          ...
          >
            ...
            >
              ...
              <div className="flex-1 flex flex-col items-center justify-center text-center gap-4">
                <h2 className="text-4xl font-extrabold arabic-text text-primary">
                  {card.arabic}
                </h2>
                ...
                {card.exampleSentenceArabic && (
                  <p className="text-sm arabic-text text-muted-foreground max-w-xs">
                    {card.exampleSentenceArabic}
                  </p>
                )}
              </div>
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          >
            <CheckCircle2 className="w-5 h-5 mr-2" />I Know This Now
          </Button>
