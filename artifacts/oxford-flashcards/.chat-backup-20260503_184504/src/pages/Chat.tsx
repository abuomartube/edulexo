  ...
  return (
    ...
    >
      ...
      <main className="relative max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="rounded-[28px] p-4 sm:p-5 bg-gradient-to-br from-slate-800/55 to-slate-900/65 backdrop-blur-2xl ring-1 ring-white/10 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.85),0_8px_24px_-8px_rgba(124,58,237,0.35),inset_0_1px_0_rgba(255,255,255,0.06)]">
