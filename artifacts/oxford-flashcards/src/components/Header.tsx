...
const NAV: NavItem[] = [
  ...
  { label: "Level Assessment", href: "/assessment" },
          ...
          {isAuthenticated && user ? (
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="flex items-center gap-1.5 pr-2 pl-1 py-1 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800/60 transition"
              ...
              {menuOpen && (
                <div className="absolute right-0 top-full mt-2 w-60 rounded-2xl bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 shadow-2xl py-2 origin-top-right animate-in fade-in slide-in-from-top-2 duration-150">
