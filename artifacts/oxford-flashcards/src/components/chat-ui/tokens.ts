export const chatUI = {
  ...
  surface: {
    ...
    card:
      "bg-gradient-to-br from-slate-800/70 to-slate-900/75 backdrop-blur-xl border border-white/[0.08] shadow-[0_14px_40px_-14px_rgba(0,0,0,0.75),0_2px_8px_-2px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.06)]",
    glass:
  ...
  shadow: {
    ...
    soft:
      "0 8px 24px -10px rgba(0,0,0,0.6), 0 1px 2px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.05)",
  },
  ambient: {
    pageBg:
      "radial-gradient(ellipse 80% 60% at 50% -10%, #1f1750 0%, #0d1330 28%, #060b1f 55%, #02040e 100%)",
    sceneBg:
      "linear-gradient(180deg, #0c1428 0%, #070c1d 50%, #02050d 100%)",
    radialTop:
