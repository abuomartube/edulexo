...
export const translations = {
  ...
  "dashboard.profile.uploadFailed": { en: "Upload failed. Please try again.", ar: "فشل الرفع. حاول مرّة أخرى." },
  "dashboard.profile.fileTooLarge": { en: "Image is too large (max 5 MB).", ar: "الصورة كبيرة جدًا (حتى ٥ ميغابايت)." },
  "dashboard.profile.invalidType": { en: "Please choose a JPG, PNG or WebP image.", ar: "اختر صورة JPG أو PNG أو WebP." },
  "dashboard.profile.editTitle": { en: "Edit profile", ar: "تعديل الملف الشخصي" },
  "dashboard.profile.fieldName": { en: "Full name", ar: "الاسم الكامل" },
  "dashboard.profile.fieldPhone": { en: "Phone (optional)", ar: "الهاتف (اختياري)" },
  "dashboard.profile.fieldBio": { en: "About me", ar: "نبذة عنّي" },
  "dashboard.profile.bioCounter": { en: "{n}/500 characters", ar: "{n}/٥٠٠ حرف" },
  ...
  "dashboard.profile.saveFailed": { en: "Could not save changes.", ar: "تعذّر حفظ التغييرات." },
  "dashboard.summary.title": { en: "Subscription overview", ar: "نظرة على الاشتراك" },
  "dashboard.summary.activeCourses": { en: "Active courses", ar: "الدورات النشطة" },
  "dashboard.summary.activeCoursesNote": { en: "of {total} owned", ar: "من أصل {total}" },
  "dashboard.summary.certificates": { en: "Certificates earned", ar: "الشهادات المُكتسبة" },
  "dashboard.summary.certificatesNote": { en: "Across both courses", ar: "في كلتا الدورتين" },
  "dashboard.summary.nextExpiry": { en: "Next expiry", ar: "أقرب انتهاء" },
  "dashboard.summary.nextExpiryNone": { en: "No active subscription", ar: "لا يوجد اشتراك نشط" },
