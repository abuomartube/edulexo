...
const GOALS: Array<{
  ...
  { icon: Trophy, titleKey: "course.detail.goal1.title", descKey: "course.detail.goal1.desc" },
  { icon: Brain, titleKey: "course.detail.goal2.title", descKey: "course.detail.goal2.desc" },
  { icon: Mic, titleKey: "course.detail.goal3.title", descKey: "course.detail.goal3.desc" },
  { icon: Target, titleKey: "course.detail.goal4.title", descKey: "course.detail.goal4.desc" },
];
...
const SHOWCASE_TILES: Array<{
  ...
  { icon: BookOpen, labelKey: "course.detail.image1.label", gradient: "from-[#0a1f44] to-[#123b75]" },
  { icon: Headphones, labelKey: "course.detail.image2.label", gradient: "from-[#123b75] to-[#0a1f44]" },
  { icon: ClipboardCheck, labelKey: "course.detail.image3.label", gradient: "from-[#0a1f44] via-[#123b75] to-[#ff8a00]" },
  { icon: Mic, labelKey: "course.detail.image4.label", gradient: "from-[#ff8a00] to-[#0a1f44]" },
];
...
const TESTIMONIALS: Array<{
  ...
  { nameKey: "course.detail.t1.name", scoreKey: "course.detail.t1.score", quoteKey: "course.detail.t1.quote", hue: "from-[#0a1f44] to-[#123b75]" },
  { nameKey: "course.detail.t2.name", scoreKey: "course.detail.t2.score", quoteKey: "course.detail.t2.quote", hue: "from-[#123b75] to-[#ff8a00]" },
  { nameKey: "course.detail.t3.name", scoreKey: "course.detail.t3.score", quoteKey: "course.detail.t3.quote", hue: "from-[#ff8a00] to-[#0a1f44]" },
];
...
export default function CourseDetail() {
  ...
  const checkoutHref = useMemo(() => (tier ? `/checkout/intro/${tier}` : "/ielts"), [tier]);
  ...
  const submitReview = () => {
    ...
    setReviews(updated);
    try {
      window.localStorage.setItem(`course-reviews:${tier}`, JSON.stringify(updated));
    } catch {
      /* ignore quota errors */
    }
    setReviewName("");
  ...
  const handleAddToCart = () => {
    ...
    try {
      ...
      if (!list.includes(`ielts:${tier}`)) list.push(`ielts:${tier}`);
  ...
  return (
    ...
    >
            ...
            {GOALS.map((g, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[#0a1f44] dark:text-white">{t(g.titleKey)}</h3>
      ...
      {/* PREVIEW */}
      <section className="bg-gradient-to-br from-[#0a1f44] via-[#123b75] to-[#0a1f44] text-white py-14" data-testid="section-preview">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl sm:text-4xl font-extrabold">{t("course.detail.preview.title")}</h2>
            <p className="mt-3 text-white/80 max-w-2xl mx-auto">{t("course.detail.preview.subtitle")}</p>
          </div>
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-[#0a1f44] dark:text-white truncate">{name}</p>
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-14" data-testid="section-reviews">
        ...
        >
          ...
          <div>
            <label htmlFor="review-name" className="block text-sm font-semibold text-[#0a1f44] dark:text-white mb-2">
          ...
          <div>
            <label htmlFor="review-text" className="block text-sm font-semibold text-[#0a1f44] dark:text-white mb-2">
            ...
            reviews.map((r) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <p className="font-bold text-sm text-[#0a1f44] dark:text-white">{r.name}</p>
      ...
      {/* BOTTOM CTA */}
      <section className="bg-gradient-to-br from-[#0a1f44] via-[#123b75] to-[#0a1f44] text-white py-16" data-testid="section-bottom-cta">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="mt-3 text-lg text-white/80">{t("course.detail.cta.priceFull")}</p>
