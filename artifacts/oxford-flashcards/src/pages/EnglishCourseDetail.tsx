...
type Tier = "foundations" | "advanced";
const VALID_TIERS: Tier[] = ["foundations", "advanced"];
...
const GOALS: Array<{
  ...
  { icon: Mic, titleKey: "english.course.goal1.title", descKey: "english.course.goal1.desc" },
  { icon: Brain, titleKey: "english.course.goal2.title", descKey: "english.course.goal2.desc" },
  { icon: Trophy, titleKey: "english.course.goal3.title", descKey: "english.course.goal3.desc" },
  { icon: Target, titleKey: "english.course.goal4.title", descKey: "english.course.goal4.desc" },
];
...
const SHOWCASE_TILES: Array<{
  ...
  { icon: BookOpen, labelKey: "english.course.image1.label", gradient: "from-[#1a0a44] to-[#3b1275]" },
  { icon: Headphones, labelKey: "english.course.image2.label", gradient: "from-[#3b1275] to-[#1a0a44]" },
  { icon: ClipboardCheck, labelKey: "english.course.image3.label", gradient: "from-[#1a0a44] via-[#3b1275] to-[#ff8a00]" },
  { icon: Mic, labelKey: "english.course.image4.label", gradient: "from-[#ff8a00] to-[#1a0a44]" },
];
...
const TESTIMONIALS: Array<{
  ...
  { nameKey: "english.course.t1.name", levelKey: "english.course.t1.level", quoteKey: "english.course.t1.quote", hue: "from-[#1a0a44] to-[#3b1275]" },
  { nameKey: "english.course.t2.name", levelKey: "english.course.t2.level", quoteKey: "english.course.t2.quote", hue: "from-[#3b1275] to-[#ff8a00]" },
  { nameKey: "english.course.t3.name", levelKey: "english.course.t3.level", quoteKey: "english.course.t3.quote", hue: "from-[#ff8a00] to-[#1a0a44]" },
];

type Review = { id: string; name: string; rating: number; text: string; createdAt: number };
...
export default function EnglishCourseDetail() {
  ...
  const tier = (VALID_TIERS as readonly string[]).includes(rawTier) ? (rawTier as Tier) : null;
  const meta = tier ? TIER_META[tier] : null;

  const [openFaq, setOpenFaq] = useState<number | null>(0);
  const [reviews, setReviews] = useState<Review[]>(() => (tier ? loadReviews(tier) : []));
  ...
  const checkoutHref = useMemo(() => (tier ? `/checkout/english/${tier}` : "/english"), [tier]);
  ...
  const submitReview = () => {
    ...
    setReviews(updated);
    try {
      window.localStorage.setItem(`english-course-reviews:${tier}`, JSON.stringify(updated));
    } catch {
      /* ignore quota errors */
    }
    setReviewName("");
  ...
  const handleAddToCart = () => {
    ...
    try {
      ...
      if (!list.includes(`english:${tier}`)) list.push(`english:${tier}`);
  ...
  return (
    ...
    >
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-12">
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="mt-3 text-base sm:text-lg font-semibold text-[#ffb866]" dir="ltr">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-white/10 backdrop-blur border border-white/30 text-white font-semibold hover:bg-white/20 transition"
                >
                  <ShoppingCart size={16} />
                  {t("course.detail.cta.addToCart")}
                </button>
              </div>
              <p className="mt-3 text-xs text-white/60">{t("course.detail.cta.includes")}</p>
            </div>
            ...
            <div className="lg:col-span-5">
              ...
              >
                ...
                <div className="absolute bottom-4 start-4 end-4 flex items-center justify-between">
                  ...
                  <span className="text-xs font-semibold text-white/70">2:14</span>
                </div>
              </button>
            </div>
          </div>
      ...
      {/* ABOUT */}
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-14" data-testid="section-about">
        ...
        <ul className="mt-7 grid sm:grid-cols-2 gap-3">
          {meta.features.map((fKey) => (
            ...
            >
              <CheckCircle2 size={18} className="text-[#ff8a00] mt-0.5 flex-shrink-0" />
      ...
      {/* GOALS */}
      <section className="bg-white dark:bg-slate-900 py-14 border-y border-slate-200 dark:border-slate-800" data-testid="section-goals">
            ...
            {GOALS.map((g, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-[#1a0a44] dark:text-white">{t(g.titleKey)}</h3>
      ...
      {/* SHOWCASE IMAGES */}
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14" data-testid="section-images">
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1a0a44] dark:text-white">
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black/60 to-transparent">
                  <p className="text-xs sm:text-sm font-bold text-white">{t(tile.labelKey)}</p>
                </div>
              </div>
            );
          })}
      ...
      {/* PREVIEW */}
      <section className="bg-gradient-to-br from-[#1a0a44] via-[#3b1275] to-[#1a0a44] text-white py-14" data-testid="section-preview">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl sm:text-4xl font-extrabold">{t("course.detail.preview.title")}</h2>
            <p className="mt-3 text-white/80 max-w-2xl mx-auto">{t("english.course.preview.subtitle")}</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl bg-white/5 backdrop-blur border border-white/20 p-6 flex flex-col items-start justify-between gap-5">
              <div>
                ...
                <h3 className="text-xl font-bold">{t("course.detail.preview.pdf")}</h3>
      ...
      {/* FAQ */}
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-14" data-testid="section-faq">
      ...
      {/* TESTIMONIALS */}
      <section className="bg-white dark:bg-slate-900 py-14 border-y border-slate-200 dark:border-slate-800" data-testid="section-testimonials">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1a0a44] dark:text-white text-center">
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="min-w-0">
                      <p className="text-sm font-bold text-[#1a0a44] dark:text-white truncate">{name}</p>
                  ...
                  <div className="flex gap-0.5 mb-3">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star key={s} size={14} className="text-[#ff8a00]" fill="currentColor" />
                    ))}
                  </div>
      ...
      {/* REVIEWS */}
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-14" data-testid="section-reviews">
        ...
        >
              ...
              {[1, 2, 3, 4, 5].map((s) => {
                ...
                return (
                  ...
                  >
                    <Star
                      size={28}
                      className={filled ? "text-[#ff8a00]" : "text-slate-300 dark:text-slate-600"}
          ...
          <div>
            <label htmlFor="review-name" className="block text-sm font-semibold text-[#1a0a44] dark:text-white mb-2">
          ...
          <div>
            <label htmlFor="review-text" className="block text-sm font-semibold text-[#1a0a44] dark:text-white mb-2">
            ...
            reviews.map((r) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <p className="font-bold text-sm text-[#1a0a44] dark:text-white">{r.name}</p>
                  <div className="flex gap-0.5 flex-shrink-0">
                    {[1, 2, 3, 4, 5].map((s) => (
                      <Star
                        key={s}
                        size={13}
                        className={s <= r.rating ? "text-[#ff8a00]" : "text-slate-300 dark:text-slate-600"}
      ...
      {/* BOTTOM CTA */}
      <section className="bg-gradient-to-br from-[#1a0a44] via-[#3b1275] to-[#1a0a44] text-white py-16" data-testid="section-bottom-cta">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <Globe2 size={42} className="mx-auto text-[#ff8a00] mb-4" />
          <h2 className="text-3xl sm:text-4xl font-extrabold">{t(meta.nameKey)}</h2>
          <p className="mt-3 text-lg text-white/80">{t("english.course.cta.priceFull")}</p>
          <p className="mt-1 text-sm text-white/70">{t("course.detail.cta.includes")}</p>
          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-2xl bg-white/10 backdrop-blur border border-white/30 text-white font-semibold hover:bg-white/20 transition"
            >
              <ShoppingCart size={16} />
              {t("course.detail.cta.addToCart")}
            </button>
