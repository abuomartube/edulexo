...
const modules: Module[] = [
  { icon: BookOpen, titleKey: "english.mod.vocab.title", descKey: "english.mod.vocab.desc", gradient: "from-violet-500 to-purple-700", status: "ready", href: "/demo" },
  { icon: Video, titleKey: "english.mod.lessons.title", descKey: "english.mod.lessons.desc", gradient: "from-rose-500 to-pink-600", status: "soon" },
  { icon: Mic, titleKey: "english.mod.speaking.title", descKey: "english.mod.speaking.desc", gradient: "from-amber-400 to-orange-500", status: "soon" },
  { icon: PenLine, titleKey: "english.mod.writing.title", descKey: "english.mod.writing.desc", gradient: "from-emerald-500 to-teal-600", status: "soon" },
  { icon: Headphones, titleKey: "english.mod.listening.title", descKey: "english.mod.listening.desc", gradient: "from-sky-500 to-blue-600", status: "soon" },
  { icon: BookMarked, titleKey: "english.mod.reading.title", descKey: "english.mod.reading.desc", gradient: "from-fuchsia-500 to-purple-600", status: "soon" },
  { icon: Trophy, titleKey: "english.mod.test.title", descKey: "english.mod.test.desc", gradient: "from-yellow-500 to-amber-600", status: "soon" },
];
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-start">
              ...
              <h2 className="mt-5 text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.05]">
                <span className="text-gray-900 dark:text-white">{t("english.hero.headline1")}</span>
                <br />
              ...
              <div className="relative max-w-md mx-auto space-y-4">
                ...
                <div className="relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-100 dark:border-gray-800 rounded-3xl p-6 shadow-xl">
                  ...
                  <div className="rounded-2xl bg-gradient-to-br from-violet-100 via-violet-50 to-purple-100 dark:from-violet-900/40 dark:via-violet-900/30 dark:to-purple-900/40 border border-violet-200/70 dark:border-violet-700/40 p-8 text-center shadow-md">
                    <p className="text-4xl font-extrabold tracking-tight text-violet-900 dark:text-violet-100" dir="ltr">excellent</p>
                    <p className="mt-2 text-sm italic text-violet-600/80 dark:text-violet-300/80" dir="ltr">/ˈek.səl.ənt/</p>
                  ...
                  <div className="mt-4 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <span className="font-semibold text-violet-600 dark:text-violet-400">{t("english.preview.families")}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            return (
              ...
              >
                ...
                <div className="p-7">
                  ...
                  <div className="mt-5 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-gray-800 text-sm font-bold text-gray-700 dark:text-gray-200" dir="ltr">
                    CEFR {pkg.levels}
                  </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {modules.map((m) => {
            ...
            return m.status === "ready" && m.href ? (
              <Link key={m.titleKey} href={m.href}>{card}</Link>
            ) : (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold">
              ...
              <span className="bg-gradient-to-r from-violet-600 to-purple-700 dark:from-violet-400 dark:to-purple-400 bg-clip-text text-transparent">{t("english.footer.brand")}</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
            <a href="#" className="hover:text-violet-600 dark:hover:text-violet-400 transition">{t("common.privacy")}</a>
            <span>·</span>
            <a href="#" className="hover:text-violet-600 dark:hover:text-violet-400 transition">{t("common.terms")}</a>
            <span>·</span>
            <a href="#" className="hover:text-violet-600 dark:hover:text-violet-400 transition">{t("common.contact")}</a>
          </div>
        </div>
      </footer>
    </div>
