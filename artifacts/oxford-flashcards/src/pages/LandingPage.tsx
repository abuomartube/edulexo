...
type Pkg = {
  tier: "beginner" | "advanced" | "complete";
            ...
            return (
              ...
              >
                ...
                <div className="p-7">
                  ...
                  <div
                    className="mt-5 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-gray-800 text-sm font-bold text-gray-700 dark:text-gray-200"
                    dir="ltr"
                  >
                    CEFR {pkg.levels}
                  </div>
