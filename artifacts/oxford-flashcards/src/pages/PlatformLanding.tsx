...
const platformFeatures: Feature[] = [
  { icon: Brain, titleKey: "platform.feat1.title", descKey: "platform.feat1.desc", color: "from-indigo-500 to-purple-600" },
  { icon: Volume2, titleKey: "platform.feat2.title", descKey: "platform.feat2.desc", color: "from-blue-500 to-cyan-600" },
  { icon: Globe2, titleKey: "platform.feat3.title", descKey: "platform.feat3.desc", color: "from-purple-500 to-pink-600" },
  { icon: GraduationCap, titleKey: "platform.feat4.title", descKey: "platform.feat4.desc", color: "from-violet-500 to-indigo-600" },
  { icon: TrendingUp, titleKey: "platform.feat5.title", descKey: "platform.feat5.desc", color: "from-emerald-500 to-teal-600" },
  { icon: ClipboardCheck, titleKey: "platform.feat6.title", descKey: "platform.feat6.desc", color: "from-amber-500 to-orange-600" },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-10 sm:pt-14 pb-10 sm:pb-12 text-center">
          ...
          <h2 className="mt-5 text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.05]">
            <span className="text-slate-900 dark:text-white">{t("platform.hero.headline1")}</span>
            <br />
      ...
      <footer className="border-t border-slate-100 dark:border-slate-800 bg-white/40 dark:bg-gray-950/40">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 text-xs text-slate-500 dark:text-slate-400">
            <a href="#" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">{t("common.privacy")}</a>
            <span>·</span>
            <a href="#" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">{t("common.terms")}</a>
            <span>·</span>
            <a href="#" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition">{t("common.contact")}</a>
          </div>
        </div>
      </footer>
    </div>
