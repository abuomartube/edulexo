import { Mic, Hand, MessageSquare, PhoneOff, Users, Headphones } from "lucide-react";
import {
  Header,
  Avatar,
  IconButton,
    ...
    <>
      ...
      <div className="relative z-10 px-6 pt-3 pb-2 border-t border-white/5 bg-slate-950/60 backdrop-blur">
        <div dir="ltr" className="flex items-end justify-around">
          <IconButton icon={<Hand size={20} />} label="Raise Hand" tone="warning" badge="3" />
          <IconButton icon={<MessageSquare size={20} />} label="Message" tone="accent" />
          <IconButton icon={<PhoneOff size={20} />} label="Leave" tone="danger" />
        </div>
        <div className="pt-1">
          <HomeIndicator />
        </div>
