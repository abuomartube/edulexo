        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {weeklyPool.map((section) => {
            ...
            const scheduled = Math.max(
              1,
              getWeeklyScheduledCount(section.id, level, today),
            );
            ...
            return (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-xl bg-gradient-to-br ${section.color} flex items-center justify-center shrink-0 text-lg shadow-sm`}
                >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-xs font-extrabold text-muted-foreground tabular-nums shrink-0">
                      {capped}/{scheduled}
                    </span>
                  </div>
  ...
  return (
    ...
    >
      <div className="flex items-stretch">
        ...
        >
          <div
            className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${task.color} flex items-center justify-center shrink-0 text-2xl shadow-md`}
          >
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <p
                className={`font-extrabold text-sm sm:text-base truncate ${done ? "line-through text-muted-foreground" : "text-foreground"}`}
              >
                {task.label}
              </p>
            </div>
