...
const synonymMap = new Map(
  (synonymsRaw as { word: string; synonym: string }[]).map((s) => [
    s.word.toLowerCase(),
    s,
  ]),
);
              ...
              <div className="w-full border-t border-primary/15 pt-2.5 flex flex-col gap-1.5 text-left">
                {synonym && (
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs font-bold text-primary/70 w-14 shrink-0">
                      Synonym
                    </span>
                ...
                {antonym && (
                  <div className="flex items-center gap-2 flex-wrap">
                    <span className="text-xs font-bold text-orange-500/80 w-14 shrink-0">
                      Antonym
                    </span>
                    <span className="text-sm font-semibold text-foreground">
                      {antonym.antonym}
