...
const steps: TourStep[] = [
  {
    ...
    description:
      "Every day a new academic word. Learn it, quiz yourself, earn XP.",
  ...
  },
  {
    ...
    title: "Your Streak",
    description:
      "Study every day to keep your streak alive. Miss a day and it resets to zero.",
  ...
  },
  {
    ...
    title: "Weak Words",
    description:
      "Every word you get wrong is saved here automatically. Review them until you master them.",
  ...
  },
  {
    ...
    description:
      "Practice Speaking with Churchill AI and get your Writing scored by Orwell AI.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Practice with Listening and Reading tests, or take a full timed Mock IELTS to get your band score estimate.",
    icon: (
      <div className="flex -space-x-1">
    ...
    >
      ...
      >
        <div className="bg-card border border-border sm:rounded-2xl rounded-t-2xl shadow-2xl overflow-hidden">
          <div
            className={`relative bg-gradient-to-br ${step.bgGradient} p-6 pb-4`}
          >
            <button
              onClick={handleSkip}
            ...
            >
              <div
                className={`w-16 h-16 rounded-2xl ${step.iconBg} border flex items-center justify-center mb-4`}
              >
                {step.icon}
              </div>
