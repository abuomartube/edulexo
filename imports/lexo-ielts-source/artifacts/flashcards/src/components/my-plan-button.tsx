          ...
          <div className="relative ml-auto h-full w-full sm:w-[420px] bg-card border-l border-border shadow-2xl flex flex-col animate-in slide-in-from-right duration-200">
                  ...
                  {days !== null ? (
                    ...
                    <>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Set it in onboarding to see countdown.
                      </p>
                    </>
                  )}
                </div>
            ...
            <div className="flex-1 overflow-y-auto px-3 py-3 space-y-2">
              ...
              {doneCount === totalCount && totalCount > 0 && (
                <div className="mt-4 p-4 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 border border-emerald-200 dark:border-emerald-800 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Great work — come back tomorrow for a fresh plan.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="px-5 py-3 border-t border-border bg-muted/30 space-y-2">
              ...
              <p className="text-[11px] text-muted-foreground text-center">
                The plan rotates every day so you cover every section across the
                week.
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  This clears all your task completions and starts a fresh plan
                  today.
                </p>
              </div>
              <button
  ...
  return (
    ...
    >
      <div className="flex items-stretch">
        ...
        >
          <div
            className={`w-10 h-10 rounded-xl bg-gradient-to-br ${task.color} flex items-center justify-center shrink-0 text-lg shadow-sm`}
          >
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <p
                className={`font-bold text-sm truncate ${done ? "line-through text-muted-foreground" : "text-foreground"}`}
              >
                {task.label}
              </p>
            </div>
