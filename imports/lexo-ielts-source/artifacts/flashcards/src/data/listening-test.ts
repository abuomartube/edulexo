        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "Good for people who are especially keen on ________",
                answer: "fish",
              },
              {
                num: 2,
                text: "The ________ is a good place for a drink",
                answer: "roof",
              },
              {
                num: 3,
                text: "________ Food, good for sharing",
                answer: "Spanish",
              },
              {
                num: 4,
                text: "A limited selection of ________ food on the menu",
                answer: "vegetarian",
                alternateAnswers: ["vegetarians"],
              },
              {
                num: 5,
                text: "The ________ (name of restaurant)",
                answer: "Audley",
              },
              { num: 6, text: "At the top of a ________", answer: "hotel" },
              {
                num: 7,
                text: "All the ________ are very good",
                answer: "reviews",
              },
              {
                num: 8,
                text: "Only uses ________ ingredients",
                answer: "local",
              },
              {
                num: 9,
                text: "Set lunch costs ________ per person",
                answer: "30",
                alternateAnswers: ["thirty", "£30"],
              },
              {
                num: 10,
                text: "Portions probably of ________ size",
                answer: "average",
              },
            ],
          },
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 21,
                text: "Which TWO things are responsible for the increase in loneliness? (Questions 21–22)",
                answer: "C,E",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 23,
                text: "Which TWO health risks are based on solid evidence? (Questions 23–24)",
                answer: "A,E",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 25,
                text: "Which TWO opinions about the evolutionary theory of loneliness? (Questions 25–26)",
                answer: "A,B",
              },
            ],
          },
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 31,
                text: "Industrial development led to pollution from ________ on the river bank.",
                answer: "factories",
              },
              {
                num: 32,
                text: "In 1957, the River Thames in London was declared biologically ________.",
                answer: "dead",
              },
              {
                num: 33,
                text: "Seals and even a ________ have been seen in the River Thames.",
                answer: "whale",
              },
              {
                num: 34,
                text: "Riverside warehouses are converted to restaurants and ________.",
                answer: "apartments",
              },
              {
                num: 35,
                text: "In Los Angeles, there are plans to build a riverside ________.",
                answer: "park",
              },
              { num: 36, text: "Display ________ projects.", answer: "art" },
              {
                num: 37,
                text: "In Paris, ________ are created on the sides of the river every summer.",
                answer: "beaches",
              },
              {
                num: 38,
                text: "Over 2 billion passengers already travel by ________ in cities round the world.",
                answer: "ferry",
              },
              {
                num: 39,
                text: "Goods could be transported by large freight barges and electric ________.",
                answer: "bikes",
              },
              {
                num: 40,
                text: "Or, in future, by ________.",
                answer: "drone",
                alternateAnswers: ["drones"],
              },
            ],
          },
        ],
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "Local councils can give the carer a ________ (time off)",
                answer: "break",
              },
              {
                num: 2,
                text: "Assessment includes how much ________ the caring involves",
                answer: "time",
              },
              {
                num: 3,
                text: "Tasks include helping her have a ________",
                answer: "shower",
              },
              {
                num: 4,
                text: "Tasks include dealing with ________",
                answer: "money",
              },
              {
                num: 5,
                text: "A difficult aspect: loss of ________",
                answer: "memory",
              },
              {
                num: 6,
                text: "A difficult aspect: ________ her",
                answer: "lifting",
              },
              {
                num: 7,
                text: "A difficult aspect: preventing a ________",
                answer: "fall",
              },
              {
                num: 8,
                text: "Transport costs: cost of a ________",
                answer: "taxi",
              },
              {
                num: 9,
                text: "Car-related costs: fuel and ________",
                answer: "insurance",
              },
        ...
        questionSections: [
          {
            ...
            options: [
              ...
              {
                label: "B",
                text: "providing publicity about a council service",
              },
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 31,
                text: "The growth in interest in food fashions started with ________ of food being shared on social media.",
                answer: "photos",
                alternateAnswers: ["photographs", "pictures"],
              },
              {
                num: 32,
                text: "Sales of ________ food brands have grown through social media influencers.",
                answer: "vegan",
              },
              {
                num: 33,
                text: "Famous ________ are influential in food trends.",
                answer: "chefs",
                alternateAnswers: ["cooks"],
              },
              {
                num: 34,
                text: "________ were invited to visit avocado growers in South Africa.",
                answer: "journalists",
                alternateAnswers: ["reporters"],
              },
              {
                num: 35,
                text: "Avocado advertising focused on its ________ benefits.",
                answer: "health",
              },
              {
                num: 36,
                text: "Oat milk was promoted in the USA through ________ shops.",
                answer: "coffee",
              },
              {
                num: 37,
                text: "Oat milk appealed to consumers concerned about the ________.",
                answer: "environment",
              },
              {
                num: 38,
                text: "Norwegian skrei helped strengthen the ________ of Norwegian seafood.",
                answer: "reputation",
              },
              {
                num: 39,
                text: "Quinoa's success led to an increase in its ________.",
                answer: "price",
                alternateAnswers: ["cost"],
              },
              {
                num: 40,
                text: "Overuse of resources resulted in poor quality ________.",
                answer: "soil",
              },
            ],
          },
...
<tr><td class="border border-border p-2 pl-6">Returning books</td><td class="border border-border p-2">Loan period is <strong>(9) ________</strong> weeks · fines charged at 50p per <strong>(10) ________</strong></td></tr>
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "Can borrow up to ________ books at a time",
                answer: "8",
                alternateAnswers: ["eight"],
              },
              {
                num: 2,
                text: "Costs £________ per year",
                answer: "45",
                alternateAnswers: ["forty-five"],
              },
              {
                num: 3,
                text: "Includes access to online ________",
                answer: "databases",
              },
              {
                num: 4,
                text: "Study rooms can be booked for a maximum of ________ hours",
                answer: "3",
              ...
              {
                num: 6,
                text: "Story time every ________ morning",
                answer: "Saturday",
              },
              {
                num: 7,
                text: "Craft activities during ________",
                answer: "holidays",
              },
              {
                num: 8,
                text: "A recent ________ or bank statement",
                answer: "bill",
              },
              {
                num: 9,
                text: "Loan period is ________ weeks",
                answer: "3",
                alternateAnswers: ["three"],
              },
              {
                num: 10,
                text: "Fines charged at 50p per ________",
                answer: "day",
              },
            ],
          },
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 11,
                text: "The conservation centre was originally set up to\nA. breed endangered species.\nB. educate the local community.\nC. carry out scientific research.",
                answer: "A",
              },
              {
                num: 12,
                text: "What does the speaker say has changed most about the centre in recent years?\nA. the number of visitors\nB. the range of animals\nC. the way it is funded",
                answer: "C",
              },
              {
                num: 13,
                text: "The most popular programme for schools is about\nA. rainforest ecosystems.\nB. marine habitats.\nC. local wildlife.",
                answer: "C",
              },
              {
                num: 14,
                text: "The volunteer programme requires a minimum commitment of\nA. two months.\nB. three months.\nC. six months.",
                answer: "B",
              },
              {
                num: 15,
                text: "What surprised the speaker about the feeding programme?\nA. How much food is required.\nB. How carefully diets are planned.\nC. How the animals respond to keepers.",
                answer: "B",
              },
              {
                num: 16,
                text: "The centre's biggest achievement this year has been\nA. successfully releasing animals into the wild.\nB. opening a new visitor education facility.\nC. winning an international conservation award.",
                answer: "A",
              },
            ],
          },
          {
            instruction:
              "Which TWO benefits of the conservation centre do visitors most frequently mention?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
            ...
            questions: [
              {
                num: 17,
                text: "Which TWO benefits do visitors most frequently mention? (Questions 17–18)",
                answer: "A,D",
              },
            ],
          },
          {
            instruction:
              "Which TWO plans does the centre have for the future?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
            ...
            questions: [
              {
                num: 19,
                text: "Which TWO plans does the centre have for the future? (Questions 19–20)",
                answer: "B,E",
              },
            ],
          },
      ...
      },
      {
        ...
        questionSections: [
          {
            instruction:
              "Which TWO challenges did the researchers face during their study of coral reefs?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
              {
                label: "A",
                text: "obtaining permission to access certain sites",
              },
              {
                label: "B",
                text: "dealing with unpredictable weather conditions",
              },
              { label: "C", text: "finding enough qualified divers" },
              {
                label: "D",
                text: "transporting equipment to remote locations",
              },
            ...
            questions: [
              {
                num: 21,
                text: "Which TWO challenges did the researchers face? (Questions 21–22)",
                answer: "B,D",
              },
            ],
          },
          {
            instruction:
              "Which TWO findings surprised the researchers?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
              ...
              {
                label: "D",
                text: "the diversity of life near the ocean floor",
              },
              {
                label: "E",
                text: "the impact of tourism on marine ecosystems",
              },
            ],
            questions: [
              {
                num: 23,
                text: "Which TWO findings surprised the researchers? (Questions 23–24)",
                answer: "A,B",
              },
            ],
          },
          {
            instruction:
              "Which TWO methods proved to be most effective in the research?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
              ...
              {
                label: "E",
                text: "using artificial intelligence to classify species",
              },
            ],
            questions: [
              {
                num: 25,
                text: "Which TWO methods proved most effective? (Questions 25–26)",
                answer: "B,E",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 27,
                text: "The researchers believe that their findings will mainly affect\nA. government environmental policy.\nB. the fishing industry.\nC. future academic research.",
                answer: "A",
              },
              {
                num: 28,
                text: "What do the students think is the most important implication of the research?\nA. It proves that reef restoration is possible.\nB. It shows the need for stricter regulations.\nC. It provides a model for studying other ecosystems.",
                answer: "B",
              },
              {
                num: 29,
                text: "The professor suggests that the next step should be\nA. publishing the results in an international journal.\nB. presenting at a marine biology conference.\nC. conducting a follow-up study in a different location.",
                answer: "C",
              },
              {
                num: 30,
                text: "Both students agree that the most rewarding part of the project was\nA. working with an international team.\nB. learning new diving techniques.\nC. seeing the direct impact of their work.",
                answer: "C",
              },
            ],
          },
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 31,
                text: "The first public bus service used vehicles pulled by ________.",
                answer: "horses",
              },
              {
                num: 32,
                text: "Early buses were mainly used by wealthy ________.",
                answer: "merchants",
                alternateAnswers: ["businessmen"],
              },
              {
                num: 33,
                text: "The introduction of steam ________ made long-distance travel possible.",
                answer: "engines",
              },
              {
                num: 34,
                text: "The first underground railway opened in London in the year ________.",
                answer: "1863",
              },
              {
                num: 35,
                text: "Early underground passengers complained about the level of ________ from the trains.",
                answer: "smoke",
              },
              {
                num: 36,
                text: "Electric trams were first introduced in the city of ________.",
                answer: "Berlin",
              },
              {
                num: 37,
                text: "Trams declined because cities preferred to invest in ________.",
                answer: "roads",
              },
              {
                num: 38,
                text: "Modern bus rapid transit systems have dedicated ________ to avoid delays.",
                answer: "lanes",
              },
              {
                num: 39,
                text: "Some cities are now testing buses powered by ________.",
                answer: "hydrogen",
              },
              {
                num: 40,
                text: "Experts predict that driverless ________ will transform urban transport.",
                answer: "vehicles",
                alternateAnswers: ["cars"],
              },
            ],
          },
        ],
...
<tr><td class="border border-border p-2 pl-6">Payment</td><td class="border border-border p-2">Can pay annually or by monthly <strong>(10) ________</strong></td></tr>
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 1,
                text: "Covers fire and ________ only",
                answer: "flood",
                alternateAnswers: ["flooding"],
              },
              {
                num: 2,
                text: "Costs £________ per month",
                answer: "15",
                alternateAnswers: ["fifteen"],
              },
              {
                num: 3,
                text: "Also covers theft and ________ damage",
                answer: "water",
              },
              {
                num: 4,
                text: "Covers items up to £________ in value",
                answer: "5000",
                alternateAnswers: ["5,000", "five thousand"],
              },
              {
                num: 5,
                text: "Standard excess is £________ per claim",
                answer: "250",
                alternateAnswers: ["two hundred and fifty"],
              },
              {
                num: 6,
                text: "Available if the home has a ________ alarm fitted",
                answer: "burglar",
                alternateAnswers: ["security"],
              },
              {
                num: 7,
                text: "Only covered if kept in a locked ________",
                answer: "shed",
              },
              {
                num: 8,
                text: "Must be reported within ________ days",
                answer: "14",
                alternateAnswers: ["fourteen"],
              },
              {
                num: 9,
                text: "Need a crime reference ________ for theft",
                answer: "number",
              },
              {
                num: 10,
                text: "Can pay annually or by monthly ________",
                answer: "instalments",
                alternateAnswers: ["installments"],
              },
            ],
          },
        ],
        ...
        questionSections: [
          ...
          },
          {
            ...
            questions: [
              {
                num: 17,
                text: "All new guides must complete a training course lasting\nA. one week.\nB. two weeks.\nC. one month.",
                answer: "B",
              },
              {
                num: 18,
                text: "The most important quality for a museum guide is\nA. detailed knowledge of history.\nB. an ability to engage with different audiences.\nC. experience of working with children.",
                answer: "B",
              },
              {
                num: 19,
                text: "Guides are expected to attend refresher training\nA. every three months.\nB. every six months.\nC. once a year.",
                answer: "B",
              },
              {
                num: 20,
                text: "What benefit do guides receive?\nA. free entry to other museums\nB. a discount in the museum shop\nC. free parking at the museum",
                answer: "A",
              },
            ],
          },
      ...
      },
      {
        ...
        questionSections: [
          {
            instruction:
              "Which TWO problems did the students encounter when designing their experiment?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
            ...
            questions: [
              {
                num: 21,
                text: "Which TWO problems did the students encounter? (Questions 21–22)",
                answer: "A,C",
              },
            ],
          },
          {
            instruction:
              "Which TWO results did the students find unexpected?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
              {
                label: "A",
                text: "Older participants performed better under pressure.",
              },
              { label: "B", text: "Music had no effect on concentration." },
              {
                label: "C",
                text: "Male and female scores were almost identical.",
              },
              {
                label: "D",
                text: "Practice improved performance significantly.",
              },
              {
                label: "E",
                text: "Participants performed worse in the afternoon.",
              },
            ],
            questions: [
              {
                num: 23,
                text: "Which TWO results were unexpected? (Questions 23–24)",
                answer: "B,E",
              },
            ],
          },
          {
            instruction:
              "Which TWO changes would the students make if they repeated the experiment?\nChoose TWO letters, A–E.",
            type: "multiSelect",
            options: [
              ...
              {
                label: "E",
                text: "carry out the tests at the same time of day",
              },
            ],
            questions: [
              {
                num: 25,
                text: "Which TWO changes would the students make? (Questions 25–26)",
                answer: "A,E",
              },
            ],
          },
          {
            ...
            questions: [
              {
                num: 27,
                text: "The professor thinks the experiment's main strength is\nA. its original research question.\nB. the clarity of its methodology.\nC. the way the data was analysed.",
                answer: "B",
              },
              {
                num: 28,
                text: "The students were surprised by the professor's suggestion to\nA. submit the work to a journal.\nB. extend the experiment by another week.\nC. present the results at a student conference.",
                answer: "C",
              },
              {
                num: 29,
                text: "What do the students think was the most difficult part of the project?\nA. writing up the literature review\nB. analysing the statistical data\nC. interpreting the results",
                answer: "B",
              },
              {
                num: 30,
                text: "The students agree that the most valuable skill they gained was\nA. time management.\nB. critical thinking.\nC. teamwork.",
                answer: "C",
              },
            ],
          },
        ...
        questionSections: [
          {
            ...
            questions: [
              {
                num: 31,
                text: "Sustainable architecture aims to reduce a building's impact on the ________.",
                answer: "environment",
              },
              {
                num: 32,
                text: "Traditional buildings used local ________ that were naturally available.",
                answer: "materials",
              },
              {
                num: 33,
                text: "Green roofs help to reduce ________ in urban areas.",
                answer: "flooding",
              },
              {
                num: 34,
                text: "The orientation of a building affects how much natural ________ it receives.",
                answer: "light",
                alternateAnswers: ["sunlight"],
              },
              {
                num: 35,
                text: "Double-glazed windows improve a building's ________.",
                answer: "insulation",
              },
              {
                num: 36,
                text: "Rainwater is collected and used for ________ gardens.",
                answer: "watering",
                alternateAnswers: ["irrigating"],
              },
              {
                num: 37,
                text: "Solar panels can generate enough ________ for an entire household.",
                answer: "electricity",
                alternateAnswers: ["power", "energy"],
              },
              {
                num: 38,
                text: "Recycled ________ is increasingly used in construction.",
                answer: "steel",
                alternateAnswers: ["concrete"],
              },
              {
                num: 39,
                text: "Smart sensors can automatically adjust the ________ inside a building.",
                answer: "temperature",
              },
              {
                num: 40,
                text: "The greatest challenge is persuading ________ to invest in sustainable design.",
                answer: "developers",
                alternateAnswers: ["clients"],
              },
            ],
          },
        ],
...
export function getListeningRecommendation(band: number): string {
  if (band >= 8)
    return "Outstanding listening skills! You can follow complex discussions and extract specific details with ease. Keep practising with advanced academic lectures and fast-paced conversations to stay sharp.";
  if (band >= 7)
    return "Great work! You handle most listening tasks well. To move higher, focus on catching subtle details, numbers, and spelling in fast speech. Practise with varied accents and note-taking under time pressure.";
  if (band >= 6)
    return "You're progressing well! Work on identifying paraphrased information and distractors in multiple-choice questions. Listen to English podcasts, news, and lectures daily. Practise predicting answers before listening.";
  if (band >= 5)
    return "Keep going! Focus on following the flow of conversations and monologues. Practise spelling common words, recognising numbers and dates. Listen to English audio for at least 30 minutes daily and build your vocabulary.";
...
export function getListeningArabicRecommendation(band: number): string {
  if (band >= 8)
    return "مهارات استماع متميزة! استمر في التدرب على المحاضرات الأكاديمية والمحادثات السريعة للحفاظ على مستواك.";
  if (band >= 7)
    return "عمل رائع! ركّز على التقاط التفاصيل الدقيقة والأرقام والهجاء في الكلام السريع. تدرّب مع لهجات متنوعة.";
  if (band >= 6)
    return "أنت تتقدم جيداً! اعمل على تحديد المعلومات المُعاد صياغتها. استمع للبودكاست والأخبار الإنجليزية يومياً.";
  if (band >= 5)
    return "استمر! ركّز على متابعة المحادثات وتدرّب على هجاء الكلمات والأرقام. استمع للإنجليزية ٣٠ دقيقة يومياً على الأقل.";
