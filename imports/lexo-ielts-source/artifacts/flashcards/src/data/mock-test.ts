...
export const MOCK_TEST_SETS: MockTestSet[] = [
  {
    ...
    writingTask1: {
      ...
      notes:
        "Key data points: In 1918, roughly 23% owned homes and 77% rented. By 1971, ownership rose to about 51%. In 2001, ownership peaked at 69%. By 2011, ownership dropped slightly to 64% while renting increased to 36%.",
    },
    writingTask2: {
      id: "w2-1",
      taskType: "Task 2",
    ...
    speakingQuestions: [
      ...
      {
        part: 3,
        text: "Do you think schools should teach more practical skills? Why or why not?",
      },
      {
        part: 3,
      ...
      {
        part: 3,
        text: "Is it more important to have academic qualifications or practical skills in today's job market?",
      },
      {
        part: 3,
        text: "Do you think older people find it harder to learn new skills compared to younger people?",
      },
    ],
  },
  {
    ...
    writingTask1: {
      ...
      taskType: "Task 1",
      prompt:
        "The line graph below shows the average monthly temperatures in three different cities — London, Dubai and Sydney — over the course of a year.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
      notes:
        "Key data: London ranges from 5°C (Jan) to 23°C (Jul). Dubai ranges from 19°C (Jan) to 42°C (Aug). Sydney ranges from 26°C (Jan/summer) to 13°C (Jul/winter). London and Dubai peak in summer months while Sydney's pattern is reversed (Southern Hemisphere).",
    },
    writingTask2: {
      id: "w2-2",
      taskType: "Task 2",
      prompt:
        "In many countries, the gap between the rich and the poor is increasing. What problems does this cause? What solutions can be proposed to address this issue?\n\nGive reasons for your answer and include any relevant examples from your own knowledge or experience.\n\nWrite at least 250 words.",
    },
    speakingQuestions: [
      ...
      {
        part: 3,
        text: "What are the benefits of travelling to different countries?",
      },
      {
        part: 3,
      ...
      {
        part: 3,
        text: "Will virtual reality replace the need for physical travel in the future?",
      },
    ],
  },
  {
    ...
    writingTask1: {
      ...
      taskType: "Task 1",
      prompt:
        "The pie charts below show the main reasons why agricultural land becomes less productive and how these causes vary by region worldwide.\n\nSummarise the information by selecting and reporting the main features, and make comparisons where relevant.\n\nWrite at least 150 words.",
      notes:
        "Key data: Globally — over-grazing 35%, deforestation 30%, over-cultivation 28%, other 7%. In North America, deforestation is 45%. In Europe, over-cultivation is 40%. In Africa, over-grazing is 50%.",
    },
    writingTask2: {
      id: "w2-3",
      taskType: "Task 2",
    ...
    speakingQuestions: [
      ...
      {
        part: 3,
        text: "Do you think celebrities have too much influence on young people?",
      },
      { part: 3, text: "What qualities make a good role model?" },
      {
        part: 3,
        text: "Is it better to be influenced by people you know personally or by public figures?",
      },
      {
        part: 3,
        text: "How has social media changed the way people influence each other?",
      },
    ],
  },
];
...
export const SECTION_INFO: Record<
  MockSection,
  { label: string; icon: string; duration: string; description: string }
> = {
  listening: {
    label: "Listening",
    icon: "🎧",
    duration: "30 minutes",
    description: "4 parts, 40 questions — audio-based comprehension",
  },
  reading: {
    label: "Reading",
    icon: "📖",
    duration: "60 minutes",
    description: "3 passages, 40 questions — academic reading comprehension",
  },
  writing: {
    label: "Writing",
    icon: "✍️",
    duration: "60 minutes",
    description: "Task 1 (report) + Task 2 (essay) — minimum 150 + 250 words",
  },
  speaking: {
    label: "Speaking",
    icon: "🎤",
    duration: "11–14 minutes",
    description: "Parts 1, 2, 3 — type your spoken responses",
  },
};
