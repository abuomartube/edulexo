...
const supplements: SkillExercise[] = [
  // ───── 9. List Selection (B2) — 10 new items ─────
  {
    ...
    items: [
      {
        prompt: "Choose THREE advantages mentioned in the passage.",
        answer: ["A", "C", "E"],
      },
    ],
    analysis: `A — "the cheapest forms of new generation".
...
Tip: in list selection, identify the part of the passage where the writer is explicitly listing advantages or features and tick off matches one by one.`,
  },
  {
    ...
    passage: `Coral reefs depend on a delicate symbiosis between coral polyps and tiny photosynthetic algae called zooxanthellae, which live inside coral tissues and supply most of the energy the corals need. When seawater becomes unusually warm, however, the relationship breaks down: the algae produce harmful by-products and the polyps expel them, leaving the colony pale or white — a condition known as bleaching. Although elevated temperature is the most common trigger, marine biologists also document bleaching in response to abnormally low salinity following heavy rainfall, increased ultraviolet radiation when the water is unusually clear, and pollution from agricultural run-off that disturbs the algae's chemistry. Reefs can recover from a single short bleaching event if conditions return to normal, but repeated or prolonged stress eventually kills the corals outright.`,
    instructions:
      "Which THREE triggers of coral bleaching are mentioned in the passage? Choose THREE letters.",
    options: [
    ...
    items: [
      {
        prompt: "Choose THREE bleaching triggers mentioned.",
        answer: ["A", "C", "E"],
      },
    ],
    analysis: `A — "elevated temperature is the most common trigger".
...
B, D and F are never mentioned. Be cautious of plausible-sounding distractors that aren't actually in the text.`,
  },
  {
    ...
    instructions:
      "Which THREE negative consequences of heavy smartphone use are mentioned? Choose THREE letters.",
    options: [
    ...
    items: [
      {
        prompt: "Choose THREE consequences mentioned in the passage.",
        answer: ["A", "C", "E"],
      },
    ],
    analysis: `A — sleep is "one of the clearest casualties".
...
B, D and F are not mentioned. Memory tests in old age (D) is plausible but never stated; reject any option that does not appear in the text.`,
  },
  {
    ...
    items: [
      {
        prompt: "Choose THREE hardships mentioned in the passage.",
        answer: ["A", "C", "E"],
      },
    ],
    analysis: `A — katabatic winds and ground blizzards are described in detail.
...
D and F are not mentioned in the passage.`,
  },
  {
    ...
    items: [
      {
        prompt: "Choose THREE causes mentioned in the passage.",
        answer: ["A", "B", "D"],
      },
    ],
    analysis: `A — varroa mite "weakens individual workers and spreads viral diseases".
...
E is the opposite of what the passage says: warm winters are said to have "little impact on healthy colonies".`,
  },
  {
    ...
    instructions:
      "Which THREE benefits of urban parks are mentioned? Choose THREE letters.",
    options: [
      { label: "A", text: "Reducing the urban heat-island effect" },
      { label: "B", text: "Generating significant tax revenue" },
      {
        label: "C",
        text: "Absorbing storm-water and easing pressure on drains",
      },
    ...
    items: [
      {
        prompt: "Choose THREE benefits mentioned in the passage.",
        answer: ["A", "C", "D"],
      },
    ],
    analysis: `A — trees "cool the surrounding air through shade and evapotranspiration".
...
F is not mentioned.`,
  },
  {
    ...
    items: [
      {
        prompt: "Choose THREE features mentioned in the passage.",
        answer: ["A", "C", "E"],
      },
    ],
    analysis: `A — "long, deliberate straight lines wherever the terrain allowed".
...
B, D and F are not mentioned. Resist the temptation to choose plausible features that the writer simply does not discuss.`,
  },
  {
    ...
    items: [
      {
        prompt: "Choose THREE effects mentioned in the passage.",
        answer: ["A", "C", "D"],
      },
    ],
    analysis: `A — "block[s] adenosine receptors in the brain".
...
B, E and F are not mentioned at all.`,
  },
  {
    ...
    items: [
      {
        prompt: "Choose THREE current applications mentioned in the passage.",
        answer: ["A", "C", "E"],
      },
    ],
    analysis: `A — "flag suspicious nodules on lung scans".
...
D and F are not mentioned.`,
  },
  {
    ...
    options: [
      ...
      {
        label: "F",
        text: "Rapid expansion of mountain forests above the tree line",
      },
    ],
    items: [
      {
    ...
    analysis: `A — meltwater "will rise temporarily and then fall sharply".
...
D and F are not mentioned.`,
  ...
  // ───── 10. Choose a Title (B2) — 10 new items ─────
  {
    ...
    analysis: `B captures the writer's central judgement: vertical farms suit a narrow range of crops and complement (rather than replace) conventional agriculture.
...
D is not the topic at all.`,
  },
  {
    ...
    passage: `The trillions of microbes that inhabit the human gut were until recently regarded as little more than passive lodgers. A wave of research over the past fifteen years has reframed them as an active organ in their own right, influencing not only digestion but also the immune system, drug metabolism and even mood. Different individuals carry strikingly different communities of microbes, shaped by diet, antibiotic exposure and early-life conditions; this diversity may help explain why the same medicine can have very different effects on different patients. While popular accounts often promise specific probiotic cures, most scientists working in the field stress how much remains unknown about which microbial mixtures benefit whom, and they urge caution against marketing claims that outrun the evidence.`,
    instructions: "Choose the BEST title for the passage.",
    options: [
      {
        label: "A",
        text: "Why probiotic yoghurts cure most digestive illnesses",
      },
      {
        label: "B",
        text: "The gut microbiome: an active organ whose effects we are only beginning to understand",
      },
      { label: "C", text: "How antibiotics were discovered" },
      { label: "D", text: "A diet plan for losing weight quickly" },
    ],
    items: [{ prompt: "Best title:", answer: "B" }],
    analysis: `B matches the writer's two main points: the gut microbiome is biologically active and our understanding remains incomplete.
...
C is a different topic.`,
  },
  {
    ...
    options: [
      ...
      {
        label: "C",
        text: "Digital nomadism: rapid growth and the questions it raises for host cities",
      },
      { label: "D", text: "Why visas should be abolished worldwide" },
    ],
    items: [{ prompt: "Best title:", answer: "C" }],
    analysis: `C captures both the rise of digital nomadism and the policy questions it raises for the cities receiving the workers.
...
A, C and D are not the writer's topic.`,
  },
  {
    ...
    items: [{ prompt: "Best title:", answer: "A" }],
    analysis: `A captures both the engineering scale of Gothic cathedrals and their civic significance.
...
B, C and D drift into unrelated subjects.`,
  },
  {
    ...
    passage: `For most of the twentieth century, mainstream economic models assumed that consumers were broadly rational, weighing costs and benefits to maximise their own welfare. Behavioural economics, drawing on psychology, has accumulated a long list of systematic departures from that ideal. People treat losses as roughly twice as painful as equivalent gains, persistently undervalue future rewards, and are heavily influenced by how options are framed — choosing differently when the same choice is described as "ninety per cent fat-free" rather than "ten per cent fat". Public-policy designers increasingly use such insights, building "nudges" that exploit the framing of choices to steer people towards saving more for retirement or eating less sugar. Critics argue that nudges can be paternalistic; defenders reply that all choice environments shape behaviour, so it is better to design them deliberately than by accident.`,
    instructions: "Choose the BEST title for the passage.",
    options: [
      { label: "A", text: "How interest rates are set by central banks" },
      {
        label: "B",
        text: "Behavioural economics and the rise of policy nudges",
      },
      { label: "C", text: "Why advertisements should be banned" },
      { label: "D", text: "A mathematical proof of consumer rationality" },
    ],
    items: [{ prompt: "Best title:", answer: "B" }],
    analysis: `B captures the writer's two main themes: behavioural economics' findings AND their use in nudge-based policy.
...
D contradicts the passage.`,
  ...
  },
  {
    ...
    passage: `Launched into low Earth orbit by the space shuttle Discovery on 24 April 1990, the Hubble Space Telescope was the first major optical observatory placed above the distorting effects of the atmosphere. Initial images, however, were disappointingly fuzzy: a tiny imperfection in the curvature of the primary mirror, only about two micrometres at its edge, was preventing the instrument from focusing properly. A repair mission in December 1993 fitted corrective optics that restored the telescope's intended sharpness. Over the following three decades, Hubble produced some of the most influential images in the history of astronomy, from the deep-field surveys that revealed thousands of distant galaxies in a single tiny patch of sky to detailed pictures of nebulae such as the Eagle's "Pillars of Creation". Five servicing missions extended its operating life, and the observatory was finally joined in space by the James Webb Space Telescope in 2021.`,
    instructions:
      "Answer the questions with NO MORE THAN THREE WORDS or a number from the passage.",
    items: [
      {
        prompt: "1. Which space shuttle carried Hubble into orbit?",
        answer: "Discovery",
      },
      {
        prompt: "2. In what month and year was Hubble launched?",
        answer: "April 1990",
      },
      {
        prompt: "3. Which part of the telescope was found to be defective?",
        answer: "primary mirror",
        acceptable: ["the primary mirror", "mirror"],
      },
      {
        prompt: "4. In which year was the corrective repair mission flown?",
        answer: "1993",
      },
      {
        prompt:
          "5. Which famous nebula image is named the 'Pillars of Creation'?",
        answer: "Eagle",
        acceptable: ["the Eagle", "Eagle nebula", "the Eagle nebula"],
      },
    ],
    analysis: `Each answer is taken directly from the passage. Be careful with proper nouns: "Discovery" (the shuttle) and "Eagle" (the nebula) appear capitalised, which can speed scanning.`,
  },
  {
    id: "sa-b2-403",
    type: "short_answer",
    ...
    items: [
      ...
      {
        prompt: "3. Which element is named after her native country?",
        answer: "polonium",
      },
      {
        prompt: "4. With whom did the Curies share the 1903 Nobel Prize?",
        answer: "Henri Becquerel",
        acceptable: ["Becquerel"],
      },
      {
        prompt: "5. What were her wartime mobile X-ray units nicknamed?",
        answer: "petites Curies",
        acceptable: ["petites curies", "the petites Curies"],
      },
    ],
    analysis: `All five answers appear word-for-word in the passage. When the answer is a proper noun, copy the spelling exactly, including any accents or italics.`,
  },
...
(4) photorespiration — the side reaction with oxygen.`,
  ...
  // ───── 13. Summary Completion (B2) — 10 new items ─────
  {
    ...
    passage: `The outer shell of the Earth is not a single solid skin but is broken into a dozen or so rigid pieces called tectonic plates. Driven by slow currents in the underlying mantle, these plates inch across the surface at rates of a few centimetres a year. Where two plates pull apart at a divergent boundary, molten rock rises to fill the gap, forming new ocean floor along mid-ocean ridges. Where two plates collide at a convergent boundary, one is usually forced down beneath the other in a process called subduction, generating chains of volcanoes and triggering some of the planet's most powerful earthquakes. A third type of boundary, transform, occurs where two plates slide past each other horizontally, as along California's San Andreas Fault. Recognising these patterns has allowed geologists to explain phenomena that once seemed unrelated, from the matching coastlines of Africa and South America to the distribution of mountain ranges and earthquake zones.`,
    instructions:
    ...
    items: [
      {
        prompt:
          "Plates are driven by currents in the (1) ______. At (2) ______ boundaries molten rock forms new sea floor along mid-ocean (3) ______. At convergent boundaries, one plate slides under the other in a process called (4) ______, producing volcanoes and major (5) ______. — Gap 1:",
        answer: "D",
      },
    ...
    analysis: `(1) D mantle — "slow currents in the underlying mantle".
...
C (transform) and G/H are distractors.`,
  },
  {
    ...
    items: [
      {
        prompt:
          "Strong emotion activates the (1) ______, which sits next to the brain's main memory hub, the (2) ______. The amygdala releases stress hormones such as (3) ______, producing memories that are unusually (4) ______. The same mechanism can make traumatic memories (5) ______. — Gap 1:",
        answer: "A",
      },
      { prompt: "Gap 2:", answer: "B" },
    ...
    analysis: `(1) A amygdala — the named brain structure.
...
└────────────────┴──────────────────────┴──────────────────────────┴──────────────────────────┘`,
    items: [
      ...
      { prompt: "Cell (3)", answer: "Caravaggio" },
      {
        prompt: "Cell (4)",
        answer: "Claude Monet",
        acceptable: ["Monet", "Pierre-Auguste Renoir", "Renoir"],
      },
    ],
    analysis: `(1) Florence — "beginning in fifteenth-century Florence".
...
└────────┴──────────────────────────┴──────────────────────────┴─────────────────────────┘`,
    ...
    analysis: `(1) carbon dioxide — Venus's "dense atmosphere of carbon dioxide".
...
Storm sustained over warm water → wind speeds grow`,
    ...
    analysis: `(1) 26 — "exceeds about 26 degrees Celsius".
...
(4) eye — "a spinning vortex around an area of low pressure called the eye".`,
  },
  {
    ...
    instructions:
      "Complete the flow chart. Use NO MORE THAN TWO WORDS from the passage.",
    visual: `Researchers select a viral or bacterial (1) ______
            ↓
    ...
    items: [
      {
        prompt: "Step (1)",
        answer: "fragment",
        acceptable: ["target", "viral fragment"],
      },
      {
        prompt: "Step (2)",
        answer: "volunteers",
        acceptable: ["healthy volunteers"],
      },
      { prompt: "Step (3)", answer: "dose" },
      { prompt: "Step (4)", answer: "placebo" },
    ],
    analysis: `(1) fragment — "selecting a target — typically a fragment of a virus or bacterium".
...
Wine is clarified, blended and (4) ______`,
    ...
    analysis: `(1) crushed — "the grapes are first crushed to release their juice".
...
(4) bottled — "blended to achieve a consistent style, and bottled".`,
  ...
  // ───── 16. Diagram Completion (B2) — 10 new items ─────
  {
   ...
   (1) ______ ──→ │ ◯  ←── (2) ______ (coloured ring)
    ...
    items: [
      {
        prompt: "Label (1) — transparent front dome",
        answer: "cornea",
        acceptable: ["the cornea"],
      },
      {
        prompt: "Label (2) — coloured ring around the pupil",
        answer: "iris",
        acceptable: ["the iris"],
      },
      {
        prompt: "Label (3) — flexible focusing disc",
        answer: "lens",
        acceptable: ["the lens"],
      },
      {
        prompt: "Label (4) — light-sensitive lining at the back",
        answer: "retina",
        acceptable: ["the retina"],
      },
      {
        prompt: "Label (5) — nerve carrying signals to the brain",
        answer: "optic nerve",
        acceptable: ["the optic nerve"],
      },
    ],
    analysis: `(1) cornea — "the transparent dome that does most of the eye's focusing".
...
(5) optic nerve — "the optic nerve, which carries them to the brain".`,
  },
  {
    ...
    items: [
      {
        prompt: "Label (1) — three of these capture the wind",
        answer: "blades",
        acceptable: ["rotor blades"],
      },
      {
        prompt: "Label (2) — streamlined housing at the top",
        answer: "nacelle",
        acceptable: ["the nacelle"],
      },
      {
        prompt: "Label (3) — converts mechanical motion to electricity",
        answer: "generator",
        acceptable: ["the generator"],
      },
      {
        prompt: "Label (4) — vertical structure",
        answer: "tower",
        acceptable: ["the tower", "steel tower"],
      },
      {
        prompt: "Label (5) — raises the voltage before grid feed",
        answer: "transformer",
        acceptable: ["the transformer"],
      },
    ],
    analysis: `(1) blades — "three main rotor blades".
