...
export const SPEAKING_TOPICS: SpeakingTopic[] = [
  {
    ...
    part1: [
      {
        ...
        modelAnswer:
          "My hometown is Riyadh, the capital city of Saudi Arabia. It's a sprawling metropolis in the heart of the Arabian Peninsula, known for its modern skyline and rich cultural heritage. I've lived there for most of my life, and I'm quite fond of the way the city blends tradition with modernity.",
        keyVocabulary: [
      ...
      },
      {
        ...
        keyVocabulary: [
          ...
          {
            word: "venues",
            meaning: "places where events or activities happen",
          },
        ],
        tips: [
      ...
      },
      {
        ...
        modelAnswer:
          "If I had to mention one drawback, it would be the scorching summer heat. Temperatures can soar above 45 degrees, which makes it quite challenging to do outdoor activities for several months. However, people have adapted by spending more time in air-conditioned spaces, and the cooler winter months more than make up for it.",
        keyVocabulary: [
    ...
    part2: {
      ...
      keyVocabulary: [
        ...
        {
          word: "courtyard",
          meaning: "an open area surrounded by walls or buildings",
        },
    ...
    part1: [
      {
        ...
        modelAnswer:
          "I use the internet on a daily basis — it's become an integral part of my routine. From checking emails and browsing social media in the morning to streaming educational content in the evening, I'd say I'm online for at least five or six hours a day. While I'm aware that excessive screen time can be detrimental, I try to use the internet productively for learning and staying connected with family abroad.",
        keyVocabulary: [
          {
            word: "integral",
            meaning: "essential, necessary for completeness",
          },
          {
            word: "streaming",
            meaning: "watching or listening to content online in real time",
          },
      ...
      },
      {
        ...
        modelAnswer:
          "I'd have to say my favourite app is a language learning platform called LEXO. I find it incredibly user-friendly and well-designed. What I particularly like about it is the way it combines flashcards, quizzes, and AI-powered speaking practice all in one place. I use it every day to prepare for my IELTS exam, and I've noticed a significant improvement in my vocabulary since I started using it a few months ago.",
        keyVocabulary: [
          { word: "user-friendly", meaning: "easy to learn and use" },
          {
            word: "well-designed",
            meaning: "made in a way that works effectively",
          },
          {
            word: "significant",
            meaning: "large enough to be noticed or important",
          },
    ...
    part1: [
      {
        ...
        modelAnswer:
          "I try to maintain a balanced lifestyle. I go jogging three or four times a week, usually early in the morning before it gets too hot. I also pay attention to my diet — I've cut down on processed food and sugary drinks, and I try to incorporate more fruits, vegetables, and lean protein into my meals. Beyond physical health, I make a conscious effort to manage stress through meditation, even if it's just ten minutes a day.",
        keyVocabulary: [
          {
            word: "balanced",
            meaning: "having different elements in equal amounts",
          },
          { word: "cut down on", meaning: "reduce the amount of" },
          { word: "incorporate", meaning: "include as part of something" },
          {
            word: "conscious effort",
            meaning: "deliberate, intentional attempt",
          },
        ],
        tips: [
...

  {
    ...
    part3: [
      ...
      },
      {
        ...
        modelAnswer:
          "Generally speaking, yes, I believe travel can broaden one's horizons and foster greater tolerance and understanding. When you experience different cultures first-hand — their customs, values, and ways of life — it challenges your preconceptions and helps you see the world from multiple perspectives.\n\nHowever, I wouldn't say travel automatically makes everyone more open-minded. Some travellers stay within their comfort zones, sticking to tourist resorts and never truly engaging with the local culture. The key is how you travel — if you make an effort to interact with locals, learn some of the language, and step outside your comfort zone, then travel can be truly transformative.",
        keyVocabulary: [
          { word: "foster", meaning: "encourage the development of" },
          {
            word: "preconceptions",
            meaning: "ideas formed before having full knowledge",
          },
          {
            word: "transformative",
            meaning: "causing a great and positive change",
          },
          {
            word: "comfort zone",
            meaning: "situation where you feel safe and unchallenged",
          },
        ],
        tips: [
    ...
    part1: [
      {
        ...
        modelAnswer:
          "I'm currently pursuing a degree in Computer Science at King Saud University. I'm in my final year, so I'm quite focused on my graduation project, which involves developing a mobile application for language learning. I chose this field because I've always been fascinated by how technology can solve real-world problems, and I'm particularly interested in artificial intelligence and its applications in education.",
        keyVocabulary: [
          { word: "pursuing", meaning: "actively working towards" },
          {
            word: "graduation project",
            meaning: "final academic project to complete a degree",
          },
          { word: "fascinated", meaning: "very interested and attracted" },
      ...
      },
      {
        ...
        modelAnswer:
          "Ideally, I'd like to work as a software engineer at a technology company, preferably one that's working on innovative products. In the long run, I'd love to launch my own startup focused on educational technology, because I believe there's enormous potential to improve how people learn through AI and personalised content. I know it's ambitious, but I think the combination of technical skills and a clear vision can make it achievable.",
        keyVocabulary: [
    ...
    part3: [
      ...
      },
      {
        ...
        keyVocabulary: [
          ...
          {
            word: "fulfilment",
            meaning: "satisfaction from achieving something",
          },
        ],
        tips: [
    ...
    part1: [
      {
        ...
        keyVocabulary: [
          ...
          {
            word: "experimenting",
            meaning: "trying new things to see what happens",
          },
        ],
        tips: [
    ...
    part1: [
      {
        ...
        modelAnswer:
          "I try to spend as much time as possible with my family, though it can be challenging with my study commitments. We always have dinner together, which is a non-negotiable tradition in our household. On Fridays, which is our weekend, we usually gather at my grandparents' house for a family lunch. I find these regular family interactions incredibly grounding — they remind me of what truly matters in life.",
        keyVocabulary: [
          {
            word: "commitments",
            meaning: "things you must do; responsibilities",
          },
          {
            word: "non-negotiable",
            meaning: "not open to discussion or change",
          },
          {
            word: "grounding",
            meaning: "helping you feel stable and connected",
          },
        ],
        tips: [
      ...
      },
      {
        ...
        modelAnswer:
          "I'd say I'm closest to my mother. She's been my confidante and biggest supporter throughout my life. What I admire most about her is her ability to remain calm and optimistic, even during difficult times. She has this remarkable way of making everyone around her feel valued and understood. We can talk about absolutely anything, from everyday matters to deeper philosophical questions about life.",
        keyVocabulary: [
          {
            word: "confidante",
            meaning: "a person you trust with private matters",
          },
          {
            word: "optimistic",
          ...
          {
            word: "philosophical",
            meaning: "relating to deep questions about life and existence",
          },
        ],
        tips: [
    ...
    part2: {
      ...
      keyVocabulary: [
        ...
        { word: "integrity", meaning: "the quality of being honest and moral" },
        {
          ...
          meaning: "cannot both be true at the same time",
        },
...

  {
    ...
    part2: {
      cueCard:
        "Describe a time when you read or heard a piece of news that made you happy.",
      bullets: [
...

  {
    ...
    part2: {
      cueCard:
        "Describe a cultural event or tradition you have enjoyed participating in.",
      bullets: [
    ...
    part3: [
      {
        ...
        keyVocabulary: [
          ...
          {
            word: "disconnected",
            meaning: "having lost the feeling of connection",
          },
        ],
        tips: [
    ...
    part1: [
      {
        ...
        modelAnswer:
          "In my free time, I'm quite drawn to reading — mainly non-fiction books about psychology and self-improvement. I find it fascinating to learn about how the human mind works. I also enjoy playing football with friends on weekends, which is a great way to stay active and socialise. When I'm in the mood for something more relaxing, I'll watch documentaries or listen to podcasts about science and technology. I think it's important to have a mix of active and passive hobbies.",
        keyVocabulary: [
      ...
      },
      {
        ...
        keyVocabulary: [
          ...
          {
            word: "rejuvenating",
            meaning: "making you feel young and energetic again",
          },
        ],
        tips: [
