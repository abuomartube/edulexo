...
const orwellTask1: PlanContentItem[] = [
  {
    id: "task1-1",
    title: "Bar chart: Car ownership",
    href: "/essay-checker?id=task1-1",
  },
  {
    id: "task1-2",
    title: "Bar chart: Leisure activities",
    href: "/essay-checker?id=task1-2",
  },
  {
    id: "task1-3",
    title: "Bar chart: University subjects",
    href: "/essay-checker?id=task1-3",
  },
  {
    id: "task1-4",
    title: "Line graph: Internet users",
    href: "/essay-checker?id=task1-4",
  },
  {
    id: "task1-5",
    title: "Line graph: Average temperatures",
    href: "/essay-checker?id=task1-5",
  },
  {
    id: "task1-6",
    title: "Line graph: Crime trends",
    href: "/essay-checker?id=task1-6",
  },
  {
    id: "task1-7",
    title: "Pie chart: Household energy",
    href: "/essay-checker?id=task1-7",
  },
  {
    id: "task1-8",
    title: "Pie chart: Student spending",
    href: "/essay-checker?id=task1-8",
  },
  {
    id: "task1-9",
    title: "Pie chart: Waste composition",
    href: "/essay-checker?id=task1-9",
  },
  {
    id: "task1-10",
    title: "Process: The water cycle",
    href: "/essay-checker?id=task1-10",
  },
  {
    id: "task1-11",
    title: "Process: Paper recycling",
    href: "/essay-checker?id=task1-11",
  },
  {
    id: "task1-12",
    title: "Task 1 prompt 12",
    href: "/essay-checker?id=task1-12",
  },
  {
    id: "task1-13",
    title: "Task 1 prompt 13",
    href: "/essay-checker?id=task1-13",
  },
  {
    id: "task1-14",
    title: "Task 1 prompt 14",
    href: "/essay-checker?id=task1-14",
  },
  {
    id: "task1-15",
    title: "Task 1 prompt 15",
    href: "/essay-checker?id=task1-15",
  },
  {
    id: "task1-16",
    title: "Task 1 prompt 16",
    href: "/essay-checker?id=task1-16",
  },
  {
    id: "task1-17",
    title: "Task 1 prompt 17",
    href: "/essay-checker?id=task1-17",
  },
  {
    id: "task1-18",
    title: "Task 1 prompt 18",
    href: "/essay-checker?id=task1-18",
  },
  {
    id: "task1-19",
    title: "Task 1 prompt 19",
    href: "/essay-checker?id=task1-19",
  },
  {
    id: "task1-20",
    title: "Task 1 prompt 20",
    href: "/essay-checker?id=task1-20",
  },
];
...
const orwellParagraph: PlanContentItem[] = Array.from(
  { length: 15 },
  (_, i) => ({
    id: `para-${i + 1}`,
...
const readingMockTests: PlanContentItem[] = [
  {
    id: "test1",
    title: "Mock Test 1: Urban farming, Forests, Space junk",
    href: "/reading-test?test=test1",
  },
  {
    id: "test2",
    title: "Mock Test 2: Kākāpō, Elms, Stress",
    href: "/reading-test?test=test2",
  },
  {
    id: "test3",
    title: "Mock Test 3: Manatees, Procrastination, Robots",
    href: "/reading-test?test=test3",
  },
  {
    id: "test4",
    title: "Mock Test 4: Vertical Forests, Sleep, Happiness",
    href: "/reading-test?test=test4",
  },
  {
    id: "test5",
    title: "Mock Test 5: Soil, AI in Healthcare, Timekeeping",
    href: "/reading-test?test=test5",
  },
];
...
const listeningMockTests: PlanContentItem[] = [
  {
    id: "listening-1",
    title: "Mock 1: Restaurants, Pottery, Loneliness, Rivers",
    href: "/listening-test?test=listening-1",
  },
  {
    id: "listening-2",
    title: "Mock 2: Carers, Volunteering, Geography, Food",
    href: "/listening-test?test=listening-2",
  },
  {
    id: "listening-3",
    title: "Mock 3: Library, Wildlife, Marine Bio, Transport",
    href: "/listening-test?test=listening-3",
  },
  {
    id: "listening-4",
    title: "Mock 4: Insurance, Museum, Psychology, Architecture",
    href: "/listening-test?test=listening-4",
  },
];
...
const HARDER_PREFIXES = READING_SKILL_PREFIXES.filter(
  (p) => !EASY_PREFIXES.includes(p),
);
