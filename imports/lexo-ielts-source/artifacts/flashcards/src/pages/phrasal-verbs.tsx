...
export default function PhrasalVerbs() {
  ...
  const {
    ...
    save: savePosition,
    loadedRef,
  } = useActivityPosition("phrasal-verbs", levelFilter);
      ...
      <div className="flex flex-col h-full max-w-2xl mx-auto animate-in fade-in duration-500">
        <div className="flex flex-col gap-3 mb-5">
          ...
          <p className="text-sm text-muted-foreground">
            {cards.length} cards · See the phrasal verb → guess the meaning →
            flip to check
          </p>
        </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            >
              ...
              >
                ...
                >
                  <span
                    className={`text-[11px] font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-8 ${levelColors[card.level] ?? levelColors["All Levels"]}`}
                  >
                    {card.level}
                  </span>
                ...
                >
                  ...
                  <div className="flex-1 px-8 py-5 flex flex-col justify-center gap-4 overflow-y-auto">
                    <div className="text-center">
                      ...
                      <p
                        className="text-sm text-primary-foreground/75 arabic-text mt-1"
                        dir="rtl"
                        lang="ar"
                      >
                        {card.meaningAr}
