      ...
      {expanded && (
        <div className="px-4 pb-4 space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-300 dark:border-amber-700 rounded-xl p-4 space-y-2">
            ...
            <p className="text-xs font-semibold text-foreground uppercase tracking-wider mt-2">
              You should say:
            </p>
            {p2.bullets.map((b, i) => (
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5 animate-in fade-in duration-300">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {topic.part1.length + 1 + topic.part3.length} questions with model
              answers
            </p>
          </div>
        </div>
      ...
      <p className="text-center text-xs text-muted-foreground pt-2">
        💡 Practice these answers out loud — reading alone isn't enough for
        Speaking!
      </p>
    </div>
  );
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground mt-0.5">
                    {topic.part1.length + 1 + topic.part3.length} questions · 3
                    parts
                  </div>
                </div>
