  ...
  return (
    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center px-4 pt-12 pb-8 gap-10">
          ...
          <div>
            ...
            <div className="flex items-center justify-center gap-1 mt-2">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  className="w-4 h-4 fill-gold-500"
        ...
        >
          "Hi, this is Churchill AI. I am here to enhance your speaking skills
          and help you achieve your target IELTS band score. Let's begin."
        </div>
          ...
          {[
            {
              n: "1",
              label: "Introduction",
              desc: "8 personal questions about the topic",
            },
            {
              n: "2",
              label: "Long Turn",
              desc: "1 minute to prepare + 1–2 minute talk",
            },
            {
              n: "3",
              label: "Discussion",
              desc: "4 abstract analytical questions",
            },
          ].map((p) => (
            <div
              key={p.n}
