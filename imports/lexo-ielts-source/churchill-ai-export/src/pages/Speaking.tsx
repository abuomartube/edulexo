...
const CUE_CARDS: Record<string, string> = {
  ...
  Animals:
    "an animal that you find interesting or that has been important to you",
  ...
  Mountains:
    "a mountain or outdoor landscape you have visited or would like to visit",
  Forests: "a forest, park, or green area that you enjoy or find interesting",
  "Climate change":
    "something you have noticed about climate change or its effects",
  ...
  "Morning routines":
    "your morning routine or a morning that stands out in your memory",
  ...
  Neighbors:
    "a neighbour or someone who lives near you that you find interesting",
  Childhood: "a memory or experience from your childhood that stands out",
  Relationships:
    "an important relationship in your life and what makes it special",
  ...
  Community:
    "a community group, club, or organisation you are part of or know about",
  Volunteering:
    "a time when you or someone you know volunteered to help others",
  ...
  "Online learning":
    "an online course, video, or learning platform you have used",
  ...
  "Job interviews":
    "a job interview or application process you have experienced",
  ...
  Internet:
    "a website, app, or online service that has changed your daily life",
  ...
  Transportation:
    "a form of transport or journey that stands out in your memory",
  Space: "something related to space exploration that fascinates you",
  Innovation:
    "a recent invention or technological innovation you find impressive",
  ...
  "Electric cars":
    "an electric vehicle or new type of transport you find interesting",
  "Smart homes":
    "a smart device or home technology you use or find interesting",
  ...
  "Mental health":
    "something that helps you relax or maintain your mental wellbeing",
  ...
  "Healthy eating":
    "a healthy food or eating habit that you practice or admire",
  "Work-life balance":
    "something you do to maintain a healthy balance between work and personal life",
  ...
  "Cultural heritage":
    "a cultural tradition or heritage that you find fascinating",
  ...
  "Personal ambition":
    "a personal ambition or aspiration that drives you forward",
  Creativity: "a creative person or creative project that you admire",
  "Decision making":
    "an important decision you have made that changed your life",
  "Risk taking":
    "a risk you or someone you know took and what happened as a result",
...
const VOICE_INTRO =
  "Welcome to Churchill AI. I am your personal IELTS Speaking Examiner. Please relax, speak naturally, and let's begin your practice session.";
const GOODBYE_MESSAGE =
  "This has been Churchill AI. Thank you for practising today. Keep going, stay consistent, and your band score will improve. Goodbye and good luck.";
...
function parseFeedback(text: string) {
  ...
  const examinerText = examinerLines
    .join("\n")
...
async function callMessageStream(
  messages: Message[],
  topic: string,
  part: number,
  questionNum: number,
...
function AIChatBubble({ content }: { content: string }) {
  const { examinerText, correction, suggestion, vocab, band } =
  ...
  return (
    <div className="flex gap-3 justify-start">
      ...
      <div className="max-w-[85%] space-y-2">
        {examinerText && (
          <div
            className="rounded-2xl rounded-tl-sm px-4 py-3 text-sm leading-relaxed text-white whitespace-pre-wrap"
            style={{
        ...
        {hasFeedback && (
          ...
          >
            {correction && (
              ...
              >
                <span className="text-red-400">
                  {correction.split("→")[0]?.trim()}
                </span>
                <span className="text-white/50 mx-2">→</span>
                <span className="text-green-400 font-semibold">
                  {correction.split("→")[1]?.trim()}
                </span>
              </div>
            )}
            {suggestion && (
              <div
                className="rounded-xl px-3 py-2 text-sm text-teal-300"
                style={{
            ...
            {band && (
              <div className="text-sm font-bold px-1" style={{ color: GOLD }}>
                {band}
              </div>
            )}
          </div>
...
function UserChatBubble({ content }: { content: string }) {
  return (
    <div className="flex gap-3 justify-end">
      <div
        className="max-w-[85%] rounded-2xl rounded-tr-sm px-4 py-3 text-sm leading-relaxed text-white whitespace-pre-wrap"
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1 text-sm text-white/60">
        <p className="font-semibold text-white/80 text-xs uppercase tracking-wider mb-2">
          You should say:
        </p>
...
function CountdownTimer({
  ...
  return (
    ...
    >
      <Timer
        className={`w-5 h-5 shrink-0 ${urgent ? "animate-pulse" : ""}`}
        style={{ color: urgent ? "#ef4444" : "#38bdf8" }}
      />
      <div className="flex-1">
        <div className="flex items-center justify-between mb-1">
          ...
          <span
            className={`font-bold text-lg tabular-nums ${urgent ? "text-red-400" : "text-sky-300"}`}
          >
            {remaining}s
          </span>
        </div>
        ...
        >
          <div
            ...
            style={{
              width: `${pct}%`,
              background: urgent ? "#ef4444" : "#38bdf8",
            }}
          />
        </div>
      </div>
  ...
  return (
    <div className="space-y-5 animate-in fade-in duration-500">
      ...
      >
        ...
        <div className="text-7xl font-black my-3" style={{ color: bandColor }}>
          {band}
        </div>
      ...
      >
        ...
        <BandBar
          ...
          band={report.fluencyCoherence.band}
        />
        <BandBar label="Lexical Resource" band={report.lexicalResource.band} />
        <BandBar
          label="Grammatical Range & Accuracy"
          band={report.grammaticalRange.band}
        />
        <BandBar
          label="Pronunciation (estimated)"
          band={report.pronunciation.band}
        />
      </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <ul className="space-y-1">
              {report.pronunciation.tips.map((t, i) => (
                <li
                  key={i}
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl font-bold text-base transition-all hover:opacity-90"
        style={{ background: GOLD, color: NAVY }}
      >
...
function buildTranscriptText(
  ...
  if (report) {
    lines.push(
      ...
      "FINAL REPORT",
      "━━━━━━━━━━━━━━━━━━━━━",
      `Overall Band: ${report.overallBand}/9`,
      `Fluency & Coherence: ${report.fluencyCoherence.band}/9`,
      `Lexical Resource: ${report.lexicalResource.band}/9`,
      `Grammatical Range: ${report.grammaticalRange.band}/9`,
    );
    if (report.improvements?.length) {
      lines.push("", "Top improvements:");
      report.improvements
        .slice(0, 5)
        .forEach((imp, idx) => lines.push(`${idx + 1}. ${imp}`));
    }
    lines.push("━━━━━━━━━━━━━━━━━━━━━");
  }
  return lines.join("\n");
    ...
    >
      ...
      >
        <div className="flex items-center justify-between px-4 pt-4 pb-2">
          ...
          <button
            onClick={onClose}
            className="px-3 py-1.5 rounded-xl text-xs font-semibold text-white/60 hover:bg-white/10 transition-colors"
          >
            ✕
          </button>
        </div>
        <div className="px-4 pb-3 flex items-center gap-2 flex-wrap text-xs text-white/40">
          ...
          <span>{date}</span>
          <span>·</span>
          <span>Part {partsInTranscript} of 3 completed</span>
        </div>
      </div>
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          return (
            <div key={i}>
              ...
              >
                ...
                {e.correction && (
                  <p className="text-red-400 text-xs">❌ {e.correction}</p>
                )}
                {e.vocab && (
                  <p className="text-sky-400 text-xs">📝 {e.vocab}</p>
                )}
                {e.band && (
                  <p className="text-xs font-semibold" style={{ color: GOLD }}>
                    ⭐ {e.band}
        ...
        {report && (
          <div
            className="rounded-2xl p-4 text-sm space-y-1.5"
            style={{
              background: "rgba(201,168,76,0.08)",
              border: "1px solid rgba(201,168,76,0.2)",
            }}
          >
            <h3 className="font-bold mb-2" style={{ color: GOLD }}>
              📊 FINAL REPORT
            </h3>
      ...
      >
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl border text-sm font-semibold text-white/60 hover:bg-white/10 transition-colors"
...
export default function Speaking({ onBack }: Props) {
  ...
  const rtConversationRef = useRef<
    { role: "user" | "assistant"; content: string }[]
  >([]);
  const rtResponseTextRef = useRef("");
  const rtHandlerRef = useRef<((e: Record<string, unknown>) => void) | null>(
    null,
  );
  ...
  useEffect(() => {
    rtMessagesEndRef.current?.scrollIntoView({ behavior: "smooth" });
  }, [rtMessages, rtStreamText]);
  useEffect(() => {
    rtTopicRef.current = rtTopic;
  }, [rtTopic]);
  ...
  const setTtsSpeed = useCallback((speed: number) => {
    ...
    if (ttsAudioRef.current && isSpeakingRef.current) {
      ttsAudioRef.current.playbackRate = Math.max(
        0.25,
        Math.min(4.0, speed / ttsGeneratedSpeedRef.current),
      );
    }
  }, []);
  ...
  const startSession = useCallback(
    async (mode: SessionMode) => {
      ...
      try {
        const reply = await callMessageStream(
          [],
          topic,
          1,
          1,
  ...
  const processAnswer = useCallback(
    async (text: string) => {
      ...
      const { examinerText: lastQuestion } = lastAiMsg
        ? parseFeedback(lastAiMsg.content)
        : { examinerText: "" };
  ...
  const nextPart = useCallback(async () => {
    if (session.part === 1) {
      const cue =
        CUE_CARDS[session.topic] ?? `something related to ${session.topic}`;
      const cueMsg: Message = {
        role: "assistant",
          ...
          if (!res.ok) {
            setError(
              data.error === "quota_exceeded"
                ? "⚠️ OpenAI quota exceeded. Add billing at platform.openai.com."
                : data.message || "Voice transcription failed.",
            );
            return;
          }
          if (data.text?.trim()) {
  ...
  const handleRtEvent = useCallback((event: Record<string, unknown>) => {
    switch (event.type as string) {
      ...
      case "response.output_item.done": {
        ...
        if (item?.role === "assistant") {
          ...
          if (text?.trim()) {
            ...
            rtConversationRef.current.push({
              role: "assistant",
              content: text,
            });
      ...
      case "error": {
        ...
        setRtError(
          err?.message ?? "Realtime connection error. Please try again.",
        );
        break;
      }
    }
  ...
  useEffect(() => {
    rtHandlerRef.current = handleRtEvent;
  }, [handleRtEvent]);
  ...
  const stopRealtimeSession = useCallback((andReport = false) => {
    ...
    if (andReport) {
      ...
      const msgs = rtConversationRef.current.map((m) => ({
  ...
  const startRealtimeSession = useCallback(async () => {
    ...
    try {
      const res = await fetch("/api/realtime-session", {
        ...
        body: JSON.stringify({
          topic,
          cue: CUE_CARDS[topic] ?? `something related to ${topic}`,
        }),
      });
      ...
      dc.onmessage = (e) => {
        try {
          rtHandlerRef.current?.(JSON.parse(e.data) as Record<string, unknown>);
        } catch {
          /* ignore */
        }
      };
      ...
      if (!sdpRes.ok)
        throw new Error(
          "WebRTC negotiation failed — check your OpenAI API key",
        );
  ...
  const showViewReportBtn =
    session.partDone && !isLoading && session.phase === "part3";
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(160deg, #0D1B3E 0%, #132244 60%, #0D1B3E 100%)",
      }}
    >
      {/* ── HEADER ── */}
      <header
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {(rtTopic || session.topic) && (
            <span className="text-xs text-white/40 hidden sm:inline">
              Topic: {rtTopic || session.topic}
            </span>
          )}
          {sessionNumber > 0 && (
            <span className="text-xs text-white/40 hidden sm:inline">
          ...
          {(session.phase !== "idle" || rtStatus !== "idle") && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold text-white/60 hover:bg-white/10 transition-colors"
          ...
          <>
            ...
            {rtStatus === "connecting" && (
              <div className="flex-1 flex flex-col items-center justify-center gap-5">
                <div className="relative">
                  <div
                    className="w-20 h-20 rounded-full animate-ping absolute inset-0"
                ...
                <p className="text-white font-bold text-lg">
                  Connecting to Churchill AI…
                </p>
                <p className="text-white/40 text-sm text-center">
                  Setting up real-time voice connection via WebRTC
                </p>
              </div>
            )}
            ...
            {(rtStatus === "live" || rtStatus === "done") && (
              <>
                  ...
                  <div className="flex items-center gap-2">
                    {rtStatus === "live" && (
                      <div className="flex items-center gap-1.5">
                        <div
                          className={`w-2.5 h-2.5 rounded-full ${rtIsAiSpeaking ? "animate-pulse" : rtIsUserSpeaking ? "bg-green-400" : "bg-white/20"}`}
                          style={rtIsAiSpeaking ? { background: GOLD } : {}}
                        />
                        <span
                ...
                <div className="flex-1 overflow-y-auto space-y-4 py-2 pr-1">
                  {rtMessages.length === 0 && rtStatus === "live" && (
                    <div className="flex flex-col items-center gap-3 pt-8 text-center">
                      <div className="relative">
                        <div
                          className="w-14 h-14 rounded-full animate-ping absolute inset-0"
                      ...
                      <p className="text-white/60 text-sm">
                        Churchill AI is introducing the test…
                      </p>
                      <p className="text-white/30 text-xs">
                        Speak naturally — the examiner will hear you
                        automatically
                      </p>
                    </div>
                  )}
                  ...
                  {rtStreamText && (
                    <AIChatBubble content={rtStreamText + "▌"} />
                  )}
                ...
                {rtError && (
                  <div
                    className="shrink-0 flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-red-400 mb-2"
                    style={{
                      background: "rgba(239,68,68,0.1)",
                      border: "1px solid rgba(239,68,68,0.3)",
                    }}
                ...
                {rtStatus === "live" && (
                  <div className="shrink-0 flex gap-2 mt-3">
                    <button
                      onClick={() => stopRealtimeSession(true)}
                      className="flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl font-bold text-sm transition-opacity hover:opacity-90"
                      style={{ background: "#4ade80", color: NAVY }}
                    >
                      <Trophy className="w-4 h-4" />
                      End &amp; Get Report
                    </button>
                    <button
                      onClick={() => stopRealtimeSession(false)}
                      className="px-4 py-3 rounded-2xl text-sm font-semibold text-white/50 hover:bg-white/10 transition-colors"
                      style={{ border: "1px solid rgba(255,255,255,0.15)" }}
                    >
                      End
                    </button>
                    ...
                    {rtReport && (
                      <>
                        <FinalReport
                          report={rtReport}
                          topic={rtTopic}
                          onNewSession={resetRealtimeSession}
                        />
                        <button
                          onClick={resetRealtimeSession}
                          className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl text-sm font-semibold text-white/50 hover:bg-white/10 transition-colors"
                          style={{ border: "1px solid rgba(255,255,255,0.15)" }}
                        >
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => {
                            setRtGeneratingReport(true);
                            callReport(
                              rtConversationRef.current.map((m) => ({
                                role: m.role as "user" | "assistant",
                                content: m.content,
                              })),
                              rtTopic,
                            )
                              .then((r) => setRtReport(r))
                              .catch(() =>
                                setRtError("Failed to generate report."),
                              )
                              .finally(() => setRtGeneratingReport(false));
                          }}
                          className="flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl font-bold text-sm transition-opacity hover:opacity-90"
        ...
        {rtStatus === "idle" && session.phase === "idle" && (
          <div className="flex-1 flex flex-col items-center gap-5 overflow-y-auto pb-4">
            <div
              ...
              style={{
                background: "linear-gradient(160deg,#0D1B3E 0%,#132244 100%)",
                border: "1px solid rgba(201,168,76,0.2)",
              }}
            >
              <div
              ...
              <div>
                ...
                <div
                  className="rounded-2xl px-4 py-3 max-w-sm mx-auto"
                  style={{ background: "rgba(255,255,255,0.08)" }}
                >
                  <p className="text-sm text-white/80 leading-relaxed italic">
                    "Hi, this is Churchill AI. I am here to enhance your
                    speaking skills and help you achieve your target IELTS band
                    score. Let's begin."
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 text-sm w-full">
              {[
                ...
                >
                  <span>{item.icon}</span>
                  <span className="font-medium text-white/70">{item.text}</span>
                </div>
              ))}
            </div>
            ...
            {rtError && (
              <div
                className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-red-400"
                style={{
                  background: "rgba(239,68,68,0.1)",
                  border: "1px solid rgba(239,68,68,0.3)",
                }}
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full">
              <button
                ...
                className="flex-1 flex flex-col items-center gap-1 px-6 py-4 rounded-2xl font-bold shadow-xl transition-all hover:opacity-90"
                style={{ background: GOLD, color: NAVY }}
              >
              ...
              <button
                ...
                className="flex-1 flex flex-col items-center gap-1 px-6 py-4 rounded-2xl font-bold transition-all hover:bg-white/10"
                style={{
                  background: "rgba(255,255,255,0.07)",
            ...
            <div className="flex-1 overflow-y-auto space-y-3">
              ...
              {transcript.length > 0 && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl text-sm font-semibold text-white/60 hover:bg-white/10 transition-colors"
                  style={{ border: "1px solid rgba(255,255,255,0.15)" }}
                >
        ...
        {rtStatus === "idle" &&
          (session.phase === "part1" ||
            ...
            <>
              ...
              <div className="shrink-0 flex items-center gap-2 mb-2 flex-wrap">
                ...
                <div className="flex gap-1">
                  {SPEED_OPTIONS.map((opt) => (
                    ...
                    >
                      {opt.label}
                      <span className="block text-[9px] font-normal opacity-70 leading-tight">
                        {opt.arabic}
                      </span>
                    </button>
                  ))}
              ...
              {session.phase === "part2-prep" && (
                <div className="shrink-0 mt-3">
                  ...
                  <p className="text-xs text-white/40 text-center mt-2">
                    Read the cue card above. Your answer box will unlock when
                    the timer ends.
                  </p>
                </div>
              )}
              ...
              {error && (
                <div
                  className="shrink-0 flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-red-400"
                  style={{
                    background: "rgba(239,68,68,0.1)",
                    border: "1px solid rgba(239,68,68,0.3)",
                  }}
              ...
              {(showNextPartBtn || showViewReportBtn) && (
                <div className="shrink-0 mt-3">
                  {showNextPartBtn && (
                    <button
                      onClick={nextPart}
                      className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl font-bold hover:opacity-90 transition-opacity shadow-sm"
                      style={{ background: GOLD, color: NAVY }}
                    >
                  ...
                  {showViewReportBtn && (
                    <button
                      onClick={viewReport}
                      className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl font-bold transition-opacity hover:opacity-90"
                      style={{ background: "#4ade80", color: NAVY }}
                    >
                ...
                !showViewReportBtn && (
                  <div className="shrink-0 mt-3 flex flex-col items-center gap-3">
                    ...
                    <p className="text-xs text-white/40 text-center">
                      {isRecording
                        ? "اضغط مرة ثانية لإيقاف التسجيل"
                        : isSpeaking
                          ? "اضغط لمقاطعة المحكّم"
                          : "اضغط للتسجيل · يُرسَل تلقائياً"}
                    </p>
                    {lastTtsText &&
                      !isRecording &&
                      !isSpeaking &&
                ...
                !showViewReportBtn && (
                  <div className="shrink-0 mt-3 space-y-2">
                    ...
                    <div className="flex gap-2 items-end">
                      <div
                        className="flex-1 rounded-2xl overflow-hidden transition-colors"
                        style={{
                          background: "rgba(255,255,255,0.06)",
                          border: `1px solid rgba(255,255,255,0.15)`,
                        }}
                      >
                        <textarea
                          ...
                          rows={3}
                          className="w-full px-4 py-3 text-sm bg-transparent text-white placeholder-white/30 resize-none focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
                        />
                      </div>
                      <button
                        onClick={sendMessage}
                        disabled={
                          inputDisabled || !input.trim() || isTranscribing
                        }
                        className="w-12 h-12 rounded-2xl flex items-center justify-center transition-all disabled:opacity-40 disabled:cursor-not-allowed shrink-0 shadow-sm"
                        style={{ background: GOLD, color: NAVY }}
                      >
                        {isLoading ? (
                    ...
                    {lastTtsText && !isSpeaking && !isLoading && (
                      <button
                        onClick={replayTts}
                        className="flex items-center gap-1.5 text-xs text-white/40 hover:text-white/70 transition-colors px-1"
                      >
                        <Volume2 className="w-3.5 h-3.5" />
                        Replay Churchill AI's last question
                      </button>
                    )}
                  </div>
                )}
                ...
                session.phase !== "part2-prep" && (
                  <div className="shrink-0 flex items-center justify-between text-xs text-white/30 mt-1 px-1">
                    <span className="flex items-center gap-1">
                      ...
                      Part {session.part} · {session.answeredCount}/
                      {PART_LIMITS[session.part]} answered
                    </span>
                    <span>
                      {sessionMode === "voice" ? "🎤 وضع صوتي" : "⌨️ وضع كتابي"}
                    </span>
                  </div>
                )}
            </>
      ...
      <a
        href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi! I want to practice IELTS Speaking with Churchill AI.`}
        target="_blank"
        rel="noreferrer"
