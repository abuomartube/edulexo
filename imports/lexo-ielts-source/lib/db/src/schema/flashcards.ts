...
export const cardSrsTable = pgTable(
  "card_srs",
  {
    id: serial("id").primaryKey(),
    flashcardId: integer("flashcard_id")
...
export const storyQuizzesTable = pgTable(
  "story_quizzes",
  {
    id: serial("id").primaryKey(),
...
export const activityPositionTable = pgTable(
  "activity_positions",
  {
    id: serial("id").primaryKey(),
    email: text("email").notNull(),
...
export const xpEventsTable = pgTable(
  ...
  (t) => [
    ...
    index("xp_events_email_activity_created_idx").on(
      t.email,
      t.activity,
      t.createdAt,
    ),
...
export const weakWordsTable = pgTable(
  "weak_words",
  {
    id: serial("id").primaryKey(),
    email: text("email").notNull(),
...
export const orwellSubmissionsTable = pgTable(
  "orwell_submissions",
  {
    id: serial("id").primaryKey(),
    email: text("email").notNull(),
...
export const orwellCoachSummariesTable = pgTable(
  "orwell_coach_summaries",
  {
    id: serial("id").primaryKey(),
    email: text("email").notNull(),
