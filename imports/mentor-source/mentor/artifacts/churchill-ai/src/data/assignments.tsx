...
const PALETTE = ["#0A1A30", "#00B4C8", "#F59E0B", "#EF4444", "#10B981", "#8B5CF6"];
    ...
    visual: (
      <RawSvg
        ...
        svg={`<svg viewBox="0 0 640 340" style="width:100%;max-width:640px" xmlns="http://www.w3.org/2000/svg">
          <defs><marker id="a1" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto"><path d="M0 0 L10 5 L0 10 z" fill="#0A1A30"/></marker></defs>
          ...
          <g transform="translate(40,60)">
            ...
            <text x="50" y="140" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">1. Eggs</text>
            <text x="50" y="156" text-anchor="middle" font-size="10" fill="#64748b">laid on a leaf</text>
          </g>
          <line x1="150" y1="100" x2="200" y2="100" stroke="#0A1A30" stroke-width="2" marker-end="url(#a1)"/>
          <!-- Stage 2: Caterpillar -->
          <g transform="translate(210,70)">
            ...
            <circle cx="88" cy="26" r="2" fill="#0A1A30"/>
            <text x="50" y="130" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">2. Caterpillar</text>
            <text x="50" y="146" text-anchor="middle" font-size="10" fill="#64748b">feeds and grows</text>
          </g>
          <line x1="320" y1="100" x2="370" y2="100" stroke="#0A1A30" stroke-width="2" marker-end="url(#a1)"/>
          <!-- Stage 3: Chrysalis -->
          <g transform="translate(380,60)">
            ...
            <text x="50" y="140" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">3. Chrysalis</text>
            <text x="50" y="156" text-anchor="middle" font-size="10" fill="#64748b">pupa stage, ~2 weeks</text>
          </g>
          <line x1="490" y1="100" x2="540" y2="100" stroke="#0A1A30" stroke-width="2" marker-end="url(#a1)"/>
          <!-- Stage 4: Butterfly -->
          <g transform="translate(545,55)">
            <ellipse cx="40" cy="50" rx="5" ry="22" fill="#0A1A30"/>
            ...
            <text x="40" y="140" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">4. Butterfly</text>
            <text x="40" y="156" text-anchor="middle" font-size="10" fill="#64748b">adult emerges</text>
          </g>
          <!-- Loop back arrow -->
          <path d="M580,200 Q580,270 320,270 Q60,270 60,200" fill="none" stroke="#00B4C8" stroke-width="2" stroke-dasharray="5 4" marker-end="url(#a1)"/>
          <text x="320" y="295" text-anchor="middle" font-size="11" font-style="italic" fill="#00B4C8" font-weight="600">cycle begins again — adult lays new eggs</text>
        </svg>`}
      />
    ),
  },
    ...
    visual: (
      <RawSvg
        ...
        svg={`<svg viewBox="0 0 640 360" style="width:100%;max-width:640px" xmlns="http://www.w3.org/2000/svg">
          <defs><marker id="a2" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="8" markerHeight="8" orient="auto"><path d="M0 0 L10 5 L0 10 z" fill="#0A1A30"/></marker></defs>
          ...
          <g transform="translate(20,30)">
            ...
            <text x="50" y="135" text-anchor="middle" font-size="11" font-weight="700" fill="#0A1A30">1. Harvest</text>
            <text x="50" y="150" text-anchor="middle" font-size="10" fill="#64748b">cocoa pods picked</text>
          </g>
          <line x1="125" y1="90" x2="165" y2="90" stroke="#0A1A30" stroke-width="2" marker-end="url(#a2)"/>
          <!-- Step 2: Ferment -->
          <g transform="translate(170,30)">
            ...
            <text x="55" y="135" text-anchor="middle" font-size="11" font-weight="700" fill="#0A1A30">2. Ferment</text>
            <text x="55" y="150" text-anchor="middle" font-size="10" fill="#64748b">beans fermented 6 days</text>
          </g>
          <line x1="280" y1="90" x2="320" y2="90" stroke="#0A1A30" stroke-width="2" marker-end="url(#a2)"/>
          <!-- Step 3: Dry -->
          <g transform="translate(325,30)">
            ...
            <text x="55" y="135" text-anchor="middle" font-size="11" font-weight="700" fill="#0A1A30">3. Dry</text>
            <text x="55" y="150" text-anchor="middle" font-size="10" fill="#64748b">sun-dried for 1 week</text>
          </g>
          <line x1="435" y1="90" x2="475" y2="90" stroke="#0A1A30" stroke-width="2" marker-end="url(#a2)"/>
          <!-- Step 4: Roast -->
          <g transform="translate(480,30)">
            ...
            <text x="55" y="135" text-anchor="middle" font-size="11" font-weight="700" fill="#0A1A30">4. Roast</text>
            <text x="55" y="150" text-anchor="middle" font-size="10" fill="#64748b">at 120°C</text>
          </g>
          <!-- Row 2 flow down-left -->
          <path d="M535,170 Q535,200 490,200" stroke="#0A1A30" stroke-width="2" fill="none" marker-end="url(#a2)"/>
          <!-- Step 5: Grind -->
          <g transform="translate(380,180)">
            ...
            <text x="55" y="95" text-anchor="middle" font-size="11" font-weight="700" fill="#0A1A30">5. Grind</text>
            <text x="55" y="110" text-anchor="middle" font-size="10" fill="#64748b">beans → cocoa paste</text>
          </g>
          <line x1="375" y1="210" x2="335" y2="210" stroke="#0A1A30" stroke-width="2" marker-end="url(#a2)"/>
          <!-- Step 6: Mix -->
          <g transform="translate(230,180)">
            ...
            <text x="55" y="95" text-anchor="middle" font-size="11" font-weight="700" fill="#0A1A30">6. Mix</text>
            <text x="55" y="110" text-anchor="middle" font-size="10" fill="#64748b">add sugar &amp; milk</text>
          </g>
          <line x1="225" y1="210" x2="185" y2="210" stroke="#0A1A30" stroke-width="2" marker-end="url(#a2)"/>
          <!-- Step 7: Mould -->
          <g transform="translate(80,180)">
            ...
            <text x="60" y="95" text-anchor="middle" font-size="11" font-weight="700" fill="#0A1A30">7. Mould &amp; cool</text>
  ...
  },
  {
    ...
    visual: (
      <RawSvg
        ...
        svg={`<svg viewBox="0 0 640 360" style="width:100%;max-width:640px" xmlns="http://www.w3.org/2000/svg">
          <defs><marker id="a3" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0 0 L10 5 L0 10 z" fill="#00B4C8"/></marker></defs>
          <!-- Rain -->
          ${Array.from({ length: 18 }, (_, i) => `<line x1="${60 + i * 15}" y1="20" x2="${54 + i * 15}" y2="40" stroke="#00B4C8" stroke-width="1.6"/>`).join("")}
          <text x="320" y="14" text-anchor="middle" font-size="11" font-style="italic" fill="#00B4C8" font-weight="700">Rainwater falls on roof</text>
          <!-- House -->
          ...
          <text x="110" y="180" text-anchor="middle" font-size="10" fill="#0A1A30" font-weight="600">Gutter &amp;</text>
          <text x="110" y="194" text-anchor="middle" font-size="10" fill="#0A1A30" font-weight="600">downpipe</text>
          <!-- Filter -->
          <rect x="130" y="254" width="30" height="20" fill="#F59E0B" stroke="#78350F"/>
          <text x="145" y="290" text-anchor="middle" font-size="10" fill="#0A1A30" font-weight="600">Filter</text>
          ...
          <text x="345" y="300" font-size="10" fill="#0A1A30" font-weight="600">Pump delivers</text>
          <text x="345" y="314" font-size="10" fill="#0A1A30" font-weight="600">water to taps</text>
          <!-- Overflow -->
          ...
          <!-- In-house uses -->
          <text x="540" y="140" font-size="11" font-weight="700" fill="#0A1A30">Used for:</text>
      ...
      <RawSvg
        ...
        svg={`<svg viewBox="0 0 680 340" style="width:100%;max-width:680px" xmlns="http://www.w3.org/2000/svg">
          ...
          <g transform="translate(10,10)">
            <rect x="0" y="0" width="320" height="310" fill="#F8FAFC" stroke="#0A1A30" stroke-width="1.5"/>
            <text x="160" y="20" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">1995</text>
            <!-- roads -->
          ...
          <g transform="translate(350,10)">
            <rect x="0" y="0" width="320" height="310" fill="#F8FAFC" stroke="#0A1A30" stroke-width="1.5"/>
            <text x="160" y="20" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">2025</text>
            <rect x="0" y="140" width="320" height="24" fill="#CBD5E1"/>
            <rect x="150" y="30" width="24" height="280" fill="#CBD5E1"/>
            <text x="80" y="158" text-anchor="middle" font-size="10" fill="#475569" font-weight="600">Main Road</text>
            <!-- NW: park (same) -->
      ...
      <RawSvg
        ...
        svg={`<svg viewBox="0 0 680 340" style="width:100%;max-width:680px" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(10,10)">
            ...
            <!-- entrance -->
            <polygon points="150,300 170,300 160,310" fill="#0A1A30"/>
            <text x="160" y="295" text-anchor="middle" font-size="9" fill="#0A1A30" font-weight="600">Entrance</text>
          </g>
          <g transform="translate(350,10)">
            <rect x="0" y="0" width="320" height="310" fill="#DCFCE7" stroke="#166534" stroke-width="1.5"/>
    ...
    visual: (
      <RawSvg
        ...
        svg={`<svg viewBox="0 0 680 340" style="width:100%;max-width:680px" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(10,10)">
            <rect x="0" y="0" width="320" height="310" fill="#F8FAFC" stroke="#0A1A30" stroke-width="1.5"/>
            <text x="160" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">2000</text>
          ...
          <g transform="translate(350,10)">
            <rect x="0" y="0" width="320" height="310" fill="#F8FAFC" stroke="#0A1A30" stroke-width="1.5"/>
            <text x="160" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#0A1A30">2024</text>
