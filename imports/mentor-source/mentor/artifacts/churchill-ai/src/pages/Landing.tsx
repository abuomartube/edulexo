    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center px-4 pt-10 pb-8 gap-8">
        ...
        <div
          ...
          style={{ background: `rgba(0,180,200,0.07)`, borderColor: `rgba(0,180,200,0.25)` }}
        >
        ...
        <div className="w-full max-w-lg flex flex-col gap-3">
          <button
            ...
            style={{
              ...
              color: NAVY,
              boxShadow: `0 8px 30px rgba(0,180,200,0.4)`,
            }}
          >
          ...
          <p className="text-center text-xs text-white/35">
            Powered by GPT-4o · All 3 IELTS Speaking Parts · by 4 IELTS
          </p>
        </div>
      </main>
