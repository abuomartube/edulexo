...
const NAVY = "#0A1A30";
const VIOLET = "#A78BFA";
const WHATSAPP_URL = "https://wa.me/4ielts";
...
export default function Login({ onAuth, onAdminClick }: Props) {
  ...
  const fetchReviews = useCallback(async () => {
    try {
      const res = await fetch(`${BASE_URL}/api/churchill/auth/comments/approved`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(`${BASE_URL}/api/churchill/auth/${endpoint}`, {
        method: "POST",
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-white/50 text-sm">
              {isLogin ? "Sign in with your email and password" : "Register with your access code from 4 IELTS"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {!isLogin && (
              <div>
                ...
                <p className="text-[11px] text-white/35 mt-1.5">One-time code from 4 IELTS — used once at registration.</p>
              </div>
            )}
            <div>
      ...
      <div className="w-full max-w-3xl space-y-8">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="relative w-28">
            <div
              ...
              style={{ background: `radial-gradient(circle, ${TEAL} 0%, ${GREEN} 100%)` }}
            />
            <img src="/4ielts-logo.png" alt="4 IELTS" className="relative w-full drop-shadow-2xl object-contain" />
          </div>
        </div>
        ...
        <div className="text-center space-y-3">
          <div
            ...
            style={{
              background: `linear-gradient(135deg, rgba(0,180,200,0.15), rgba(245,197,24,0.15))`,
          ...
          <div className="flex items-center justify-center gap-3 pt-1 text-xs text-white/50 flex-wrap">
            <span className="flex items-center gap-1.5">
              ...
              <span className="font-bold text-white">Churchill AI</span>
          ...
          <div className="flex flex-col items-center">
            <div className="relative mb-[-40px] z-10">
              ...
              <img
                ...
                style={{ border: "2px solid rgba(0,180,200,0.3)" }}
              />
            </div>
            <div
              className="relative w-full rounded-2xl pt-14 pb-5 px-5 text-center"
              style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(0,180,200,0.25)" }}
            >
              <div className="space-y-3">
                <div>
                  <div
                    className="inline-block px-2.5 py-0.5 rounded-full text-[9px] font-black tracking-[0.2em] uppercase mb-1"
                    style={{ background: "rgba(0,180,200,0.15)", color: TEAL }}
                  >
                    Speaking
                  </div>
                  <h2 className="text-2xl font-black text-white leading-tight">Churchill AI</h2>
        ...
        <div className="w-full max-w-md mx-auto space-y-3 pt-2">
          <button
            ...
            style={{
              background: `linear-gradient(135deg, ${TEAL}, #00D4F0)`,
              boxShadow: `0 0 40px rgba(0,180,200,0.35), 0 8px 20px rgba(0,0,0,0.3)`,
            }}
          >
        ...
        <div className="text-center space-y-3 pt-2 pb-4">
          ...
          <p className="text-[11px] text-white/20">Powered by GPT-4o &amp; Claude AI · by 4 IELTS</p>
        </div>
      </div>
    </div>
  );
