...
export default function ToolChoice({ onChurchill, onOrwell, onAttenborough, onHemingway, onLogout, expiresAt }: Props) {
  ...
  const fetchComments = useCallback(async () => {
    try {
      const res = await fetch(`${BASE_URL}/api/churchill/auth/comments/approved`, { credentials: "include" });
  ...
  const submitReview = async () => {
    ...
    setReviewError(null);
    try {
      const res = await fetch(`${BASE_URL}/api/churchill/auth/comments`, {
        method: "POST",
    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-black text-white text-base tracking-tight leading-none">4 IELTS</div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 pb-8 gap-6">
          ...
          >
            ...
            >
              <div
                ...
                style={{ background: `linear-gradient(180deg, rgba(0,180,200,0.1) 0%, rgba(0,180,200,0.02) 100%)` }}
              />
          ...
          {!submitted ? (
            ...
            >
              ...
              <textarea
                ...
                placeholder="How has 4 IELTS helped you?"
                rows={2}
        ...
        <p className="text-center text-xs text-white/30">
          Powered by GPT-4o & Claude AI · by 4 IELTS
        </p>
      </main>
    </div>
  );
