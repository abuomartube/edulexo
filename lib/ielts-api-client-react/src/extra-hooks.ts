...
export const useListBookmarks = () =>
  useQuery<number[]>({
    ...
    queryFn: () =>
      customFetch<number[]>("/api-ielts/bookmarks", { method: "GET" }),
  });
...
export const useToggleBookmark = () => {
  ...
  return useMutation<{ bookmarked: boolean }, unknown, number>({
    mutationFn: (id) =>
      customFetch<{ bookmarked: boolean }>(`/api-ielts/bookmarks/${id}`, {
        method: "POST",
      }),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["/api-ielts/bookmarks"] }),
  });
};
...
export const useWordOfDay = () =>
  useQuery<WordOfDay | null>({
    ...
    queryFn: () =>
      customFetch<WordOfDay>("/api-ielts/word-of-day", { method: "GET" }),
  });
...
export const useStreak = () =>
  useQuery<StreakInfo>({
    ...
    queryFn: () =>
      customFetch<StreakInfo>("/api-ielts/streak", { method: "GET" }),
  });
...
export const useWeakWords = () =>
  useQuery<WeakWordItem[]>({
    ...
    queryFn: () =>
      customFetch<WeakWordItem[]>("/api-ielts/weak-words", { method: "GET" }),
  });
...
export const useAddWeakWords = () => {
  ...
  return useMutation<{ added: number }, unknown, number[]>({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["/api-ielts/weak-words"] }),
  });
};
...
export const useMasterWeakWord = () => {
  ...
  return useMutation<{ mastered: boolean }, unknown, number>({
    mutationFn: (id) =>
      customFetch<{ mastered: boolean }>(`/api-ielts/weak-words/${id}/master`, {
        method: "POST",
      }),
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["/api-ielts/weak-words"] }),
...
export const usePhrasalVerbWeak = () => {
  ...
  const query = useQuery<{ ids: number[] }>({
    ...
    queryFn: () =>
      customFetch<{ ids: number[] }>("/api-ielts/phrasal-verbs/weak"),
    staleTime: 30_000,
  });
  const toggle = useMutation<{ weak: boolean }, unknown, number>({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["/api-ielts/phrasal-verbs/weak"] }),
  });
...
export const useQuiz = (level?: string, count = 10) =>
  useQuery<QuizQuestion[]>({
    ...
    queryFn: () => {
      ...
      return customFetch<QuizQuestion[]>(`/api-ielts/quiz?${params}`, {
        method: "GET",
      });
    },
  });
...
export const useFillBlank = (level?: string, count = 10) =>
  useQuery<FillBlankQuestion[]>({
    ...
    queryFn: () => {
      ...
      if (level && level !== "ALL") params.set("level", level);
      params.set("count", String(count));
      return customFetch<FillBlankQuestion[]>(
        `/api-ielts/fill-blank?${params}`,
        { method: "GET" },
      );
    },
  });
...
export const useSrsDue = (level?: string) =>
  useQuery<WordOfDay[]>({
    ...
    queryFn: () => {
      ...
      return customFetch<WordOfDay[]>(`/api-ielts/srs/due${params}`, {
        method: "GET",
      });
    },
  });
